...
/*
================================================
The *Debug Graph, budDebugGraph, contains graphing functionality common to many debug tools.
================================================
*/
class budDebugGraph
{
public:
	budDebugGraph( int numItems = 0 );
	...
	void	AddGridLine( float value, const budVec4& color );
	
	// sets a bar value, pass -1 to append an element
	void	SetValue( int b, float value, const budVec4& color );
	...
	void	SetBackgroundColor( const budVec4& color )
	{
		bgColor = color;
	}
	void	SetLabelColor( const budVec4& color )
	{
		fontColor = color;
	}
	...
	void	Render( budRenderSystem* gui );
	
private:
	const class budMaterial* white;
	const class budMaterial* font;
	...
	budList< graphPlot_t >	bars;
	budList< graphPlot_t >	grid;
	budList< budStr >			labels;
};
