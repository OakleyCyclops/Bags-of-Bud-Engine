...
=================
*/
size_t budDeclFX::Size() const
{
	return sizeof( budDeclFX );
}
...
===============
*/
void budDeclFX::Print() const
{
	const budDeclFX* list = this;
...
/*
================
budDeclFX::ParseSingleFXAction
================
*/
void budDeclFX::ParseSingleFXAction( budLexer& src, idFXSingleAction& FXAction )
{
	budToken token;
...
================
*/
bool budDeclFX::Parse( const char* text, const int textLength, bool allowBinaryVersion )
{
	budLexer src;
	budToken token;
...
/*
===================
budDeclFX::DefaultDefinition
===================
*/
const char* budDeclFX::DefaultDefinition() const
{
	return
		"{\n"
		"\t"	"{\n"
