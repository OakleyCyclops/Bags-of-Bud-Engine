...
/*
=================
budDeclTable::TableLookup
=================
*/
float budDeclTable::TableLookup( float index ) const
{
	int iIndex;
	float iFrac;
	...
	else
	{
		...
		if( index < 0 )
		{
			index += domain * budMath::Ceil( -index / domain );
		}
		
		iIndex = budMath::Ftoi( budMath::Floor( index ) );
		iFrac = index - iIndex;
...
=================
*/
size_t budDeclTable::Size() const
{
	return sizeof( budDeclTable ) + values.Allocated();
}

/*
=================
budDeclTable::FreeData
=================
*/
void budDeclTable::FreeData()
{
	snap = false;
	clamp = false;
	values.Clear();
...
/*
=================
budDeclTable::DefaultDefinition
=================
*/
const char* budDeclTable::DefaultDefinition() const
{
	return "{ { 0 } }";
}
...
=================
*/
bool budDeclTable::Parse( const char* text, const int textLength, bool allowBinaryVersion )
{
	budLexer src;
	budToken token;
	float v;
