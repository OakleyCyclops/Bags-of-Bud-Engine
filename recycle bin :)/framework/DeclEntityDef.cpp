...
/*
=================
budDeclEntityDef::Size
=================
*/
size_t budDeclEntityDef::Size() const
{
	return sizeof( budDeclEntityDef ) + dict.Allocated();
}

/*
================
budDeclEntityDef::FreeData
================
*/
void budDeclEntityDef::FreeData()
{
	dict.Clear();
}
...
/*
================
budDeclEntityDef::Parse
================
*/
bool budDeclEntityDef::Parse( const char* text, const int textLength, bool allowBinaryVersion )
{
	budLexer src;
	...
	budList<const budDeclEntityDef*> defList;
	...
	while( 1 )
	{
		...
		const budDeclEntityDef* copy = static_cast<const budDeclEntityDef*>( declManager->FindType( DECL_ENTITYDEF, kv->GetValue(), false ) );
		if( !copy )
		{
...
/*
================
budDeclEntityDef::DefaultDefinition
================
*/
const char* budDeclEntityDef::DefaultDefinition() const
{
	return
		"{\n"
		"\t"	"\"DEFAULTED\"\t\"1\"\n"
