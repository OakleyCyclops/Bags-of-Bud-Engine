...
================
*/
bool budAFVector::Parse( budLexer& src )
{
	budToken token;
	...
	{
		type = budAFVector::VEC_BONECENTER;
		src.ExpectTokenString( "(" );
		src.ReadToken( &token );
		joint1 = token;
		src.ExpectTokenString( "," );
...
================
*/
bool budAFVector::Finish( const char* fileName, const getJointTransform_t GetJointTransform, const budJointMat* frame, void* model ) const
{
	budMat3 axis;
	budVec3 start, end;
	...
	switch( type )
	{
		case budAFVector::VEC_COORDS:
		{
			break;
		}
		case budAFVector::VEC_JOINT:
		{
		...
		case budAFVector::VEC_BONECENTER:
		{
...
================
*/
bool budAFVector::Write( budFile* f ) const
{
...
/*
================
budAFVector::ToString
================
*/
const char* budAFVector::ToString( budStr& str, const int precision )
{
...
/*
================
budDeclAF_Body::SetDefault
================
*/
void budDeclAF_Body::SetDefault( const budDeclAF* file )
{
	name = "noname";
	modelType = TRM_BOX;
	v1.type = budAFVector::VEC_COORDS;
	v1.ToVec3().x = v1.ToVec3().y = v1.ToVec3().z = -10.0f;
	v2.type = budAFVector::VEC_COORDS;
...
/*
================
budDeclAF_Constraint::SetDefault
================
*/
void budDeclAF_Constraint::SetDefault( const budDeclAF* file )
{
	name = "noname";
	...
	limit = budDeclAF_Constraint::LIMIT_NONE;
	limitAngles[0] =
		limitAngles[1] =
			limitAngles[2] = 0.0f;
...
================
*/
bool budDeclAF::WriteBody( budFile* f, const budDeclAF_Body& body ) const
{
	budStr str;
	...
	{
		const budMat3& ic = body.inertiaScale;
...
/*
================
budDeclAF::WriteFixed
================
*/
bool budDeclAF::WriteFixed( budFile* f, const budDeclAF_Constraint& c ) const
{
	f->WriteFloatString( "\nfixed \"%s\" {\n", c.name.c_str() );
...
/*
================
budDeclAF::WriteBallAndSocketJoint
================
*/
bool budDeclAF::WriteBallAndSocketJoint( budFile* f, const budDeclAF_Constraint& c ) const
{
	...
	if( c.limit == budDeclAF_Constraint::LIMIT_CONE )
	{
	...
	else if( c.limit == budDeclAF_Constraint::LIMIT_PYRAMID )
	{
...
/*
================
budDeclAF::WriteUniversalJoint
================
*/
bool budDeclAF::WriteUniversalJoint( budFile* f, const budDeclAF_Constraint& c ) const
{
	f->WriteFloatString( "\nuniversalJoint \"%s\" {\n", c.name.c_str() );
	f->WriteFloatString( "\tbody1 \"%s\"\n", c.body1.c_str() );
	f->WriteFloatString( "\tbody2 \"%s\"\n", c.body2.c_str() );
...
/*
================
budDeclAF::WriteHinge
================
*/
bool budDeclAF::WriteHinge( budFile* f, const budDeclAF_Constraint& c ) const
{
	f->WriteFloatString( "\nhinge \"%s\" {\n", c.name.c_str() );
	f->WriteFloatString( "\tbody1 \"%s\"\n", c.body1.c_str() );
	f->WriteFloatString( "\tbody2 \"%s\"\n", c.body2.c_str() );
...
/*
================
budDeclAF::WriteSlider
================
*/
bool budDeclAF::WriteSlider( budFile* f, const budDeclAF_Constraint& c ) const
{
	f->WriteFloatString( "\nslider \"%s\" {\n", c.name.c_str() );
	f->WriteFloatString( "\tbody1 \"%s\"\n", c.body1.c_str() );
	f->WriteFloatString( "\tbody2 \"%s\"\n", c.body2.c_str() );
...
/*
================
budDeclAF::WriteSpring
================
*/
bool budDeclAF::WriteSpring( budFile* f, const budDeclAF_Constraint& c ) const
{
	f->WriteFloatString( "\nspring \"%s\" {\n", c.name.c_str() );
	f->WriteFloatString( "\tbody1 \"%s\"\n", c.body1.c_str() );
	f->WriteFloatString( "\tbody2 \"%s\"\n", c.body2.c_str() );
...
/*
================
budDeclAF::WriteConstraint
================
*/
bool budDeclAF::WriteConstraint( budFile* f, const budDeclAF_Constraint& c ) const
{
	switch( c.type )
	{
...
/*
================
budDeclAF::WriteSettings
================
*/
bool budDeclAF::WriteSettings( budFile* f ) const
{
	budStr str;
...
/*
================
budDeclAF::RebuildTextSource
================
*/
bool budDeclAF::RebuildTextSource()
{
	int i;
	budFile_Memory f;
...
/*
================
budDeclAF::ContentsFromString
================
*/
int budDeclAF::ContentsFromString( const char* str )
{
	int c;
	budToken token;
	budLexer src( str, budStr::Length( str ), "budDeclAF::ContentsFromString" );
...
/*
================
budDeclAF::ContentsToString
================
*/
const char* budDeclAF::ContentsToString( const int contents, budStr& str )
{
	str = "";
...
/*
================
budDeclAF::JointModFromString
================
*/
declAFJointMod_t budDeclAF::JointModFromString( const char* str )
{
	if( budStr::Icmp( str, "orientation" ) == 0 )
	{
		return DECLAF_JOINTMOD_AXIS;
	}
	if( budStr::Icmp( str, "position" ) == 0 )
	{
		return DECLAF_JOINTMOD_ORIGIN;
	}
	if( budStr::Icmp( str, "both" ) == 0 )
	{
...
/*
================
budDeclAF::JointModToString
================
*/
const char* budDeclAF::JointModToString( declAFJointMod_t jointMod )
{
	switch( jointMod )
	{
...
=================
*/
size_t budDeclAF::Size() const
{
	return sizeof( budDeclAF );
}

/*
================
budDeclAF::ParseContents
================
*/
bool budDeclAF::ParseContents( budLexer& src, int& c ) const
{
	budToken token;
	budStr str;
...
================
*/
bool budDeclAF::ParseBody( budLexer& src )
{
	bool hasJoint = false;
	budToken token;
	budAFVector angles;
	budDeclAF_Body* body = new( TAG_DECL ) budDeclAF_Body;
	...
	while( src.ReadToken( &token ) )
	{
		...
		else if( !token.Icmp( "angles" ) )
		{
			...
			body->angles = budAngles( angles.ToVec3().x, angles.ToVec3().y, angles.ToVec3().z );
		}
...
/*
================
budDeclAF::ParseFixed
================
*/
bool budDeclAF::ParseFixed( budLexer& src )
{
	budToken token;
	budDeclAF_Constraint* constraint = new( TAG_DECL ) budDeclAF_Constraint;
...
/*
================
budDeclAF::ParseBallAndSocketJoint
================
*/
bool budDeclAF::ParseBallAndSocketJoint( budLexer& src )
{
	budToken token;
	budDeclAF_Constraint* constraint = new( TAG_DECL ) budDeclAF_Constraint;
	...
	constraint->limit = budDeclAF_Constraint::LIMIT_NONE;
	constraint->name = token;
	...
	while( src.ReadToken( &token ) )
	{
		...
		else if( !token.Icmp( "conelimit" ) )
		{
			...
			constraint->limit = budDeclAF_Constraint::LIMIT_CONE;
		}
		else if( !token.Icmp( "pyramidlimit" ) )
		{
			...
			constraint->limit = budDeclAF_Constraint::LIMIT_PYRAMID;
		}
		else if( !token.Icmp( "friction" ) )
		{
...
/*
================
budDeclAF::ParseUniversalJoint
================
*/
bool budDeclAF::ParseUniversalJoint( budLexer& src )
{
	budToken token;
	budDeclAF_Constraint* constraint = new( TAG_DECL ) budDeclAF_Constraint;
...
/*
================
budDeclAF::ParseHinge
================
*/
bool budDeclAF::ParseHinge( budLexer& src )
{
	budToken token;
	budDeclAF_Constraint* constraint = new( TAG_DECL ) budDeclAF_Constraint;
...
/*
================
budDeclAF::ParseSlider
================
*/
bool budDeclAF::ParseSlider( budLexer& src )
{
	budToken token;
	budDeclAF_Constraint* constraint = new( TAG_DECL ) budDeclAF_Constraint;
...
/*
================
budDeclAF::ParseSpring
================
*/
bool budDeclAF::ParseSpring( budLexer& src )
{
	budToken token;
	budDeclAF_Constraint* constraint = new( TAG_DECL ) budDeclAF_Constraint;
...
/*
================
budDeclAF::ParseSettings
================
*/
bool budDeclAF::ParseSettings( budLexer& src )
{
	budToken token;
...
================
*/
bool budDeclAF::Parse( const char* text, const int textLength, bool allowBinaryVersion )
{
	int i, j;
	budLexer src;
	budToken token;
...
/*
================
budDeclAF::DefaultDefinition
================
*/
const char* budDeclAF::DefaultDefinition() const
{
	return
		"{\n"
		"\t"	"settings {\n"
...
================
*/
void budDeclAF::Finish( const getJointTransform_t GetJointTransform, const budJointMat* frame, void* model ) const
{
	int i;
	...
	for( i = 0; i < constraints.Num(); i++ )
	{
		budDeclAF_Constraint* constraint = constraints[i];
...
================
*/
void budDeclAF::NewBody( const char* name )
{
	budDeclAF_Body* body;
	
	body = new( TAG_DECL ) budDeclAF_Body();
	body->SetDefault( this );
	body->name = name;
	bodies.Append( body );
}
...
/*
================
budDeclAF::RenameBody

  rename the body with the given name and rename
  all constraint body references
================
*/
void budDeclAF::RenameBody( const char* oldName, const char* newName )
{
	int i;
...
/*
================
budDeclAF::NewConstraint
================
*/
void budDeclAF::NewConstraint( const char* name )
{
	budDeclAF_Constraint* constraint;
	
	constraint = new( TAG_DECL ) budDeclAF_Constraint;
	constraint->SetDefault( this );
...
/*
================
budDeclAF::RenameConstraint
================
*/
void budDeclAF::RenameConstraint( const char* oldName, const char* newName )
{
	int i;
...
/*
================
budDeclAF::DeleteConstraint
================
*/
void budDeclAF::DeleteConstraint( const char* name )
{
	int i;
