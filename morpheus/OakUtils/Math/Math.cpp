...
const float Math::ONEOVER_PI		= 1.0f / Math::PI;
const float Math::ONEOVER_TWOPI	= 1.0f / Math::TWO_PI;
...
const float Math::FLT_SMALLEST_NON_DENORMAL	= * reinterpret_cast< const float* >( & SMALLEST_NON_DENORMAL );	// 1.1754944e-038f
...
const __m128 Math::SIMD_SP_smallestNonDenorm	= { FLT_SMALLEST_NON_DENORMAL, FLT_SMALLEST_NON_DENORMAL, FLT_SMALLEST_NON_DENORMAL, FLT_SMALLEST_NON_DENORMAL };
