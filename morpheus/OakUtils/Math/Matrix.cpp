...
Matrix2 mat2_zero( Vector2( 0, 0 ), Vector2( 0, 0 ) );
Matrix2 mat2_identity( Vector2( 1, 0 ), Vector2( 0, 1 ) );
...
Matrix3 mat3_zero( Vector3( 0, 0, 0 ), Vector3( 0, 0, 0 ), Vector3( 0, 0, 0 ) );
Matrix3 mat3_identity( Vector3( 1, 0, 0 ), Vector3( 0, 1, 0 ), Vector3( 0, 0, 1 ) );
...
============
*/
CMPQuat Matrix3::ToCQuat() const
{
	Quat q = ToQuat();
	if( q.w < 0.0f )
	{
		return CMPQuat( -q.x, -q.y, -q.z );
	}
	return CMPQuat( q.x, q.y, q.z );
}
...
============
*/
Rotation Matrix3::ToRotation() const
{
	Rotation	r;
	float		trace;
	float		s;
	...
	if( ( Math::Fabs( r.angle ) < 1e-10f ) || ( lengthSqr < 1e-10f ) )
	{
	...
	{
		r.vec *= Math::InvSqrt( lengthSqr );
		r.angle *= 2.0f * Math::M_RAD2DEG;
	}
...
=================
*/
Vector3 Matrix3::ToAngularVelocity() const
{
...
============
*/
Matrix3 Matrix3::InertiaTranslate( const float mass, const Vector3& centerOfMass, const Vector3& translation ) const
{
	Matrix3 m;
	Vector3 newCenter;
...
============
*/
Matrix3& Matrix3::InertiaTranslateSelf( const float mass, const Vector3& centerOfMass, const Vector3& translation )
{
	Matrix3 m;
	Vector3 newCenter;
...
Matrix5 mat5_zero( Vector5( 0, 0, 0, 0, 0 ), Vector5( 0, 0, 0, 0, 0 ), Vector5( 0, 0, 0, 0, 0 ), Vector5( 0, 0, 0, 0, 0 ), Vector5( 0, 0, 0, 0, 0 ) );
Matrix5 mat5_identity( Vector5( 1, 0, 0, 0, 0 ), Vector5( 0, 1, 0, 0, 0 ), Vector5( 0, 0, 1, 0, 0 ), Vector5( 0, 0, 0, 1, 0 ), Vector5( 0, 0, 0, 0, 1 ) );
...
============
*/
Matrix5 Matrix5::Transpose() const
{
	Matrix5	transpose;
	int		i, j;
...
============
*/
float Matrix5::Determinant() const
{
...
/*
============
Matrix5::InverseFastSelf
============
*/
bool Matrix5::InverseFastSelf()
{
#if 0
	// 280+5+25 = 310 multiplications
	//				1 division
...
Matrix6 mat6_zero( Vector6( 0, 0, 0, 0, 0, 0 ), Vector6( 0, 0, 0, 0, 0, 0 ), Vector6( 0, 0, 0, 0, 0, 0 ), Vector6( 0, 0, 0, 0, 0, 0 ), Vector6( 0, 0, 0, 0, 0, 0 ), Vector6( 0, 0, 0, 0, 0, 0 ) );
Matrix6 mat6_identity( Vector6( 1, 0, 0, 0, 0, 0 ), Vector6( 0, 1, 0, 0, 0, 0 ), Vector6( 0, 0, 1, 0, 0, 0 ), Vector6( 0, 0, 0, 1, 0, 0 ), Vector6( 0, 0, 0, 0, 1, 0 ), Vector6( 0, 0, 0, 0, 0, 1 ) );
...
============
*/
Matrix6 Matrix6::Transpose() const
{
	Matrix6	transpose;
	int		i, j;
...
============
*/
float Matrix6::Determinant() const
{
...
/*
============
Matrix6::InverseFastSelf
============
*/
bool Matrix6::InverseFastSelf()
{
#if 0
	// 810+6+36 = 852 multiplications
	//				1 division
