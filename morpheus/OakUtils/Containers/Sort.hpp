...
To sort an array, an List or an budStaticList, a new sort class, typically derived from
SortQuick, is implemented as follows:

class Sort_MySort : public SortQuick< idMyObject, Sort_MySort > {
public:
...
public:
	virtual			~Sort() {}
	virtual void	SortArray( _type_ * base, unsigned int num ) const = 0;
};

/*
================================================
SortQuick is a sort template that implements the
quick-sort algorithm on an array of objects of the specified data type.
================================================
*/
template< typename _type_, typename _derived_ >
class SortQuick : public Sort< _type_ >
{
public:
	virtual void SortArray( _type_ * base, unsigned int num ) const
	{
		if( num <= 0 )
		{
			return;
...
*/
template< typename _type_ >
class SortQuickDefault : public SortQuick< _type_, SortQuickDefault< _type_ > >
{
public:
...
*/
template<>
class SortQuickDefault< float > : public SortQuick< float, SortQuickDefault< float > >
{
public:
...
/*
================================================
SortHeap is a sort template class that implements the
heap-sort algorithm on an array of objects of the specified data type.
================================================
*/
template< typename _type_, typename _derived_ >
class SortHeap : public Sort< _type_ >
{
public:
	virtual void SortArray( _type_ * base, unsigned int num ) const
	{
...
*/
template< typename _type_ >
class SortHeapDefault : public SortHeap< _type_, SortHeapDefault< _type_ > >
{
public:
	int Compare( const _type_ & a, const _type_ & b ) const
	{
...
/*
================================================
SortInsertion is a sort template class that implements the
insertion-sort algorithm on an array of objects of the specified data type.
================================================
*/
template< typename _type_, typename _derived_ >
class SortInsertion : public Sort< _type_ >
{
public:
	virtual void SortArray( _type_ * base, unsigned int num ) const
	{
...
*/
template< typename _type_ >
class SortInsertionDefault : public SortInsertion< _type_, SortInsertionDefault< _type_ > >
{
public:
	int Compare( const _type_ & a, const _type_ & b ) const
	{
