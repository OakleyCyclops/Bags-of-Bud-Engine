...
/*
============
budAASBuild::LedgeSubdivFlood_r
============
*/
void budAASBuild::LedgeSubdivFlood_r( idBrushBSPNode* node, const idLedge* ledge )
{
	int s1, i;
	idBrushBSPPortal* p1;
	idWinding* w;
...
/*
============
budAASBuild::LedgeSubdivLeafNodes_r
...
============
*/
void budAASBuild::LedgeSubdivLeafNodes_r( idBrushBSPNode* node, const idLedge* ledge )
{
	if( !node )
	{
		return;
...
/*
============
budAASBuild::LedgeSubdiv
============
*/
void budAASBuild::LedgeSubdiv( idBrushBSPNode* root )
{
	int i, j;
	idBrush* brush;
...
/*
============
budAASBuild::FindLeafNodeLedges
============
*/
void budAASBuild::FindLeafNodeLedges( idBrushBSPNode* root, idBrushBSPNode* node )
{
	int s1, i;
	idBrushBSPPortal* p1;
	idWinding* w;
...
/*
============
budAASBuild::FindLedges_r
============
*/
void budAASBuild::FindLedges_r( idBrushBSPNode* root, idBrushBSPNode* node )
{
	if( !node )
	{
		return;
