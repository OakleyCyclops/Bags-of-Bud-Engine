...
/*
============
budAASBuild::AllGapsLeadToOtherNode
============
*/
bool budAASBuild::AllGapsLeadToOtherNode( idBrushBSPNode* nodeWithGaps, idBrushBSPNode* otherNode )
{
	int s;
	idBrushBSPPortal* p;
...
/*
============
budAASBuild::MergeWithAdjacentLeafNodes
============
*/
bool budAASBuild::MergeWithAdjacentLeafNodes( idBrushBSP& bsp, idBrushBSPNode* node )
{
...
/*
============
budAASBuild::MergeLeafNodes_r
============
*/
void budAASBuild::MergeLeafNodes_r( idBrushBSP& bsp, idBrushBSPNode* node )
{
...
/*
============
budAASBuild::MergeLeafNodes
============
*/
void budAASBuild::MergeLeafNodes( idBrushBSP& bsp )
{
