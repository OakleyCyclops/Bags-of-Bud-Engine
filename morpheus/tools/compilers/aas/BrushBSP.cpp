...
============
*/
int idBrushBSPPortal::Split( const budPlane& splitPlane, idBrushBSPPortal** front, idBrushBSPPortal** back )
{
...
============
*/
budBounds idBrushBSPNode::GetPortalBounds()
{
	int s, i;
	idBrushBSPPortal* p;
	budBounds bounds;
...
============
*/
bool idBrushBSPNode::Split( const budPlane& splitPlane, int splitPlaneNum )
{
	int s, i;
	idWinding* mid;
...
============
*/
int idBrushBSPNode::PlaneSide( const budPlane& plane, float epsilon ) const
{
	int s, side;
	idBrushBSPPortal* p;
	bool front, back;
...
============
*/
BUD_INLINE bool idBrushBSP::IsValidSplitter( const idBrushSide* side )
{
...
int idBrushBSP::BrushSplitterStats( const idBrush* brush, int planeNum, const budPlaneSet& planeList, bool* testedPlanes, struct splitterStats_s& stats )
{
...
============
*/
int idBrushBSP::FindSplitter( idBrushBSPNode* node, const budPlaneSet& planeList, bool* testedPlanes, struct splitterStats_s& bestStats )
{
...
============
*/
idBrushBSPNode* idBrushBSP::BuildBrushBSP_r( idBrushBSPNode* node, const budPlaneSet& planeList, bool* testedPlanes, int skipContents )
{
	int planeNum;
...
============
*/
void idBrushBSP::SetPortalPlanes_r( idBrushBSPNode* node, budPlaneSet& planeList )
{
	int s;
	idBrushBSPPortal* p;
...
============
*/
void idBrushBSP::UpdateTreeAfterMerge_r( idBrushBSPNode* node, const budBounds& bounds, idBrushBSPNode* oldNode, idBrushBSPNode* newNode )
{
