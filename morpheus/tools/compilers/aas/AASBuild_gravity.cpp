...
/*
============
budAASBuild::SetPortalFlags_r
============
*/
void budAASBuild::SetPortalFlags_r( idBrushBSPNode* node )
{
	int s;
	idBrushBSPPortal* p;
	Vector3 normal;
...
/*
============
budAASBuild::GravSubdivLeafNode
============
*/
#define FACE_CHECKED			BIT(31)
#define GRAVSUBDIV_EPSILON		0.1f

void budAASBuild::GravSubdivLeafNode( idBrushBSPNode* node )
{
...
/*
============
budAASBuild::GravSubdiv_r
============
*/
void budAASBuild::GravSubdiv_r( idBrushBSPNode* node )
{
...
/*
============
budAASBuild::GravitationalSubdivision
============
*/
void budAASBuild::GravitationalSubdivision( idBrushBSP& bsp )
{
