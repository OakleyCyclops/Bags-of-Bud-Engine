...
/*
================
budAASCluster::UpdatePortal
================
*/
bool budAASCluster::UpdatePortal( int areaNum, int clusterNum )
{
	int portalNum;
	aasPortal_t* portal;
...
/*
================
budAASCluster::FloodClusterAreas_r
================
*/
bool budAASCluster::FloodClusterAreas_r( int areaNum, int clusterNum )
{
	aasArea_t* area;
	aasFace_t* face;
	int faceNum, i;
...
/*
================
budAASCluster::RemoveAreaClusterNumbers
================
*/
void budAASCluster::RemoveAreaClusterNumbers()
{
	int i;
...
/*
================
budAASCluster::NumberClusterAreas
================
*/
void budAASCluster::NumberClusterAreas( int clusterNum )
{
	int i, portalNum;
...
/*
================
budAASCluster::FindClusters
================
*/
bool budAASCluster::FindClusters()
{
	int i, clusterNum;
	aasCluster_t cluster;
...
/*
================
budAASCluster::CreatePortals
================
*/
void budAASCluster::CreatePortals()
{
	int i;
	aasPortal_t portal;
...
/*
================
budAASCluster::TestPortals
================
*/
bool budAASCluster::TestPortals()
{
	int i;
...
/*
================
budAASCluster::RemoveInvalidPortals
================
*/
void budAASCluster::RemoveInvalidPortals()
{
...
================
*/
bool budAASCluster::Build( budAASFileLocal* file )
{
...
/*
================
budAASCluster::BuildSingleCluster
================
*/
bool budAASCluster::BuildSingleCluster( budAASFileLocal* file )
{
	int i, numAreas;
	aasCluster_t cluster;
