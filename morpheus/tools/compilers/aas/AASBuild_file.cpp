...
budHashIndex* aas_vertexHash;
budHashIndex* aas_edgeHash;
budBounds aas_vertexBounds;
int aas_vertexShift;

/*
================
budAASBuild::SetupHash
================
*/
void budAASBuild::SetupHash()
{
	aas_vertexHash = new budHashIndex( VERTEX_HASH_SIZE, 1024 );
	aas_edgeHash = new budHashIndex( EDGE_HASH_SIZE, 1024 );
}

/*
================
budAASBuild::ShutdownHash
================
*/
void budAASBuild::ShutdownHash()
{
...
/*
================
budAASBuild::ClearHash
================
*/
void budAASBuild::ClearHash( const budBounds& bounds )
{
	int i;
	float f, max;
...
bool budAASBuild::GetVertex( const budVec3& v, int* vertexNum )
{
	...
	hashKey = budAASBuild::HashVec( vert );
...
/*
================
budAASBuild::GetFaceForPortal
================
*/
bool budAASBuild::GetFaceForPortal( idBrushBSPPortal* portal, int side, int* faceNum )
{
	int i, j, v1num;
...
/*
================
budAASBuild::GetAreaForLeafNode
================
*/
bool budAASBuild::GetAreaForLeafNode( idBrushBSPNode* node, int* areaNum )
{
	int s, faceNum;
	idBrushBSPPortal* p;
	aasArea_t area;
...
/*
================
budAASBuild::StoreTree_r
================
*/
int budAASBuild::StoreTree_r( idBrushBSPNode* node )
{
...
void budAASBuild::GetSizeEstimate_r( idBrushBSPNode* parent, idBrushBSPNode* node, struct sizeEstimate_s& size )
{
	idBrushBSPPortal* p;
	int s;
...
/*
================
budAASBuild::SetSizeEstimate
================
*/
void budAASBuild::SetSizeEstimate( const idBrushBSP& bsp, budAASFileLocal* file )
{
	sizeEstimate_t size;
...
/*
================
budAASBuild::StoreFile
================
*/
bool budAASBuild::StoreFile( const idBrushBSP& bsp )
{
	aasEdge_t edge;
	aasFace_t face;
	aasArea_t area;
