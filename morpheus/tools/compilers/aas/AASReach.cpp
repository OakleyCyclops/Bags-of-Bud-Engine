...
/*
================
budAASReach::ReachabilityExists
================
*/
bool budAASReach::ReachabilityExists( int fromAreaNum, int toAreaNum )
{
	aasArea_t* area;
...
/*
================
budAASReach::CanSwimInArea
================
*/
BUD_INLINE bool budAASReach::CanSwimInArea( int areaNum )
{
...
/*
================
budAASReach::AreaHasFloor
================
*/
BUD_INLINE bool budAASReach::AreaHasFloor( int areaNum )
{
...
/*
================
budAASReach::AreaIsClusterPortal
================
*/
BUD_INLINE bool budAASReach::AreaIsClusterPortal( int areaNum )
{
...
/*
================
budAASReach::AddReachabilityToArea
================
*/
void budAASReach::AddReachabilityToArea( idReachability* reach, int areaNum )
{
	aasArea_t* area;
...
/*
================
budAASReach::Reachability_Fly
================
*/
void budAASReach::Reachability_Fly( int areaNum )
{
...
/*
================
budAASReach::Reachability_Swim
================
*/
void budAASReach::Reachability_Swim( int areaNum )
{
	int i, faceNum, otherAreaNum;
	aasArea_t* area;
	aasFace_t* face;
...
/*
================
budAASReach::Reachability_EqualFloorHeight
================
*/
void budAASReach::Reachability_EqualFloorHeight( int areaNum )
{
...
/*
================
budAASReach::Reachability_Step_Barrier_WaterJump_WalkOffLedge
================
*/
bool budAASReach::Reachability_Step_Barrier_WaterJump_WalkOffLedge( int area1num, int area2num )
{
...
/*
================
budAASReach::Reachability_WalkOffLedge
================
*/
void budAASReach::Reachability_WalkOffLedge( int areaNum )
{
...
/*
================
budAASReach::FlagReachableAreas
================
*/
void budAASReach::FlagReachableAreas( budAASFileLocal* file )
{
...
================
*/
bool budAASReach::Build( const budMapFile* mapFile, budAASFileLocal* file )
{
