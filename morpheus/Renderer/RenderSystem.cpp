...
budRenderSystemLocal	tr;
budRenderSystem* renderSystem = &tr;
...
=====================
*/
void budRenderSystemLocal::PrintPerformanceCounters()
{
...
====================
*/
void budRenderSystemLocal::RenderCommandBuffers( const emptyCommand_t* const cmdHead )
{
...
/*
=============
budRenderSystemLocal::budRenderSystemLocal
=============
*/
budRenderSystemLocal::budRenderSystemLocal() :
...
/*
=============
budRenderSystemLocal::GetColor
=============
*/
uint32 budRenderSystemLocal::GetColor()
{
...
/*
=============
budRenderSystemLocal::SetGLState
=============
*/
void budRenderSystemLocal::SetGLState( const uint64 glState )
{
...
/*
=============
budRenderSystemLocal::DrawStretchPic
=============
*/
...
void budRenderSystemLocal::DrawStretchPic( const Vector4& topLeft, const Vector4& topRight, const Vector4& bottomRight, const Vector4& bottomLeft, const budMaterial* material )
{
	...
	budDrawVert* verts = guiModel->AllocTris( 4, quadPicIndexes, 6, material, currentGLState, STEREO_DEPTH_TYPE_NONE );
	if( verts == NULL )
	{
		return;
	}
	
	ALIGNTYPE16 budDrawVert localVerts[4];
...
void budRenderSystemLocal::DrawStretchTri( const Vector2& p1, const Vector2& p2, const Vector2& p3, const Vector2& t1, const Vector2& t2, const Vector2& t3, const budMaterial* material )
{
	...
	budDrawVert* verts = guiModel->AllocTris( 3, tempIndexes, 3, material, currentGLState, STEREO_DEPTH_TYPE_NONE );
	if( verts == NULL )
	{
		return;
	}
	
	ALIGNTYPE16 budDrawVert localVerts[3];
...
/*
=============
budRenderSystemLocal::AllocTris
=============
*/
budDrawVert* budRenderSystemLocal::AllocTris( int numVerts, const triIndex_t* indexes, int numIndexes, const budMaterial* material, const stereoDepthType_t stereoType )
{
...
/*
=====================
budRenderSystemLocal::DrawSmallChar

small chars are drawn at native screen resolution
=====================
*/
void budRenderSystemLocal::DrawSmallChar( int x, int y, int ch )
{
	int row, col;
	float frow, fcol;
	float size;
...
/*
==================
budRenderSystemLocal::DrawSmallStringExt
...
/*
=====================
budRenderSystemLocal::DrawBigChar
=====================
*/
void budRenderSystemLocal::DrawBigChar( int x, int y, int ch )
{
	int row, col;
	float frow, fcol;
	float size;
...
/*
==================
budRenderSystemLocal::DrawBigStringExt
...
/*
====================
budRenderSystemLocal::SwapCommandBuffers
...
====================
*/
const emptyCommand_t* budRenderSystemLocal::SwapCommandBuffers(
...
/*
=====================
budRenderSystemLocal::SwapCommandBuffers_FinishRendering
=====================
*/
void budRenderSystemLocal::SwapCommandBuffers_FinishRendering(
	uint64* frontEndMicroSec,
	uint64* backEndMicroSec,
	uint64* shadowMicroSec,
	uint64* gpuMicroSec )
...
/*
=====================
budRenderSystemLocal::SwapCommandBuffers_FinishCommandBuffers
=====================
*/
const emptyCommand_t* budRenderSystemLocal::SwapCommandBuffers_FinishCommandBuffers()
{
	if( !IsInitialized() )
	{
		return NULL;
...
/*
=====================
budRenderSystemLocal::WriteDemoPics
=====================
*/
void budRenderSystemLocal::WriteDemoPics()
{
...
/*
=====================
budRenderSystemLocal::WriteEndFrame
=====================
*/
void budRenderSystemLocal::WriteEndFrame()
{
	common->WriteDemo()->WriteInt( DS_RENDER );
...
/*
=====================
budRenderSystemLocal::DrawDemoPics
=====================
*/
void budRenderSystemLocal::DrawDemoPics()
{
}

/*
=====================
budRenderSystemLocal::GetCroppedViewport

Returns the current cropped pixel coordinates
=====================
*/
void budRenderSystemLocal::GetCroppedViewport( budScreenRect* viewport )
{
...
/*
========================
budRenderSystemLocal::PerformResolutionScaling
...
========================
*/
void budRenderSystemLocal::PerformResolutionScaling( int& newWidth, int& newHeight )
{
...
/*
================
budRenderSystemLocal::CropRenderSize
================
*/
void budRenderSystemLocal::CropRenderSize( int width, int height )
{
	if( !IsInitialized() )
	{
		return;
	...
	budScreenRect& previous = renderCrops[currentRenderCrop];
	
	currentRenderCrop++;
	
	budScreenRect& current = renderCrops[currentRenderCrop];
...
/*
================
budRenderSystemLocal::UnCrop
================
*/
void budRenderSystemLocal::UnCrop()
{
	if( !IsInitialized() )
	{
		return;
	...
	{
		common->Error( "budRenderSystemLocal::UnCrop: currentRenderCrop < 1" );
	}
...
/*
================
budRenderSystemLocal::CaptureRenderToImage
================
*/
void budRenderSystemLocal::CaptureRenderToImage( const char* imageName, bool clearColorAfterCopy )
{
	if( !IsInitialized() )
	{
		return;
	...
	budImage*	 image = globalImages->GetImage( imageName );
	if( image == NULL )
	{
		image = globalImages->AllocImage( imageName );
	}
	
	budScreenRect& rc = renderCrops[currentRenderCrop];
...
/*
==============
budRenderSystemLocal::CaptureRenderToFile
==============
*/
void budRenderSystemLocal::CaptureRenderToFile( const char* fileName, bool fixAlpha )
{
	if( !IsInitialized() )
	{
		return;
...
/*
==============
budRenderSystemLocal::AllocRenderWorld
==============
*/
budRenderWorld* budRenderSystemLocal::AllocRenderWorld()
{
	budRenderWorldLocal* rw;
	rw = new( TAG_RENDER ) budRenderWorldLocal;
	worlds.Append( rw );
	return rw;
}
...
/*
==============
budRenderSystemLocal::FreeRenderWorld
==============
*/
void budRenderSystemLocal::FreeRenderWorld( budRenderWorld* rw )
{
	if( primaryWorld == rw )
	{
		primaryWorld = NULL;
	}
	worlds.Remove( static_cast<budRenderWorldLocal*>( rw ) );
	delete rw;
}

/*
==============
budRenderSystemLocal::PrintMemInfo
==============
*/
void budRenderSystemLocal::PrintMemInfo( MemInfo_t* mi )
{
	// sum up image totals
...
/*
===============
budRenderSystemLocal::UploadImage
===============
*/
bool budRenderSystemLocal::UploadImage( const char* imageName, const byte* data, int width, int height )
{
	budImage* image = globalImages->GetImage( imageName );
	if( !image )
	{
