...
budRenderEntityLocal::budRenderEntityLocal()
{
...
void budRenderEntityLocal::FreeRenderEntity()
{
}

void budRenderEntityLocal::UpdateRenderEntity( const renderEntity_t* re, bool forceUpdate )
{
}

void budRenderEntityLocal::GetRenderEntity( renderEntity_t* re )
{
}

void budRenderEntityLocal::ForceUpdate()
{
}

int budRenderEntityLocal::GetIndex()
{
	return index;
}

void budRenderEntityLocal::ProjectOverlay( const budPlane localTextureAxis[2], const budMaterial* material )
{
}
void budRenderEntityLocal::RemoveDecals()
{
}

//======================================================================

budRenderLightLocal::budRenderLightLocal()
{
	memset( &parms, 0, sizeof( parms ) );
...
void budRenderLightLocal::FreeRenderLight()
{
}
void budRenderLightLocal::UpdateRenderLight( const renderLight_t* re, bool forceUpdate )
{
}
void budRenderLightLocal::GetRenderLight( renderLight_t* re )
{
}
void budRenderLightLocal::ForceUpdate()
{
}
int budRenderLightLocal::GetIndex()
{
	return index;
}


void budRenderEntityLocal::ReadFromDemoFile( class budDemoFile* f )
{
	int i;
	renderEntity_t ent;
	/* Initialize Pointers */
	...
	if( ent.numJoints > 0 )
	{
		ent.joints = ( budJointMat* )Mem_Alloc16( SIMD_ROUND_JOINTS( ent.numJoints ) * sizeof( ent.joints[ 0 ] ), TAG_JOINTMAT );
	...
	f->ReadInt( i );
	if( i ) {
	ent.overlays = budRenderModelOverlay::Alloc();
...
void budRenderEntityLocal::WriteToDemoFile( class budDemoFile* f ) const
{
	f->WriteInt( index );
