...
//================================================================================================
// class budRenderContext
//================================================================================================
class budRenderContext
{
public:
	budRenderContext() : depthHackValue( 0.0f ), weaponDepthHackValue( 1.0f ) {}
	virtual			~budRenderContext() {};
	...
	// Texture Resolves
	void			ResolveTargetColor( budImage* image );
	void			ResolveTargetDepth( budImage* image );
	void			ResolveTargetColor( budImage* image, int srcMinX, int srcMinY, int srcMaxX, int srcMaxY, int dstX, int dstY );
	void			ResolveTargetDepth( budImage* image, int srcMinX, int srcMinY, int srcMaxX, int srcMaxY, int dstX, int dstY );
...
extern budRenderContext rRenderContext;
