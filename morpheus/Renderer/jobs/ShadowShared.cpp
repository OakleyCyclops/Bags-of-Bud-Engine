...
#include "../../libBud/ParallelJobList_JobHeaders.h"
#include "../../libBud/SoftwareCache.h"

#include "../../libBud/math/Vector.h"
#include "../../libBud/math/Matrix.h"
#include "../../libBud/math/Quat.h"
#include "../../libBud/math/Rotation.h"
#include "../../libBud/math/Plane.h"
#include "../../libBud/bv/Sphere.h"
#include "../../libBud/bv/Bounds.h"
#include "../../libBud/geometry/JointTransform.h"
#include "../../libBud/geometry/DrawVert.h"
#include "../../libBud/geometry/RenderMatrix.h"
...
bool R_ViewPotentiallyInsideInfiniteShadowVolume( const budBounds& occluderBounds, const budVec3& localLight, const budVec3& localView, const float zNear )
{
	...
	const budBounds expandedBounds = occluderBounds.Expand( zNear );
...
====================
*/
static void R_ShadowVolumeCullBits( byte* cullBits, byte& totalOr, const float radius, const budPlane* planes, const idShadowVert* verts, const int numVerts )
{
