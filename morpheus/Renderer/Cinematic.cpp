...
class budCinematicLocal : public budCinematic
{
public:
	budCinematicLocal();
	virtual					~budCinematicLocal();
...
/*
==============
budCinematicLocal::InitCinematic
==============
*/
// RB: 64 bit fixes, changed long to int
void budCinematic::InitCinematic()
{
#if defined(USE_FFMPEG)
...
/*
==============
budCinematicLocal::ShutdownCinematic
==============
*/
void budCinematic::ShutdownCinematic()
{
...
==============
*/
budCinematic* budCinematic::Alloc()
{
	return new budCinematicLocal; //Carl: Use the proper class like in Doom 3, not just the unimplemented abstract one.
}

/*
==============
budCinematic::~budCinematic
==============
*/
budCinematic::~budCinematic( )
{
...
/*
==============
budCinematic::InitFromFile
==============
*/
bool budCinematic::InitFromFile( const char* qpath, bool looping )
{
...
/*
==============
budCinematic::AnimationLength
==============
*/
int budCinematic::AnimationLength()
{
	return 0;
}
...
/*
==============
budCinematic::GetStartTime
==============
*/
int budCinematic::GetStartTime()
{
	return -1;
}
...
/*
==============
budCinematic::ResetTime
==============
*/
void budCinematic::ResetTime( int milliseconds )
{
}

/*
==============
budCinematic::ImageForTime
==============
*/
cinData_t budCinematic::ImageForTime( int milliseconds )
{
	cinData_t c;
	memset( &c, 0, sizeof( c ) );
...
/*
==============
budCinematic::ExportToTGA
==============
*/
void budCinematic::ExportToTGA( bool skipExisting )
{
}

/*
==============
budCinematic::GetFrameRate
==============
*/
float budCinematic::GetFrameRate() const
{
	return 30.0f;
}
...
==============
*/
void budCinematic::Close()
{
}

// RB begin
bool budCinematic::IsPlaying() const
{
	return false;
}
// RB end
...
/*
==============
budCinematicLocal::budCinematicLocal
==============
*/
budCinematicLocal::budCinematicLocal()
{
...
/*
==============
budCinematicLocal::InitFromFFMPEGFile
==============
*/
#if defined(USE_FFMPEG)
bool budCinematicLocal::InitFromFFMPEGFile( const char* qpath, bool amilooping )
{
	int ret;
	looping = amilooping;
	startTime = 0;
	...
	else if( String::Cmpn( qpath, "sound/vo", 8 ) == 0 )
	{
		...
		{
			common->Warning( "budCinematic: Cannot open FFMPEG video file: '%s', %d\n", qpath, looping );
			return false;
		}
	}
	...
	{
		common->Warning( "budCinematic: Cannot find stream info: '%s', %d\n", qpath, looping );
		return false;
	}
	...
	if( ret < 0 )
	{
		common->Warning( "budCinematic: Cannot find a video stream in: '%s', %d\n", qpath, looping );
		return false;
	}
	...
	{
		common->Warning( "budCinematic: Cannot open video decoder for: '%s', %d\n", qpath, looping );
		return false;
	}
...
/*
==============
budCinematicLocal::FFMPEGReset
==============
*/
#if defined(USE_FFMPEG)
void budCinematicLocal::FFMPEGReset()
{
...
#ifdef USE_BINKDEC
bool budCinematicLocal::InitFromBinkDecFile( const char* qpath, bool amilooping )
{
	looping = amilooping;
	startTime = 0;
	isRoQ = false;
	...
	else if( String::Cmpn( qpath, "sound/vo", 8 ) == 0 )
	{
		...
		{
			common->Warning( "budCinematic: Cannot open BinkDec video file: '%s', %d\n", qpath, looping );
			return false;
		}
	}
...
void budCinematicLocal::BinkDecReset()
{
	framePos = -1;
...
/*
==============
budCinematicLocal::InitFromFile
==============
*/
bool budCinematicLocal::InitFromFile( const char* qpath, bool amilooping )
{
...
/*
==============
budCinematicLocal::Close
==============
*/
void budCinematicLocal::Close()
{
	if( image )
	{
		Mem_Free( ( void* )image );
...
/*
==============
budCinematicLocal::AnimationLength
==============
*/
int budCinematicLocal::AnimationLength()
{
	return animationLength;
}

// RB begin
bool budCinematicLocal::IsPlaying() const
{
...
/*
==============
budCinematicLocal::ResetTime
==============
*/
void budCinematicLocal::ResetTime( int time )
{
...
/*
==============
budCinematicLocal::ImageForTime
==============
*/
cinData_t budCinematicLocal::ImageForTime( int thisTime )
{
#if defined(USE_FFMPEG)
...
/*
==============
budCinematicLocal::ImageForTimeFFMPEG
==============
*/
#if defined(USE_FFMPEG)
cinData_t budCinematicLocal::ImageForTimeFFMPEG( int thisTime )
{
	cinData_t	cinData;
...
#ifdef USE_BINKDEC
cinData_t budCinematicLocal::ImageForTimeBinkDec( int thisTime )
{
	cinData_t	cinData = {0};
	...
	budImage* imgs[3] = {imgY, imgCb, imgCr}; // that's the order of the channels in yuvBuffer[]
	for( int i = 0; i < 3; ++i )
	{
...
/*
==============
budCinematicLocal::move8_32
==============
*/
void budCinematicLocal::move8_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
/*
==============
budCinematicLocal::move4_32
==============
*/
void budCinematicLocal::move4_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
/*
==============
budCinematicLocal::blit8_32
==============
*/
void budCinematicLocal::blit8_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
/*
==============
budCinematicLocal::blit4_32
==============
*/
void budCinematicLocal::blit4_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
/*
==============
budCinematicLocal::blit2_32
==============
*/
void budCinematicLocal::blit2_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
/*
==============
budCinematicLocal::blitVQQuad32fs
==============
*/
void budCinematicLocal::blitVQQuad32fs( byte** status, unsigned char* data )
{
...
/*
==============
budCinematicLocal::yuv_to_rgb
==============
*/
// RB: 64 bit fixes, changed long to int
unsigned short budCinematicLocal::yuv_to_rgb( int y, int u, int v )
{
...
/*
==============
budCinematicLocal::yuv_to_rgb24
==============
*/
// RB: 64 bit fixes, changed long to int
unsigned int budCinematicLocal::yuv_to_rgb24( int y, int u, int v )
{
	int r, g, b, YY = ( int )( ROQ_YY_tab[( y )] );
...
/*
==============
budCinematicLocal::decodeCodeBook
==============
*/
// RB: 64 bit fixes, changed long to int
void budCinematicLocal::decodeCodeBook( byte* input, unsigned short roq_flags )
{
	int	i, j, two, four;
...
/*
==============
budCinematicLocal::recurseQuad
==============
*/
// RB: 64 bit fixes, changed long to int
void budCinematicLocal::recurseQuad( int startX, int startY, int quadSize, int xOff, int yOff )
{
	byte* scroff;
...
/*
==============
budCinematicLocal::setupQuad
==============
*/
// RB: 64 bit fixes, changed long to int
void budCinematicLocal::setupQuad( int xOff, int yOff )
{
...
/*
==============
budCinematicLocal::readQuadInfo
==============
*/
void budCinematicLocal::readQuadInfo( byte* qData )
{
...
/*
==============
budCinematicLocal::RoQPrepMcomp
==============
*/
// RB: 64 bit fixes, changed long to int
void budCinematicLocal::RoQPrepMcomp( int xoff, int yoff )
{
...
/*
==============
budCinematicLocal::RoQReset
==============
*/
void budCinematicLocal::RoQReset()
{
...
/*
==============
budCinematicLocal::RoQInterrupt
==============
*/
void budCinematicLocal::RoQInterrupt()
{
	byte*				framedata;
...
/*
==============
budCinematicLocal::RoQ_init
==============
*/
void budCinematicLocal::RoQ_init()
{
...
/*
==============
budCinematicLocal::RoQShutdown
==============
*/
void budCinematicLocal::RoQShutdown()
{
	if( status == FMV_IDLE )
	{
		return;
