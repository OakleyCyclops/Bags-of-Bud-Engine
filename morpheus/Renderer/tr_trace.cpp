...
====================
*/
static void R_TracePointCullStatic( byte* cullBits, byte& totalOr, const float radius, const budPlane* planes, const budDrawVert* verts, const int numVerts )
{
...
====================
*/
static void R_TracePointCullSkinned( byte* cullBits, byte& totalOr, const float radius, const budPlane* planes, const budDrawVert* verts, const int numVerts, const budJointMat* joints )
{
	assert_16_byte_aligned( cullBits );
	assert_16_byte_aligned( verts );
