...
static void R_DefaultImage( budImage* image )
{
	image->MakeDefault();
}

static void R_WhiteImage( budImage* image )
{
	byte	data[DEFAULT_SIZE][DEFAULT_SIZE][4];
...
static void R_BlackImage( budImage* image )
{
	byte	data[DEFAULT_SIZE][DEFAULT_SIZE][4];
...
static void R_RGBA8Image( budImage* image )
{
	byte	data[DEFAULT_SIZE][DEFAULT_SIZE][4];
...
static void R_RGBA8LinearImage( budImage* image )
{
	byte	data[DEFAULT_SIZE][DEFAULT_SIZE][4];
...
static void R_DepthImage( budImage* image )
{
...
// RB begin
static void R_HDR_RGBA16FImage_ResNative( budImage* image )
{
	// FIXME
#if defined(USE_HDR_MSAA)
...
static void R_FlatNormalImage( budImage* image )
{
	byte	data[DEFAULT_SIZE][DEFAULT_SIZE][4];
...
================
*/
static void R_CreateNoFalloffImage( budImage* image )
{
	int		x, y;
...
void R_FogImage( budImage* image )
{
	int		x, y;
...
================
*/
void R_FogEnterImage( budImage* image )
{
	int		x, y;
...
void R_QuadraticImage( budImage* image )
{
	int		x, y;
...
// RB begin
static void R_CreateShadowMapImage_Res0( budImage* image )
{
	int size = shadowMapResolutions[0];
	image->GenerateShadowArray( size, size, TF_LINEAR, TR_CLAMP_TO_ZERO_ALPHA, TD_SHADOW_ARRAY );
}

static void R_CreateShadowMapImage_Res1( budImage* image )
{
	int size = shadowMapResolutions[1];
	image->GenerateShadowArray( size, size, TF_LINEAR, TR_CLAMP_TO_ZERO_ALPHA, TD_SHADOW_ARRAY );
}

static void R_CreateShadowMapImage_Res2( budImage* image )
{
	int size = shadowMapResolutions[2];
	image->GenerateShadowArray( size, size, TF_LINEAR, TR_CLAMP_TO_ZERO_ALPHA, TD_SHADOW_ARRAY );
}

static void R_CreateShadowMapImage_Res3( budImage* image )
{
	int size = shadowMapResolutions[3];
	image->GenerateShadowArray( size, size, TF_LINEAR, TR_CLAMP_TO_ZERO_ALPHA, TD_SHADOW_ARRAY );
}

static void R_CreateShadowMapImage_Res4( budImage* image )
{
...
static void R_CreateJitterImage16( budImage* image )
{
...
static void R_CreateJitterImage4( budImage* image )
{
...
static void R_CreateJitterImage1( budImage* image )
{
...
static void R_CreateRandom256Image( budImage* image )
{
	byte	data[256][256][4];
...
static void R_CreateHeatmap5ColorsImage( budImage* image )
{
	int		x, y;
	byte	data[16][FALLOFF_TEXTURE_SIZE][4];
...
static void R_CreateHeatmap7ColorsImage( budImage* image )
{
	int		x, y;
	byte	data[16][FALLOFF_TEXTURE_SIZE][4];
...
static void R_CreateGrainImage1( budImage* image )
{
...
static void R_CreateSMAAAreaImage( budImage* image )
{
...
static void R_CreateSMAASearchImage( budImage* image )
{
...
/*
================
budImageManager::CreateIntrinsicImages
================
*/
void budImageManager::CreateIntrinsicImages()
{
