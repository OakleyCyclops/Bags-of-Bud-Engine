...
/*
=================
budRenderModelMD3::InitFromFile
=================
*/
void budRenderModelMD3::InitFromFile( const char* fileName )
{
	int					i, j;
...
/*
=================
budRenderModelMD3::IsDynamicModel
=================
*/
dynamicModel_t budRenderModelMD3::IsDynamicModel() const
{
	return DM_CACHED;
}
...
/*
=================
budRenderModelMD3::LerpMeshVertexes
=================
*/
void budRenderModelMD3::LerpMeshVertexes( srfTriangles_t* tri, const struct md3Surface_s* surf, const float backlerp, const int frame, const int oldframe ) const
{
	short*	oldXyz, *newXyz;
	...
	if( backlerp == 0 )
	{
		...
		for( vertNum = 0 ; vertNum < numVerts ; vertNum++, newXyz += 4 )
		{
			...
			budDrawVert* outvert = &tri->verts[tri->numVerts];
...
/*
=============
budRenderModelMD3::InstantiateDynamicModel
=============
*/
budRenderModel* budRenderModelMD3::InstantiateDynamicModel( const struct renderEntity_s* ent, const viewDef_t* view, budRenderModel* cachedModel )
{
	int				i, j;
	float			backlerp;
	int* 			triangles;
...
/*
=====================
budRenderModelMD3::Bounds
=====================
*/

budBounds budRenderModelMD3::Bounds( const struct renderEntity_s* ent ) const
{
	budBounds		ret;
