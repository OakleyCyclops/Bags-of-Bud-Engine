...
struct geoBufferSet_t
{
	...
	budSysInterlockedInteger	indexMemUsed;
	budSysInterlockedInteger	vertexMemUsed;
	budSysInterlockedInteger	jointMemUsed;
...
public:
	...
	vertCacheHandle_t	AllocVertex( const void* data, int num, size_t size = sizeof( budDrawVert ) );
	vertCacheHandle_t	AllocIndex( const void* data, int num, size_t size = sizeof( triIndex_t ) );
	vertCacheHandle_t	AllocJoint( const void* data, int num, size_t size = sizeof( budJointMat ) );
