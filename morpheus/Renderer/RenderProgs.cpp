...
budRenderProgManager renderProgManager;

/*
================================================================================================
budRenderProgManager::budRenderProgManager()
================================================================================================
*/
budRenderProgManager::budRenderProgManager()
{
...
/*
================================================================================================
budRenderProgManager::Init()
================================================================================================
*/
void budRenderProgManager::Init()
{
	...
	for( int i = 0; i < numBuiltins; i++ )
	{
		...
		//libBud::Printf( "Loading GLSL program %i %i %i\n", i, vIndex, fIndex );
...
/*
================================================================================================
budRenderProgManager::LoadAllShaders()
================================================================================================
*/
void budRenderProgManager::LoadAllShaders()
{
...
/*
================================================================================================
budRenderProgManager::Shutdown()
================================================================================================
*/
void budRenderProgManager::Shutdown()
{
	KillAllShaders();
}
...
/*
================================================================================================
budRenderProgManager::FindVertexShader
================================================================================================
*/
...
// RB begin
bool budRenderProgManager::IsShaderBound() const
{
	return ( current != -1 );
}
// RB end
...
/*
================================================================================================
budRenderProgManager::SetRenderParms
================================================================================================
*/
void budRenderProgManager::SetRenderParms( renderParm_t rp, const float* value, int num )
{
	for( int i = 0; i < num; i++ )
	{
...
/*
================================================================================================
budRenderProgManager::SetRenderParm
================================================================================================
*/
void budRenderProgManager::SetRenderParm( renderParm_t rp, const float* value )
{
...
void RpPrintState( uint64 stateBits, uint64* stencilBits )
{
	...
	// culling
	libBud::Printf( "Culling: " );
	switch( stateBits & GLS_CULL_BITS )
	{
		case GLS_CULL_FRONTSIDED:
			libBud::Printf( "FRONTSIDED -> BACK" );
			break;
		case GLS_CULL_BACKSIDED:
			libBud::Printf( "BACKSIDED -> FRONT" );
			break;
		case GLS_CULL_TWOSIDED:
			libBud::Printf( "TWOSIDED" );
			break;
		default:
			libBud::Printf( "NA" );
			break;
	...
	// polygon mode
	libBud::Printf( "PolygonMode: %s\n", ( stateBits & GLS_POLYMODE_LINE ) ? "LINE" : "FILL" );
	
	// color mask
	libBud::Printf( "ColorMask: " );
	libBud::Printf( ( stateBits & GLS_REDMASK ) ? "_" : "R" );
	libBud::Printf( ( stateBits & GLS_GREENMASK ) ? "_" : "G" );
	libBud::Printf( ( stateBits & GLS_BLUEMASK ) ? "_" : "B" );
	libBud::Printf( ( stateBits & GLS_ALPHAMASK ) ? "_" : "A" );
	libBud::Printf( "\n" );
	
	// blend
	libBud::Printf( "Blend: src=" );
	switch( stateBits & GLS_SRCBLEND_BITS )
	{
		...
		case GLS_SRCBLEND_DST_COLOR:
			libBud::Printf( "DST_COLOR" );
			break;
		case GLS_SRCBLEND_ONE_MINUS_DST_COLOR:
			libBud::Printf( "ONE_MINUS_DST_COLOR" );
			break;
		case GLS_SRCBLEND_SRC_ALPHA:
			libBud::Printf( "SRC_ALPHA" );
			break;
		case GLS_SRCBLEND_ONE_MINUS_SRC_ALPHA:
			libBud::Printf( "ONE_MINUS_SRC_ALPHA" );
			break;
		case GLS_SRCBLEND_DST_ALPHA:
			libBud::Printf( "DST_ALPHA" );
			break;
		case GLS_SRCBLEND_ONE_MINUS_DST_ALPHA:
			libBud::Printf( "ONE_MINUS_DST_ALPHA" );
			break;
		default:
			libBud::Printf( "NA" );
			break;
	...
	switch( stateBits & GLS_DSTBLEND_BITS )
	{
		...
		case GLS_DSTBLEND_SRC_COLOR:
			libBud::Printf( "SRC_COLOR" );
			break;
		case GLS_DSTBLEND_ONE_MINUS_SRC_COLOR:
			libBud::Printf( "ONE_MINUS_SRC_COLOR" );
			break;
	...
	switch( stateBits & GLS_DEPTHFUNC_BITS )
	{
		...
		case GLS_DEPTHFUNC_ALWAYS:
			libBud::Printf( "ALWAYS" );
			break;
		case GLS_DEPTHFUNC_LESS:
			libBud::Printf( "LEQUAL" );
			break;
		case GLS_DEPTHFUNC_GREATER:
			libBud::Printf( "GEQUAL" );
			break;
		default:
			libBud::Printf( "NA" );
			break;
	...
	auto printStencil = [&]( stencilFace_t face, uint64 bits, uint64 mask, uint64 ref )
	{
		...
		switch( bits & GLS_STENCIL_FUNC_BITS )
		{
			...
			case GLS_STENCIL_FUNC_GREATER:
				libBud::Printf( "GREATER" );
				break;
			case GLS_STENCIL_FUNC_NOTEQUAL:
				libBud::Printf( "NOTEQUAL" );
				break;
		...
		switch( bits & GLS_STENCIL_OP_FAIL_BITS )
		{
			...
			case GLS_STENCIL_OP_FAIL_INVERT:
				libBud::Printf( "INVERT" );
				break;
			case GLS_STENCIL_OP_FAIL_INCR_WRAP:
				libBud::Printf( "INCR_WRAP" );
				break;
			case GLS_STENCIL_OP_FAIL_DECR_WRAP:
				libBud::Printf( "DECR_WRAP" );
				break;
			default:
				libBud::Printf( "NA" );
				break;
		...
		libBud::Printf( ", mask=%llu, ref=%llu\n", mask, ref );
	};
