...
/*
===============
budRenderModelSprite::IsDynamicModel
===============
*/
dynamicModel_t budRenderModelSprite::IsDynamicModel() const
{
...
/*
===============
budRenderModelSprite::IsLoaded
===============
*/
bool budRenderModelSprite::IsLoaded() const
{
	return true;
}
...
/*
===============
budRenderModelSprite::InstantiateDynamicModel
===============
*/
budRenderModel* 	budRenderModelSprite::InstantiateDynamicModel( const struct renderEntity_s* renderEntity, const viewDef_t* viewDef, budRenderModel* cachedModel )
{
...
/*
===============
budRenderModelSprite::Bounds
===============
*/
budBounds budRenderModelSprite::Bounds( const struct renderEntity_s* renderEntity ) const
{
	budBounds b;
