...
===============================================================================
	...
	budRenderSystem is responsible for managing the screen, which can have
	multiple budRenderWorld and 2D drawing done on it.
...
class budRenderSystem
{
public:

	virtual					~budRenderSystem() {}
	...
	virtual budRenderWorld* 	AllocRenderWorld() = 0;
	virtual	void			FreeRenderWorld( budRenderWorld* rw ) = 0;
...
extern budRenderSystem* 			renderSystem;
