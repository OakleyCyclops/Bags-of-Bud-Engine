...
/*
========================
budBinaryImage::Load2DFromMemory
========================
*/
void budBinaryImage::Load2DFromMemory( int width, int height, const byte* pic_const, int numLevels, textureFormat_t& textureFormat, textureColor_t& colorFormat, bool gammaMips )
{
	...
	{
		budBinaryImageData& img = images[ level ];
...
/*
========================
budBinaryImage::LoadCubeFromMemory
========================
*/
void budBinaryImage::LoadCubeFromMemory( int width, const byte* pics[6], int numLevels, textureFormat_t& textureFormat, bool gammaMips )
{
	...
	for( int side = 0; side < 6; side++ )
	{
		...
		{
			// compress data or convert floats as necessary
			budBinaryImageData& img = images[ level * 6 + side ];
...
/*
========================
budBinaryImage::WriteGeneratedFile
========================
*/
ID_TIME_T budBinaryImage::WriteGeneratedFile( ID_TIME_T sourceFileTime )
{
	...
	if( file == NULL )
	{
		libBud::Warning( "budBinaryImage: Could not open file '%s'", binaryFileName.c_str() );
		return FILE_NOT_FOUND_TIMESTAMP;
	}
	libBud::Printf( "Writing %s: %ix%i\n", binaryFileName.c_str(), fileData.width, fileData.height );
	...
	{
		budBinaryImageData& img = images[ i ];
...
/*
==========================
budBinaryImage::LoadFromGeneratedFile
...
==========================
*/
bool budBinaryImage::LoadFromGeneratedFile( budFile* bFile, ID_TIME_T sourceTimeStamp )
{
