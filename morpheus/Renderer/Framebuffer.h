...
public:
	...
	void					AttachImage2D( int target, const budImage* image, int index, int mipmapLod = 0 );
	void					AttachImage3D( const budImage* image );
	void					AttachImageDepth( int target, const budImage* image );
	void					AttachImageDepthLayer( const budImage* image, int layer );
