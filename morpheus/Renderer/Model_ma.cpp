...
void MA_ParseNodeHeader( budParser& parser, maNodeHeader_t* header )
{
...
bool MA_ParseAttribHeader( budParser& parser, maAttribHeader_t* header )
{
...
bool IsNodeComplete( budToken& token )
{
...
bool MA_ParseTransform( budParser& parser )
{
...
bool MA_ParseVertex( budParser& parser, maAttribHeader_t* header )
{
...
bool MA_ParseVertexTransforms( budParser& parser, maAttribHeader_t* header )
{
...
bool MA_ParseEdge( budParser& parser, maAttribHeader_t* header )
{
...
bool MA_ParseNormal( budParser& parser, maAttribHeader_t* header )
{
...
bool MA_ParseFace( budParser& parser, maAttribHeader_t* header )
{
...
bool MA_ParseColor( budParser& parser, maAttribHeader_t* header )
{
...
bool MA_ParseTVert( budParser& parser, maAttribHeader_t* header )
{
...
void MA_ParseMesh( budParser& parser )
{
...
void MA_ParseFileNode( budParser& parser )
{
...
void MA_ParseMaterialNode( budParser& parser )
{
...
void MA_ParseCreateNode( budParser& parser )
{
