...
==============
*/
void		budRenderWorldLocal::StartWritingDemo( budDemoFile* demo )
{
	int		i;
	
	// FIXME: we should track the budDemoFile locally, instead of snooping into session for it
...
void budRenderWorldLocal::StopWritingDemo()
{
//	writeDemo = NULL;
}
...
==============
*/
bool		budRenderWorldLocal::ProcessDemoCommand( budDemoFile* readDemo, renderView_t* renderView, int* demoTimeOffset )
{
	bool	newMap = false;
...
================
*/
void	budRenderWorldLocal::WriteLoadMap()
{
	...
	budDemoFile* f = common->WriteDemo();
...
================
*/
void	budRenderWorldLocal::WriteVisibleDefs( const viewDef_t* viewDef )
{
	// only the main renderWorld writes stuff to demos, not the wipes or
	// menu renders
	if( this != common->RW() )
	...
	{
		budRenderEntityLocal* ent = viewEnt->entityDef;
	...
	{
		budRenderLightLocal* light = viewLight->lightDef;
...
================
*/
void	budRenderWorldLocal::WriteRenderView( const renderView_t* renderView )
{
	int i;
...
================
*/
void	budRenderWorldLocal::WriteFreeEntity( qhandle_t handle )
{
...
================
*/
void	budRenderWorldLocal::WriteFreeLight( qhandle_t handle )
{
...
================
*/
void	budRenderWorldLocal::WriteRenderLight( budDemoFile* f, qhandle_t handle, const renderLight_t* light )
{
...
================
*/
void	budRenderWorldLocal::ReadRenderLight( )
{
	renderLight_t	light;
	int				index, i;
...
================
*/
void	budRenderWorldLocal::WriteRenderEntity( budDemoFile* f, budRenderEntityLocal* entity )
{
	// only the main renderWorld writes stuff to demos, not the wipes or
	// menu renders
	if( this != common->RW() )
...
================
*/
void budRenderWorldLocal::ReadRenderEntity()
{
	renderEntity_t ent;
	int index;
	...
	budRenderEntityLocal* def = entityDefs[ index ];
	if( def == NULL )
	{
...
void budRenderWorldLocal::WriteRenderDecal( budDemoFile* f, qhandle_t handle )
{
	// only the main renderWorld writes stuff to demos, not the wipes or
	// menu renders
	if( this != common->RW() )
...
void budRenderWorldLocal::WriteFreeDecal( budDemoFile* f, qhandle_t handle )
{
	// only the main renderWorld writes stuff to demos, not the wipes or
	// menu renders
	if( this != common->RW() )
...
void budRenderWorldLocal::WriteRenderOverlay( budDemoFile* f, qhandle_t handle )
{
	// only the main renderWorld writes stuff to demos, not the wipes or
	// menu renders
	if( this != common->RW() )
...
void budRenderWorldLocal::WriteFreeOverlay( budDemoFile* f, qhandle_t handle )
{
	// only the main renderWorld writes stuff to demos, not the wipes or
	// menu renders
	if( this != common->RW() )
