...
public:
	...
	void	SetIndex( const int index, const budBounds& bounds );
	...
	int		FindIntersections( const budBounds& testBounds, int intersectedIndexes[ MAX_BOUNDS_TRACK_INDEXES ] ) const;
