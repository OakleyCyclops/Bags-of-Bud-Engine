...
/*
====================
budRenderModelPrt::budRenderModelPrt
====================
*/
budRenderModelPrt::budRenderModelPrt()
{
...
/*
====================
budRenderModelPrt::InitFromFile
====================
*/
void budRenderModelPrt::InitFromFile( const char* fileName )
{
	name = fileName;
	particleSystem = static_cast<const budDeclParticle*>( declManager->FindType( DECL_PARTICLE, fileName ) );
}

/*
=================
budRenderModelPrt::TouchData
=================
*/
void budRenderModelPrt::TouchData()
{
	// Ensure our particle system is added to the list of referenced decls
	particleSystem = static_cast<const budDeclParticle*>( declManager->FindType( DECL_PARTICLE, name ) );
}

/*
====================
budRenderModelPrt::InstantiateDynamicModel
====================
*/
budRenderModel* budRenderModelPrt::InstantiateDynamicModel( const struct renderEntity_s* renderEntity, const viewDef_t* viewDef, budRenderModel* cachedModel )
{
	...
	*/
	...
	for( int stageNum = 0; stageNum < particleSystem->stages.Num(); stageNum++ )
	{
		...
		int numVerts = 0;
		budDrawVert* verts = surf->geometry->verts;
...
/*
====================
budRenderModelPrt::IsDynamicModel
====================
*/
dynamicModel_t budRenderModelPrt::IsDynamicModel() const
{
...
/*
====================
budRenderModelPrt::Bounds
====================
*/
budBounds budRenderModelPrt::Bounds( const struct renderEntity_s* ent ) const
{
...
/*
====================
budRenderModelPrt::DepthHack
====================
*/
float budRenderModelPrt::DepthHack() const
{
...
/*
====================
budRenderModelPrt::Memory
====================
*/
int budRenderModelPrt::Memory() const
{
	int total = 0;
	
	total += budRenderModelStatic::Memory();
