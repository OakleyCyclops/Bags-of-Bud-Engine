...
void PC_BeginNamedEvent( const char* szName, ... )
{
	...
	{
		libBud::FatalError( "PC_BeginNamedEvent: event overflow" );
	}
	if( ++numPixLevels > 1 )
	{
...
void PC_EndNamedEvent()
{
	...
	if( numPixLevels <= 0 )
	{
		libBud::FatalError( "PC_EndNamedEvent: level underflow" );
	}
	if( --numPixLevels > 0 )
	{
...
budRenderLog	renderLog;

#if !defined( STUB_RENDER_LOG )

/*
========================
budRenderLog::budRenderLog
========================
*/
budRenderLog::budRenderLog()
{
...
/*
========================
budRenderLog::StartFrame
========================
*/
void budRenderLog::StartFrame()
{
	...
	*/
	...
	if( logFile == NULL )
	{
		libBud::Warning( "Failed to open logfile %s", ospath );
		return;
	}
	libBud::Printf( "Opened logfile %s\n", ospath );
...
/*
========================
budRenderLog::EndFrame
========================
*/
void budRenderLog::EndFrame()
{
	PC_EndFrame();
...
========================
*/
void budRenderLog::Close()
{
	//if( logFile != NULL )
	if( r_logFile.GetInteger() != 0 )
	{
		CloseBlock();
		//libBud::Printf( "Closing logfile\n" );
		//fileSystem->CloseFile( logFile );
		//logFile = NULL;
		activeLevel = 0;
	}
...
/*
========================
budRenderLog::OpenMainBlock
========================
*/
void budRenderLog::OpenMainBlock( renderLogMainBlock_t block )
{
}

/*
========================
budRenderLog::CloseMainBlock
========================
*/
void budRenderLog::CloseMainBlock()
{
}

/*
========================
budRenderLog::OpenBlock
========================
*/
void budRenderLog::OpenBlock( const char* label )
{
...
/*
========================
budRenderLog::CloseBlock
========================
*/
void budRenderLog::CloseBlock()
{
	PC_EndNamedEvent();
...
========================
*/
void budRenderLog::Printf( const char* fmt, ... )
{
#if !defined(USE_VULKAN)
...
/*
========================
budRenderLog::LogOpenBlock
========================
*/
void budRenderLog::LogOpenBlock( renderLogIndentLabel_t label, const char* fmt, ... )
{
	...
	{
		libBud::Warning( "logLevel %d >= MAX_LOG_LEVELS", logLevel );
	}
...
/*
========================
budRenderLog::LogCloseBlock
========================
*/
void budRenderLog::LogCloseBlock( renderLogIndentLabel_t label )
{
