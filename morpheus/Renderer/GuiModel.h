...
public:
	...
	void		WriteToDemo( budDemoFile* demo );
	void		ReadFromDemo( budDemoFile* demo );
	...
	budDrawVert* AllocTris( int numVerts, const triIndex_t* indexes, int numIndexes, const budMaterial* material,
