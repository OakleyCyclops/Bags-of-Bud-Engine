...
/*
====================
budRenderModelLiquid::budRenderModelLiquid
====================
*/
budRenderModelLiquid::budRenderModelLiquid()
{
...
/*
====================
budRenderModelLiquid::GenerateSurface
====================
*/
modelSurface_t budRenderModelLiquid::GenerateSurface( float lerp )
{
	srfTriangles_t*	tri;
	int				i, base;
	budDrawVert*		vert;
...
/*
====================
budRenderModelLiquid::WaterDrop
====================
*/
void budRenderModelLiquid::WaterDrop( int x, int y, float* page )
{
	int		cx, cy;
...
/*
====================
budRenderModelLiquid::IntersectBounds
====================
*/
void budRenderModelLiquid::IntersectBounds( const budBounds& bounds, float displacement )
{
	int		cx, cy;
	int		left, top, right, bottom;
	float	up, down;
...
/*
====================
budRenderModelLiquid::Update
====================
*/
void budRenderModelLiquid::Update()
{
	int		x, y;
	float*	p2;
	float*	p1;
...
/*
====================
budRenderModelLiquid::Reset
====================
*/
void budRenderModelLiquid::Reset()
{
	int	i, x, y;
...
/*
====================
budRenderModelLiquid::InitFromFile
====================
*/
void budRenderModelLiquid::InitFromFile( const char* fileName )
{
	int				i, x, y;
	budToken			token;
...
/*
====================
budRenderModelLiquid::InstantiateDynamicModel
====================
*/
budRenderModel* budRenderModelLiquid::InstantiateDynamicModel( const struct renderEntity_s* ent, const viewDef_t* view, budRenderModel* cachedModel )
{
...
/*
====================
budRenderModelLiquid::IsDynamicModel
====================
*/
dynamicModel_t budRenderModelLiquid::IsDynamicModel() const
{
...
/*
====================
budRenderModelLiquid::Bounds
====================
*/
budBounds budRenderModelLiquid::Bounds( const struct renderEntity_s* ent ) const
{
