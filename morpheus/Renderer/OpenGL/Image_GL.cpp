...
====================
*/
budImage::budImage( const char* name ) : imgName( name )
{
...
void budImage::Bind()
{
	RENDERLOG_PRINTF( "budImage::Bind( %s )\n", GetName() );
...
====================
*/
void budImage::CopyFramebuffer( int x, int y, int imageWidth, int imageHeight )
{
	...
	switch( opts.textureType )
	{
		...
		case TT_2D_MULTISAMPLE:
			...
			break;
		default:
			//libBud::FatalError( "%s: bad texture type %d", GetName(), opts.textureType );
			return;
	}
...
====================
*/
void budImage::CopyDepthbuffer( int x, int y, int imageWidth, int imageHeight )
{
...
/*
========================
budImage::SubImageUpload
========================
*/
void budImage::SubImageUpload( int mipLevel, int x, int y, int z, int width, int height, const void* pic, int pixelPitch )
{
...
/*
========================
budImage::SetSamplerState
========================
*/
void budImage::SetSamplerState( textureFilter_t tf, textureRepeat_t tr )
{
...
========================
*/
void budImage::SetPixel( int mipLevel, int x, int y, const void* data, int dataSize )
{
...
/*
========================
budImage::SetTexParameters
========================
*/
void budImage::SetTexParameters()
{
	int target = GL_TEXTURE_2D;
	switch( opts.textureType )
	{
...
void budImage::AllocImage()
{
	...
	switch( opts.format )
	{
		...
		case FMT_Y16_X16:
			...
			break;
		default:
			libBud::Error( "Unhandled image format %d in %s\n", opts.format, GetName() );
	}
...
========================
*/
void budImage::Resize( int width, int height )
{
