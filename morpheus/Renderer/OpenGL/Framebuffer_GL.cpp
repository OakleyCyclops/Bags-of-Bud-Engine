...
void Framebuffer::AttachImage2D( int target, const budImage* image, int index, int mipmapLod )
{
...
void Framebuffer::AttachImageDepth( int target, const budImage* image )
{
...
void Framebuffer::AttachImageDepthLayer( const budImage* image, int layer )
{
