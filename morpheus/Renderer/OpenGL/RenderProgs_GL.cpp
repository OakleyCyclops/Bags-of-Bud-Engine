...
/*
========================
budRenderProgManager::StartFrame
========================
*/
void budRenderProgManager::StartFrame()
{
...
/*
================================================================================================
budRenderProgManager::BindProgram
================================================================================================
*/
void budRenderProgManager::BindProgram( int index )
{
	if( current == index )
	{
		return;
...
/*
================================================================================================
budRenderProgManager::Unbind
================================================================================================
*/
void budRenderProgManager::Unbind()
{
	current = -1;
...
/*
================================================================================================
budRenderProgManager::LoadShader
================================================================================================
*/
void budRenderProgManager::LoadShader( int index, rpStage_t stage )
{
...
/*
================================================================================================
budRenderProgManager::LoadGLSLShader
================================================================================================
*/
void budRenderProgManager::LoadShader( shader_t& shader )
{
	...
	else
	{
		...
		if( lengthGLSL <= 0 )
		{
			libBud::Error( "GLSL file %s could not be loaded and may be corrupt", outFileGLSL.c_str() );
		}
		...
		
		{
			...
			if( lengthUniforms <= 0 )
			{
				libBud::Error( "uniform file %s could not be loaded and may be corrupt", outFileUniforms.c_str() );
			}
	...
	// this uses the new layout structure
	{
		...
		budLexer src( programUniforms, programUniforms.Length(), "uniforms" );
		budToken token;
		if( src.ExpectTokenString( "uniforms" ) )
		{
			...
			while( !src.CheckTokenString( "]" ) )
			{
				...
				if( index == -1 )
				{
					libBud::Error( "couldn't find uniform %s for %s", token.c_str(), outFileGLSL.c_str() );
				}
	...
	if( shader.progId )
	{
		...
		if( infologLength > 1 )
		{
			...
			{
				//libBud::Printf( "%s program %s from %s compiled to run on hardware\n", typeName, GetName(), GetFileName() );
			}
...
/*
================================================================================================
budRenderProgManager::LoadGLSLProgram
================================================================================================
*/
void budRenderProgManager::LoadGLSLProgram( const int programIndex, const int vertexShaderIndex, const int fragmentShaderIndex )
{
	...
	if( program )
	{
		...
		if( infologLength > 1 )
		{
			...
			{
				//libBud::Printf( "render prog %s from %s linked\n", GetName(), GetFileName() );
			}
			else
			{
				libBud::Printf( "While linking GLSL program %d with vertexShader %s and fragmentShader %s\n",
							   programIndex,
	...
	if( linked == GL_FALSE )
	{
		...
		libBud::Error( "While linking GLSL program %d with vertexShader %s and fragmentShader %s\n",
					  programIndex,
					  ( vertexShaderIndex >= 0 ) ? shaders[vertexShaderIndex].name.c_str() : "<Invalid>",
					  ( fragmentShaderIndex >= 0 ) ? shaders[ fragmentShaderIndex ].name.c_str() : "<Invalid>" );
		return;
...
/*
================================================================================================
budRenderProgManager::CommitUnforms
================================================================================================
*/
void budRenderProgManager::CommitUniforms( uint64 stateBits )
{
...
/*
================================================================================================
budRenderProgManager::KillAllShaders()
================================================================================================
*/
void budRenderProgManager::KillAllShaders()
{
	Unbind();
...
/*
====================
budRenderBackend::ResizeImages
====================
*/
void budRenderBackend::ResizeImages()
{
