...
/*
================
budRenderBackend::DBG_SimpleSurfaceSetup
================
*/
void budRenderBackend::DBG_SimpleSurfaceSetup( const drawSurf_t* drawSurf )
{
...
/*
================
budRenderBackend::DBG_SimpleWorldSetup
================
*/
void budRenderBackend::DBG_SimpleWorldSetup()
{
...
/*
=================
budRenderBackend::DBG_PolygonClear
...
=================
*/
void budRenderBackend::DBG_PolygonClear()
{
	glPushMatrix();
...
/*
====================
budRenderBackend::DBG_ShowDestinationAlpha
====================
*/
void budRenderBackend::DBG_ShowDestinationAlpha()
{
...
/*
===================
budRenderBackend::DBG_ScanStencilBuffer

Debugging tool to see what values are in the stencil buffer
===================
*/
void budRenderBackend::DBG_ScanStencilBuffer()
{
	int		counts[256];
	int		i;
...
/*
===================
budRenderBackend::DBG_CountStencilBuffer

Print an overdraw count based on stencil index values
===================
*/
void budRenderBackend::DBG_CountStencilBuffer()
{
	int		count;
	int		i;
	byte*	stencilReadback;
...
/*
===================
budRenderBackend::DBG_ColorByStencilBuffer
...
/*
==================
budRenderBackend::DBG_ShowOverdraw
==================
*/
void budRenderBackend::DBG_ShowOverdraw()
{
...
/*
===================
budRenderBackend::DBG_ShowIntensity
...
===================
*/
void budRenderBackend::DBG_ShowIntensity()
{
	byte*	colorReadback;
	int		i, j, c;
...
/*
===================
budRenderBackend::DBG_ShowDepthBuffer

Draw the depth buffer as colors
===================
*/
void budRenderBackend::DBG_ShowDepthBuffer()
{
	void*	depthReadback;
...
/*
====================
budRenderBackend::DBG_RenderDrawSurfListWithFunction
...
====================
*/
void budRenderBackend::DBG_RenderDrawSurfListWithFunction( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	currentSpace = NULL;
...
/*
=================
budRenderBackend::DBG_ShowSilhouette
...
=================
*/
void budRenderBackend::DBG_ShowSilhouette()
{
	int		i;
	const drawSurf_t*	surf;
	const viewLight_t*	vLight;
...
/*
=====================
budRenderBackend::DBG_ShowTris

Debugging tool
=====================
*/
void budRenderBackend::DBG_ShowTris( drawSurf_t** drawSurfs, int numDrawSurfs )
{
...
/*
=====================
budRenderBackend::DBG_ShowSurfaceInfo
...
void budRenderSystemLocal::OnFrame()
{
...
void budRenderBackend::DBG_ShowSurfaceInfo( drawSurf_t** drawSurfs, int numDrawSurfs )
{
...
/*
=====================
budRenderBackend::DBG_ShowViewEntitys

Debugging tool
=====================
*/
void budRenderBackend::DBG_ShowViewEntitys( viewEntity_t* vModels )
{
	...
	for( const viewEntity_t* vModel = vModels; vModel; vModel = vModel->next )
	{
		...
		const budRenderEntityLocal* edef = vModel->entityDef;
		if( !edef )
		{
			continue;
		}
		...
		if( r_showViewEntitys.GetInteger() >= 3 )
		{
			...
			budRenderModel* model = R_EntityDefDynamicModel( vModel->entityDef );
			if( !model )
			{
...
/*
=====================
budRenderBackend::DBG_ShowTexturePolarity
...
=====================
*/
void budRenderBackend::DBG_ShowTexturePolarity( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	int		i, j;
	drawSurf_t*	drawSurf;
...
/*
=====================
budRenderBackend::DBG_ShowUnsmoothedTangents

Shade materials that are using unsmoothed tangents
=====================
*/
void budRenderBackend::DBG_ShowUnsmoothedTangents( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	int		i, j;
	drawSurf_t*	drawSurf;
	const srfTriangles_t*	tri;
...
=====================
*/
void budRenderBackend::DBG_ShowTangentSpace( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	int		i, j;
	drawSurf_t*	drawSurf;
	const srfTriangles_t*	tri;
...
/*
=====================
budRenderBackend::DBG_ShowVertexColor

Draw each triangle with the solid vertex colors
=====================
*/
void budRenderBackend::DBG_ShowVertexColor( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	int		i, j;
	drawSurf_t*	drawSurf;
	const srfTriangles_t*	tri;
...
/*
=====================
budRenderBackend::DBG_ShowNormals

Debugging tool
=====================
*/
void budRenderBackend::DBG_ShowNormals( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	int			i, j;
	drawSurf_t*	drawSurf;
	Vector3		end;
...
/*
=====================
budRenderBackend::DBG_ShowTextureVectors

Draw texture vectors in the center of each triangle
=====================
*/
void budRenderBackend::DBG_ShowTextureVectors( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	...
	for( int i = 0; i < numDrawSurfs; i++ )
	{
		...
		for( int j = 0; j < tri->numIndexes; j += 3 )
		{
			...
			const budDrawVert* c = &tri->verts[tri->indexes[j + 2]];
...
/*
=====================
budRenderBackend::DBG_ShowDominantTris

Draw lines from each vertex to the dominant triangle center
=====================
*/
void budRenderBackend::DBG_ShowDominantTris( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	int			i, j;
	drawSurf_t*	drawSurf;
	const srfTriangles_t*	tri;
...
/*
=====================
budRenderBackend::DBG_ShowEdges

Debugging tool
=====================
*/
void budRenderBackend::DBG_ShowEdges( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	int			i, j, k, m, n, o;
	drawSurf_t*	drawSurf;
	const srfTriangles_t*	tri;
	...
	for( i = 0; i < numDrawSurfs; i++ )
	{
		...
		budDrawVert* ac = ( budDrawVert* )tri->verts;
		if( !ac )
		{
			continue;
		}
...
==============
*/
void budRenderBackend::DBG_ShowLights()
{
...
// RB begin
void budRenderBackend::DBG_ShowShadowMapLODs()
{
...
/*
=====================
budRenderBackend::DBG_ShowPortals

Debugging tool, won't work correctly with SMP or when mirrors are present
=====================
*/
void budRenderBackend::DBG_ShowPortals()
{
	...
	budRenderWorldLocal& world = *viewDef->renderWorld;
...
/*
================
budRenderBackend::DBG_ClearDebugText
================
*/
...
/*
================
budRenderBackend::DBG_ShowDebugText
================
*/
void budRenderBackend::DBG_ShowDebugText()
{
	int			i;
	int			width;
	debugText_t*	text;
...
/*
================
budRenderBackend::DBG_ShowDebugLines
================
*/
void budRenderBackend::DBG_ShowDebugLines()
{
	int			i;
	int			width;
	debugLine_t*	line;
...
/*
================
budRenderBackend::DBG_ShowDebugPolygons
================
*/
void budRenderBackend::DBG_ShowDebugPolygons()
{
	int				i, j;
	debugPolygon_t*	poly;
...
/*
================
budRenderBackend::DBG_ShowCenterOfProjection
================
*/
void budRenderBackend::DBG_ShowCenterOfProjection()
{
...
/*
================
budRenderBackend::DBG_ShowLines

Draw exact pixel lines to check pixel center sampling
================
*/
void budRenderBackend::DBG_ShowLines()
{
...
/*
================
budRenderBackend::DBG_TestGamma
================
*/
#define	G_WIDTH		512
#define	G_HEIGHT	512
...
void budRenderBackend::DBG_TestGamma()
{
...
/*
==================
budRenderBackend::DBG_TestGammaBias
==================
*/
void budRenderBackend::DBG_TestGammaBias()
{
	byte	image[G_HEIGHT][G_WIDTH][4];
...
/*
================
budRenderBackend::DBG_TestImage

Display a single image over most of the screen
================
*/
void budRenderBackend::DBG_TestImage()
{
	budImage*	image = NULL;
	budImage* imageCr = NULL;
	budImage* imageCb = NULL;
	int		max;
	float	w, h;
...
// RB begin
void budRenderBackend::DBG_ShowShadowMaps()
{
	budImage*	image = NULL;
	int		max;
	float	w, h;
...
/*
================
budRenderBackend::DBG_ShowTrace
...
================
*/
void budRenderBackend::DBG_ShowTrace( drawSurf_t** drawSurfs, int numDrawSurfs )
{
	int						i;
	const srfTriangles_t*	tri;
	const drawSurf_t*		surf;
	...
	for( i = 0; i < numDrawSurfs; i++ )
	{
		...
		{
			GL_Color( 1, 1, 1, 1 );
			RB_DrawBounds( budBounds( hit.point ).Expand( 1 ) );
		}
	}
}
...
/*
=================
budRenderBackend::DBG_RenderDebugTools
=================
*/
void budRenderBackend::DBG_RenderDebugTools( drawSurf_t** drawSurfs, int numDrawSurfs )
{
