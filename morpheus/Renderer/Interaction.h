...
class budRenderEntityLocal;
class budRenderLightLocal;

class budInteraction
{
public:
	...
	budInteraction* 			lightNext;				// for lightDef chains
	budInteraction* 			lightPrev;
	budInteraction* 			entityNext;				// for entityDef chains
	budInteraction* 			entityPrev;
...
public:
	...
	// and fragmentation
	static budInteraction* 	AllocAndLink( budRenderEntityLocal* edef, budRenderLightLocal* ldef );
