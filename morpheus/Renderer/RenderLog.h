...
/*
================================================
budRenderLog contains block-based performance-tuning information. It combines
...
========================
*/
BUD_INLINE void budRenderLog::Indent( renderLogIndentLabel_t label )
{
	//if( logFile != NULL )
...
/*
========================
budRenderLog::Outdent
========================
*/
BUD_INLINE void budRenderLog::Outdent( renderLogIndentLabel_t label )
{
...
/*
================================================
budRenderLog stubbed version for the SPUs and high
