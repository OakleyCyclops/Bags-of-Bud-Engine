...
===============================================================================
	...
	Multiple budCinematics can run simultaniously.
	A single budCinematic can be reused for multiple files if desired.
...
public:
	...
	static budCinematic*	Alloc();
	
	// frees all allocated memory
	virtual				~budCinematic();
...
class idSndWindow : public budCinematic
{
public:
