...
// RB begin
const char* budRenderProgManager::GLSLMacroNames[MAX_SHADER_MACRO_NAMES] =
{
	"USE_GPU_SKINNING",
	"LIGHT_POINT",
	"LIGHT_PARALLEL",
...
const char* budRenderProgManager::FindEmbeddedSourceShader( const char* name )
{
...
class budParser_EmbeddedGLSL : public budParser
{
public:
	budParser_EmbeddedGLSL( int flags ) : budParser( flags )
	{
	}
	
private:
	int		Directive_include( budToken* token, bool supressWarning )
	{
		if( budParser::Directive_include( token, true ) )
		{
		...
		*/
		...
		if( token->type == TT_STRING )
		{
			...
			const char* embeddedSource = budRenderProgManager::FindEmbeddedSourceShader( path );
			if( embeddedSource == NULL )
			{
				// try absolute path
				path = *token;
				embeddedSource = budRenderProgManager::FindEmbeddedSourceShader( path );
				if( embeddedSource == NULL )
				{
		...
		else if( token->type == TT_PUNCTUATION && *token == "<" )
		{
			...
			const char* embeddedSource = budRenderProgManager::FindEmbeddedSourceShader( includepath + path );
...
/*
================================================================================================
budRenderProgManager::FindGLSLProgram
================================================================================================
*/
int	 budRenderProgManager::FindGLSLProgram( const char* name, int vIndex, int fIndex )
{
...
/*
================================================================================================
budRenderProgManager::GetGLSLParmName
================================================================================================
*/
const char* budRenderProgManager::GetGLSLParmName( int rp ) const
{
...
// RB begin
const char* budRenderProgManager::GetGLSLMacroName( shaderFeature_t sf ) const
{
...
/*
================================================================================================
budRenderProgManager::SetUniformValue
================================================================================================
*/
void budRenderProgManager::SetUniformValue( const renderParm_t rp, const float* value )
{
	for( int i = 0; i < 4; i++ )
	{
...
/*
================================================================================================
budRenderProgManager::ZeroUniforms
================================================================================================
*/
void budRenderProgManager::ZeroUniforms()
{
