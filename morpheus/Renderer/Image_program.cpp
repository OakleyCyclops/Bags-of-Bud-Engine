...
===================
*/
static void AppendToken( budToken& token )
{
...
===================
*/
static void MatchAndAppendToken( budLexer& src, const char* match )
{
...
===================
*/
static bool R_ParseImageProgram_r( budLexer& src, byte** pic, int* width, int* height,
