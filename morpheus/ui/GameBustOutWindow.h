...
public:
	...
	budGameBustOutWindow* 	game;
	
public:
	BOEntity( budGameBustOutWindow* _game );
	virtual					~BOEntity();
	
	virtual void			WriteToSaveGame( budFile* savefile );
	virtual void			ReadFromSaveGame( budFile* savefile, budGameBustOutWindow* _game );
...
class budGameBustOutWindow : public idWindow
{
public:
	budGameBustOutWindow( budUserInterfaceLocal* gui );
