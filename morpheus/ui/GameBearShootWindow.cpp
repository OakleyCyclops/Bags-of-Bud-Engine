...
****************************************************************************
*/
BSEntity::BSEntity( budGameBearShootWindow* _game )
{
	game = _game;
	visible = true;
...
======================
*/
void BSEntity::WriteToSaveGame( budFile* savefile )
{
...
======================
*/
void BSEntity::ReadFromSaveGame( budFile* savefile, budGameBearShootWindow* _game )
{
	game = _game;
...
/*
*****************************************************************************
* budGameBearShootWindow
****************************************************************************
*/

budGameBearShootWindow::budGameBearShootWindow( budUserInterfaceLocal* g ) : idWindow( g )
{
	gui = g;
	CommonInit();
}

budGameBearShootWindow::~budGameBearShootWindow()
{
...
/*
=============================
budGameBearShootWindow::WriteToSaveGame
=============================
*/
void budGameBearShootWindow::WriteToSaveGame( budFile* savefile )
{
...
/*
=============================
budGameBearShootWindow::ReadFromSaveGame
=============================
*/
void budGameBearShootWindow::ReadFromSaveGame( budFile* savefile )
{
...
/*
=============================
budGameBearShootWindow::ResetGameState
=============================
*/
void budGameBearShootWindow::ResetGameState()
{
	gamerunning = false;
	gameOver = false;
	onFire = false;
...
/*
=============================
budGameBearShootWindow::CommonInit
=============================
*/
void budGameBearShootWindow::CommonInit()
{
	BSEntity* 			ent;
...
/*
=============================
budGameBearShootWindow::HandleEvent
=============================
*/
const char* budGameBearShootWindow::HandleEvent( const sysEvent_t* event, bool* updateVisuals )
{
...
/*
=============================
budGameBearShootWindow::ParseInternalVar
=============================
*/
...
/*
=============================
budGameBearShootWindow::GetWinVarByName
=============================
*/
idWinVar* budGameBearShootWindow::GetWinVarByName( const char* _name, bool winLookup, drawWin_t** owner )
{
...
/*
=============================
budGameBearShootWindow::PostParse
=============================
*/
void budGameBearShootWindow::PostParse()
{
	idWindow::PostParse();
}
...
/*
=============================
budGameBearShootWindow::Draw
=============================
*/
void budGameBearShootWindow::Draw( int time, float x, float y )
{
	int i;
...
/*
=============================
budGameBearShootWindow::Activate
=============================
*/
const char* budGameBearShootWindow::Activate( bool activate )
{
	return "";
}
...
/*
=============================
budGameBearShootWindow::UpdateTurret
=============================
*/
...
/*
=============================
budGameBearShootWindow::UpdateBear
=============================
*/
void budGameBearShootWindow::UpdateBear()
{
...
/*
=============================
budGameBearShootWindow::UpdateHelicopter
=============================
*/
void budGameBearShootWindow::UpdateHelicopter()
{
...
/*
=============================
budGameBearShootWindow::UpdateButtons
=============================
*/
void budGameBearShootWindow::UpdateButtons()
{
...
/*
=============================
budGameBearShootWindow::UpdateScore
=============================
*/
void budGameBearShootWindow::UpdateScore()
{
...
/*
=============================
budGameBearShootWindow::UpdateGame
=============================
*/
void budGameBearShootWindow::UpdateGame()
{
	int i;
