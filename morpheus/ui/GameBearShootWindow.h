...
public:
	...
	budGameBearShootWindow* 	game;
	
public:
	BSEntity( budGameBearShootWindow* _game );
	virtual				~BSEntity();
	
	virtual void		WriteToSaveGame( budFile* savefile );
	virtual void		ReadFromSaveGame( budFile* savefile, budGameBearShootWindow* _game );
...
class budGameBearShootWindow : public idWindow
{
public:
	budGameBearShootWindow( budUserInterfaceLocal* gui );
