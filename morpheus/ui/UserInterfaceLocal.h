...
class budUserInterfaceLocal : public budUserInterface
{
	friend class budUserInterfaceManagerLocal;
public:
	budUserInterfaceLocal();
	virtual						~budUserInterfaceLocal();
	...
	virtual bool				WriteToSaveGame( budFile* savefile ) const;
	virtual bool				ReadFromSaveGame( budFile* savefile );
...
class budUserInterfaceManagerLocal : public budUserInterfaceManager
{
...
public:
	...
	virtual budUserInterface* 	Alloc() const;
