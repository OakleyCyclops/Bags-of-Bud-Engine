...
/*
=========================
budGuiScript::WriteToSaveGame
=========================
*/
void budGuiScript::WriteToSaveGame( budFile* savefile )
{
	int i;
...
/*
=========================
budGuiScript::ReadFromSaveGame
=========================
*/
void budGuiScript::ReadFromSaveGame( budFile* savefile )
{
	int i;
...
=========================
*/
bool budGuiScript::Parse( budTokenParser* src )
{
	int i;
...
/*
=========================
budGuiScriptList::Execute
=========================
*/
void budGuiScriptList::Execute( idWindow* win )
{
	int c = list.Num();
	for( int i = 0; i < c; i++ )
	{
		budGuiScript* gs = list[i];
		assert( gs );
...
/*
=========================
budGuiScriptList::FixupParms
=========================
*/
void budGuiScript::FixupParms( idWindow* win )
{
	if( handler == &Script_Set )
	{
		...
		for( int i = 1; i < parmCount; i++ )
		{
			...
			{
				const budMaterial* mat = declManager->FindMaterial( str->c_str() );
				mat->SetSort( SS_GUI );
			}
			else if( precacheSounds )
			{
				// Search for "play <...>"
				budToken token;
				budParser parser( LEXFL_NOSTRINGCONCAT | LEXFL_ALLOWMULTICHARLITERALS | LEXFL_ALLOWBACKSLASHSTRINGCONCAT );
...
=========================
*/
void budGuiScriptList::FixupParms( idWindow* win )
{
	int c = list.Num();
	for( int i = 0; i < c; i++ )
	{
...
/*
=========================
budGuiScriptList::WriteToSaveGame
=========================
*/
void budGuiScriptList::WriteToSaveGame( budFile* savefile )
{
	int i;
...
/*
=========================
budGuiScriptList::ReadFromSaveGame
=========================
*/
void budGuiScriptList::ReadFromSaveGame( budFile* savefile )
{
	int i;
