...
public:
	...
	const budMaterial* 	GetScrollBarImage( int index );
...
protected:
	...
	const budMaterial* 	cursorImages[CURSOR_COUNT];
	const budMaterial* 	scrollBarImages[SCROLLBAR_COUNT];
	const budMaterial* 	whiteImage;
	budFont* 			activeFont;
