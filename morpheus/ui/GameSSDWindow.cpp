...
void SSDCrossHair::WriteToSaveGame( budFile* savefile )
{
...
void SSDCrossHair::ReadFromSaveGame( budFile* savefile )
{
...
void SSDEntity::WriteToSaveGame( budFile* savefile )
{
...
void SSDEntity::ReadFromSaveGame( budFile* savefile,  budGameSSDWindow* _game )
{
...
void SSDEntity::SetGame( budGameSSDWindow* _game )
{
	game = _game;
}
...
void SSDMover::WriteToSaveGame( budFile* savefile )
{
...
void SSDMover::ReadFromSaveGame( budFile* savefile,  budGameSSDWindow* _game )
{
...
void SSDAsteroid::WriteToSaveGame( budFile* savefile )
{
...
void SSDAsteroid::ReadFromSaveGame( budFile* savefile,  budGameSSDWindow* _game )
{
...
void SSDAsteroid::WriteAsteroids( budFile* savefile )
{
	int count = 0;
	for( int i = 0; i < MAX_ASTEROIDS; i++ )
	{
...
void SSDAsteroid::ReadAsteroids( budFile* savefile, budGameSSDWindow* _game )
{
...
void SSDAstronaut::WriteToSaveGame( budFile* savefile )
{
	SSDMover::WriteToSaveGame( savefile );
...
void SSDAstronaut::ReadFromSaveGame( budFile* savefile,  budGameSSDWindow* _game )
{
	SSDMover::ReadFromSaveGame( savefile, _game );
...
void SSDAstronaut::WriteAstronauts( budFile* savefile )
{
	int count = 0;
	for( int i = 0; i < MAX_ASTRONAUT; i++ )
	{
...
void SSDAstronaut::ReadAstronauts( budFile* savefile, budGameSSDWindow* _game )
{
...
void SSDExplosion::WriteToSaveGame( budFile* savefile )
{
	SSDEntity::WriteToSaveGame( savefile );
...
void SSDExplosion::ReadFromSaveGame( budFile* savefile,  budGameSSDWindow* _game )
{
	SSDEntity::ReadFromSaveGame( savefile, _game );
...
void SSDExplosion::WriteExplosions( budFile* savefile )
{
	int count = 0;
	for( int i = 0; i < MAX_EXPLOSIONS; i++ )
	{
...
void SSDExplosion::ReadExplosions( budFile* savefile, budGameSSDWindow* _game )
{
...
void SSDPoints::WriteToSaveGame( budFile* savefile )
{
	SSDEntity::WriteToSaveGame( savefile );
...
void SSDPoints::ReadFromSaveGame( budFile* savefile,  budGameSSDWindow* _game )
{
	SSDEntity::ReadFromSaveGame( savefile, _game );
...
void SSDPoints::WritePoints( budFile* savefile )
{
	int count = 0;
	for( int i = 0; i < MAX_POINTS; i++ )
	{
...
void SSDPoints::ReadPoints( budFile* savefile, budGameSSDWindow* _game )
{
...
void SSDProjectile::WriteToSaveGame( budFile* savefile )
{
	SSDEntity::WriteToSaveGame( savefile );
...
void SSDProjectile::ReadFromSaveGame( budFile* savefile,  budGameSSDWindow* _game )
{
	SSDEntity::ReadFromSaveGame( savefile, _game );
...
void SSDProjectile::WriteProjectiles( budFile* savefile )
{
	int count = 0;
	for( int i = 0; i < MAX_PROJECTILES; i++ )
	{
...
void SSDProjectile::ReadProjectiles( budFile* savefile, budGameSSDWindow* _game )
{
...
void SSDPowerup::WriteToSaveGame( budFile* savefile )
{
	SSDMover::WriteToSaveGame( savefile );
...
void SSDPowerup::ReadFromSaveGame( budFile* savefile,  budGameSSDWindow* _game )
{
	SSDMover::ReadFromSaveGame( savefile, _game );
...
void SSDPowerup::Init( budGameSSDWindow* _game, float _speed, float _rotation )
{
...
SSDPowerup* SSDPowerup::GetNewPowerup( budGameSSDWindow* _game, float _speed, float _rotation )
{
...
void SSDPowerup::WritePowerups( budFile* savefile )
{
	int count = 0;
	for( int i = 0; i < MAX_POWERUPS; i++ )
	{
...
void SSDPowerup::ReadPowerups( budFile* savefile, budGameSSDWindow* _game )
{
...
idRandom budGameSSDWindow::random;

budGameSSDWindow::budGameSSDWindow( budUserInterfaceLocal* g ) : idWindow( g )
{
	gui = g;
	CommonInit();
}

budGameSSDWindow::~budGameSSDWindow()
{
	ResetGameStats();
}

void budGameSSDWindow::WriteToSaveGame( budFile* savefile )
{
...
void budGameSSDWindow::ReadFromSaveGame( budFile* savefile )
{
...
const char* budGameSSDWindow::HandleEvent( const sysEvent_t* event, bool* updateVisuals )
{
...
idWinVar* budGameSSDWindow::GetWinVarByName( const char* _name, bool winLookup, drawWin_t** owner )
{
...
void budGameSSDWindow::Draw( int time, float x, float y )
{
...
void budGameSSDWindow::CommonInit()
{
...
void budGameSSDWindow::ResetGameStats()
{
...
void budGameSSDWindow::ResetLevelStats()
{
...
void budGameSSDWindow::ResetEntities()
{
...
void budGameSSDWindow::StartGame()
{

	gameStats.gameRunning = true;
}

void budGameSSDWindow::StopGame()
{

	gameStats.gameRunning = false;
}

void budGameSSDWindow::GameOver()
{
...
void budGameSSDWindow::BeginLevel( int level )
{
...
*/
void budGameSSDWindow::ContinueGame()
{
	gameStats.health = 100;
...
void budGameSSDWindow::LevelComplete()
{
...
void budGameSSDWindow::GameComplete()
{
	StopGame();
...
void budGameSSDWindow::UpdateGame()
{
...
void budGameSSDWindow::CheckForHits()
{
...
void budGameSSDWindow::ZOrderEntities()
{
...
void budGameSSDWindow::SpawnAsteroid()
{
...
void budGameSSDWindow::HitAsteroid( SSDAsteroid* asteroid, int key )
{
...
void budGameSSDWindow::AddScore( SSDEntity* ent, int points )
{
...
void budGameSSDWindow::AddDamage( int damage )
{
...
void budGameSSDWindow::AddHealth( int health )
{
...
void budGameSSDWindow::OnRescueAll()
{
...
void budGameSSDWindow::OnSuperBlaster()
{
...
void budGameSSDWindow::RefreshGuiData()
{
...
void budGameSSDWindow::SpawnAstronaut()
{
...
void budGameSSDWindow::HitAstronaut( SSDAstronaut* astronaut, int key )
{
...
void budGameSSDWindow::AstronautStruckPlayer( SSDAstronaut* astronaut )
{
...
void budGameSSDWindow::SpawnPowerup()
{
...
void budGameSSDWindow::StartSuperBlaster()
{
...
void budGameSSDWindow::StopSuperBlaster()
{
...
SSDEntity* budGameSSDWindow::GetSpecificEntity( int type, int id )
{
	SSDEntity* ent = NULL;
	switch( type )
	{
...
void budGameSSDWindow::PlaySound( const char* sound )
{
