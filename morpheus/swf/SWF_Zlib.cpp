...
========================
*/
bool budSWF::Inflate( const byte* input, int inputSize, byte* output, int outputSize )
{
...
// RB begin
bool budSWF::Deflate( const byte* input, int inputSize, byte* output, int& outputSize )
{
	struct local_swf_alloc_t
	{
		static void* zalloc( void* opaque, uint32 items, uint32 size )
