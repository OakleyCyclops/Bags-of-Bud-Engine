...
/*
========================
budSWFBitStream::budSWFBitStream
========================
*/
budSWFBitStream::budSWFBitStream()
{
...
/*
========================
budSWFBitStream::operator=
========================
*/
budSWFBitStream& budSWFBitStream::operator=( budSWFBitStream& other )
{
	Free();
	free = other.free;
	startp = other.startp;
...
/*
========================
budSWFBitStream::Free
========================
*/
void budSWFBitStream::Free()
{
	if( free )
	{
...
/*
========================
budSWFBitStream::Load
========================
*/
void budSWFBitStream::Load( const byte* data, uint32 len, bool copy )
{
	Free();
...
/*
========================
budSWFBitStream::ReadEncodedU32
========================
*/
uint32 budSWFBitStream::ReadEncodedU32()
{
	uint32 result = 0;
	for( int i = 0; i < 5; i++ )
	{
...
/*
========================
budSWFBitStream::ReadData
========================
*/
const byte* budSWFBitStream::ReadData( int size )
{
...
/*
========================
budSWFBitStream::ReadInternalU
========================
*/
ID_FORCE_INLINE unsigned int budSWFBitStream::ReadInternalU( uint64& regCurrentBit, uint64& regCurrentByte, unsigned int numBits )
{
	assert( numBits <= 32 );
...
/*
========================
budSWFBitStream::ReadInternalS
========================
*/
ID_FORCE_INLINE int budSWFBitStream::ReadInternalS( uint64& regCurrentBit, uint64& regCurrentByte, unsigned int numBits )
{
...
/*
========================
budSWFBitStream::ReadU
========================
*/
unsigned int budSWFBitStream::ReadU( unsigned int numBits )
{
...
/*
========================
budSWFBitStream::ReadS
========================
*/
int budSWFBitStream::ReadS( unsigned int numBits )
{
...
/*
========================
budSWFBitStream::ReadRect
========================
*/
void budSWFBitStream::ReadRect( swfRect_t& rect )
{
...
/*
========================
budSWFBitStream::ReadMatrix
========================
*/
void budSWFBitStream::ReadMatrix( swfMatrix_t& matrix )
{
	uint64 regCurrentBit = 0;
	uint64 regCurrentByte = 0;
...
/*
========================
budSWFBitStream::ReadColorXFormRGBA
========================
*/
void budSWFBitStream::ReadColorXFormRGBA( swfColorXform_t& cxf )
{
	uint64 regCurrentBit = 0;
	uint64 regCurrentByte = 0;
...
/*
========================
budSWFBitStream::ReadColorRGB
========================
*/
void budSWFBitStream::ReadColorRGB( swfColorRGB_t& color )
{
	ResetBits();
	color.r = *readp++;
	color.g = *readp++;
...
/*
========================
budSWFBitStream::ReadColorRGBA
========================
*/
void budSWFBitStream::ReadColorRGBA( swfColorRGBA_t& color )
{
	ResetBits();
	color.r = *readp++;
	color.g = *readp++;
...
/*
========================
budSWFBitStream::ReadGradient
========================
*/
void budSWFBitStream::ReadGradient( swfGradient_t& grad, bool rgba )
{
...
/*
========================
budSWFBitStream::ReadMorphGradient
========================
*/
void budSWFBitStream::ReadMorphGradient( swfGradient_t& grad )
{
	grad.numGradients = ReadU8() & 0xF;	// the top 4 bits control spread and interpolation mode, but we ignore them
	for( int i = 0; i < grad.numGradients; i++ )
	{
