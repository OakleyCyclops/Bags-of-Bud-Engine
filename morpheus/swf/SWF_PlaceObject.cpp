...
/*
========================
budSWFSpriteInstance::PlaceObject2
========================
*/
void budSWFSpriteInstance::PlaceObject2( budSWFBitStream& bitstream )
{
	c_PlaceObject2++;
	...
	if( ( flags & PlaceFlagMove ) != 0 )
	{
		...
		if( display == NULL )
		{
			libBud::Warning( "PlaceObject2: trying to modify entry %d, which doesn't exist", depth );
			return;
		}
		if( characterID >= 0 )
		{
			...
			{
				libBud::Warning( "PlaceObject2: Trying to change the character of a sprite after it's been created" );
				return;
			}
			...
			if( dictEntry != NULL )
			{
				...
				{
					libBud::Warning( "PlaceObject2: Trying to change the character of a shape to a sprite" );
					return;
				}
			}
	...
	else
	{
		if( characterID < 0 )
		{
			libBud::Warning( "PlaceObject2: Trying to create a new object without a character" );
			return;
		}
		// create a new entry
		...
		if( display == NULL )
		{
			libBud::Warning( "PlaceObject2: trying to create a new entry at %d, but an item already exists there", depth );
			return;
		}
	}
...
/*
========================
budSWFSpriteInstance::PlaceObject3
========================
*/
void budSWFSpriteInstance::PlaceObject3( budSWFBitStream& bitstream )
{
	c_PlaceObject3++;
	...
	if( ( flags1 & PlaceFlagMove ) != 0 )
	{
		...
		if( display == NULL )
		{
			libBud::Warning( "PlaceObject3: trying to modify entry %d, which doesn't exist", depth );
			return;
		}
		if( characterID >= 0 )
		{
			...
			if( display->spriteInstance || display->textInstance )
			{
				libBud::Warning( "PlaceObject3: Trying to change the character of a sprite after it's been created" );
				return;
			}
			budSWFDictionaryEntry* dictEntry = sprite->swf->FindDictionaryEntry( characterID );
			if( dictEntry != NULL )
			{
				if( dictEntry->type == SWF_DICT_SPRITE || dictEntry->type == SWF_DICT_EDITTEXT )
				{
					libBud::Warning( "PlaceObject3: Trying to change the character of a shape to a sprite" );
					return;
				}
			}
			display->characterID = characterID;
	...
	else
	{
		if( characterID < 0 )
		{
			libBud::Warning( "PlaceObject3: Trying to create a new object without a character" );
			return;
		}
		// create a new entry
		display = AddDisplayEntry( depth, characterID );
		if( display == NULL )
		{
			libBud::Warning( "PlaceObject3: trying to create a new entry at %d, but an item already exists there", depth );
			return;
		}
	}
...
/*
========================
budSWFSpriteInstance::RemoveObject2
========================
*/
void budSWFSpriteInstance::RemoveObject2( budSWFBitStream& bitstream )
{
