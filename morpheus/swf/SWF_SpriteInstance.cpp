...
budSWFScriptObject_SpriteInstancePrototype spriteInstanceScriptObjectPrototype;

/*
========================
budSWFSpriteInstance::budSWFSpriteInstance
========================
*/
budSWFSpriteInstance::budSWFSpriteInstance() :
	isPlaying( true ),
...
/*
========================
budSWFSpriteInstance::Init
========================
*/
void budSWFSpriteInstance::Init( budSWFSprite* _sprite, budSWFSpriteInstance* _parent, int _depth )
{
	sprite = _sprite;
	parent = _parent;
	depth = _depth;
	...
	scriptObject = budSWFScriptObject::Alloc();
	...
	for( int i = 0; i < sprite->doInitActions.Num(); i++ )
	{
		...
		actionScript->Call( scriptObject, budSWFParmList() );
	}
...
budSWFSpriteInstance::~budSWFSpriteInstance()
{
	if( parent != NULL )
	{
		parent->scriptObject->Set( name, budSWFScriptVar() );
	}
	FreeDisplayList();
	displayList.Clear();
...
/*
========================
budSWFSpriteInstance::FreeDisplayList
========================
*/
void budSWFSpriteInstance::FreeDisplayList()
{
...
/*
========================
budSWFSpriteInstance::FindDisplayEntry
========================
*/
swfDisplayEntry_t* budSWFSpriteInstance::FindDisplayEntry( int depth )
{
...
/*
========================
budSWFSpriteInstance::AddDisplayEntry
========================
*/
swfDisplayEntry_t* budSWFSpriteInstance::AddDisplayEntry( int depth, int characterID )
{
	int i = 0;
	...
	budSWFDictionaryEntry* dictEntry = sprite->swf->FindDictionaryEntry( characterID );
	if( dictEntry != NULL )
	{
...
/*
========================
budSWFSpriteInstance::RemoveDisplayEntry
========================
*/
void budSWFSpriteInstance::RemoveDisplayEntry( int depth )
{
...
/*
========================
budSWFSpriteInstance::SwapDepths
========================
*/
void budSWFSpriteInstance::SwapDepths( int depth1, int depth2 )
{
	for( int i = 0; i < displayList.Num(); i++ )
	{
...
/*
===================
budSWFSpriteInstance::Run
===================
*/
bool budSWFSpriteInstance::Run()
{
	if( !isVisible )
	{
		return false;
...
/*
===================
budSWFSpriteInstance::RunActions
===================
*/
bool budSWFSpriteInstance::RunActions()
{
	if( !isVisible )
	{
		actions.SetNum( 0 );
	...
	{
		firstRun = false;
		budSWFScriptVar onLoad = scriptObject->Get( "onLoad" );
		onLoad.GetFunction()->Call( scriptObject, budSWFParmList() );
	}
	
	if( onEnterFrame.IsFunction() )
	{
		onEnterFrame.GetFunction()->Call( scriptObject, budSWFParmList() );
	}
...
/*
===================
budSWFSpriteInstance::NextFrame
===================
*/
void budSWFSpriteInstance::NextFrame()
{
	if( currentFrame < frameCount )
	{
		RunTo( currentFrame + 1 );
...
/*
===================
budSWFSpriteInstance::PrevFrame
===================
*/
void budSWFSpriteInstance::PrevFrame()
{
	if( currentFrame > 1 )
	{
		RunTo( currentFrame - 1 );
...
/*
===================
budSWFSpriteInstance::Play
===================
*/
void budSWFSpriteInstance::Play()
{
	for( budSWFSpriteInstance* p = parent; p != NULL; p = p->parent )
	{
...
/*
===================
budSWFSpriteInstance::Stop
===================
*/
void budSWFSpriteInstance::Stop()
{
	isPlaying = false;
}
...
/*
===================
budSWFSpriteInstance::RunTo
===================
*/
void budSWFSpriteInstance::RunTo( int targetFrame )
{
	...
	{
		budSWFSprite::swfSpriteCommand_t& command = sprite->commands[ c ];
...
#undef HANDLE_SWF_TAG
			default:
				libBud::Printf( "Run Sprite: Unhandled tag %s\n", budSWF::GetTagName( command.tag ) );
		}
	}
...
/*
========================
budSWFSpriteInstance::DoAction
========================
*/
void budSWFSpriteInstance::DoAction( budSWFBitStream& bitstream )
{
#if 1
...
/*
========================
budSWFSpriteInstance::FindChildSprite
========================
*/
budSWFSpriteInstance* budSWFSpriteInstance::FindChildSprite( const char* targetName )
{
	for( int i = 0; i < displayList.Num(); i++ )
	{
		if( displayList[i].spriteInstance != NULL )
...
/*
========================
budSWFSpriteInstance::ResolveTarget
...
========================
*/
budSWFSpriteInstance* budSWFSpriteInstance::ResolveTarget( const char* targetName )
{
	if( targetName[0] == 0 )
	{
		return this;
	}
	budSWFSpriteInstance* target = this;
	...
	for( int i = 0; i < spriteNames.Num(); i++ )
	{
		...
		if( target == NULL )
		{
			...
			libBud::Warning( "SWF: Could not resolve %s, %s not found", targetName, spriteNames[i].c_str() );
			return this;
		}
	}
	return target;
...
/*
========================
budSWFSpriteInstance::FindFrame
========================
*/
uint32 budSWFSpriteInstance::FindFrame( const char* labelName ) const
{
	...
	libBud::Warning( "Could not find frame '%s' in sprite '%s'", labelName, GetName() );
	return currentFrame;
}

/*
========================
budSWFSpriteInstance::FrameExists
========================
*/
bool budSWFSpriteInstance::FrameExists( const char* labelName ) const
{
	int frameNum = atoi( labelName );
	if( frameNum > 0 )
	{
...
/*
========================
budSWFSpriteInstance::IsBetweenFrames
Checks if the current frame is between the given inclusive range.
========================
*/
bool budSWFSpriteInstance::IsBetweenFrames( const char* frameLabel1, const char* frameLabel2 ) const
{
...
/*
========================
budSWFSpriteInstance::SetMaterial
========================
*/
void budSWFSpriteInstance::SetMaterial( const budMaterial* material, int width, int height )
{
...
/*
========================
budSWFSpriteInstance::SetVisible
========================
*/
void budSWFSpriteInstance::SetVisible( bool visible )
{
	isVisible = visible;
	if( isVisible )
	{
...
/*
========================
budSWFSpriteInstance::PlayFrame
========================
*/
void budSWFSpriteInstance::PlayFrame( const budSWFParmList& parms )
{
	if( parms.Num() > 0 )
	{
		actions.Clear();
	...
	{
		libBud::Warning( "gotoAndPlay: expected 1 parameter" );
	}
}

/*
========================
budSWFSpriteInstance::StopFrame
========================
*/
void budSWFSpriteInstance::StopFrame( const budSWFParmList& parms )
{
	if( parms.Num() > 0 )
	{
	...
	{
		libBud::Warning( "gotoAndStop: expected 1 parameter" );
	}
}

/*
========================
budSWFSpriteInstance::GetXPos
========================
*/
float budSWFSpriteInstance::GetXPos() const
{
	if( parent == NULL )
	{
		return 0.0f;
	...
	{
		libBud::Warning( "GetXPos: Couldn't find our display entry in our parent's display list for depth %d", depth );
		return 0.0f;
	}
...
/*
========================
budSWFSpriteInstance::GetYPos
========================
*/
float budSWFSpriteInstance::GetYPos( bool overallPos ) const
{
	if( parent == NULL )
	{
		return 0.0f;
	...
	if( thisDisplayEntry == NULL || thisDisplayEntry->spriteInstance != this )
	{
		libBud::Warning( "GetYPos: Couldn't find our display entry in our parents display list for depth %d", depth );
		return 0.0f;
	}
...
/*
========================
budSWFSpriteInstance::SetXPos
========================
*/
void budSWFSpriteInstance::SetXPos( float xPos )
{
	if( parent == NULL )
	{
		return;
	...
	if( thisDisplayEntry == NULL || thisDisplayEntry->spriteInstance != this )
	{
		libBud::Warning( "_y: Couldn't find our display entry in our parents display list" );
		return;
	}
...
/*
========================
budSWFSpriteInstance::SetYPos
========================
*/
void budSWFSpriteInstance::SetYPos( float yPos )
{
	if( parent == NULL )
	{
		return;
...
/*
========================
budSWFSpriteInstance::SetPos
========================
*/
void budSWFSpriteInstance::SetPos( float xPos, float yPos )
{
	if( parent == NULL )
	{
		return;
...
/*
========================
budSWFSpriteInstance::SetRotation
========================
*/
void budSWFSpriteInstance::SetRotation( float rot )
{
	if( parent == NULL )
	{
		return;
...
/*
========================
budSWFSpriteInstance::SetScale
========================
*/
void budSWFSpriteInstance::SetScale( float x, float y )
{
	if( parent == NULL )
	{
		return;
	...
	if( thisDisplayEntry == NULL || thisDisplayEntry->spriteInstance != this )
	{
		libBud::Warning( "scale: Couldn't find our display entry in our parents display list" );
		return;
	}
...
/*
========================
budSWFSpriteInstance::SetMoveToScale
========================
*/
void budSWFSpriteInstance::SetMoveToScale( float x, float y )
{
	moveToXScale = x;
	moveToYScale = y;
}
...
========================
*/
bool budSWFSpriteInstance::UpdateMoveToScale( float speed )
{
	...
	if( thisDisplayEntry == NULL || thisDisplayEntry->spriteInstance != this )
	{
		libBud::Warning( "SetMoveToScale: Couldn't find our display entry in our parents display list" );
		return false;
	}
...
/*
========================
budSWFSpriteInstance::SetAlpha
========================
*/
void budSWFSpriteInstance::SetAlpha( float val )
{
	if( parent == NULL )
	{
		return;
	...
	if( thisDisplayEntry == NULL || thisDisplayEntry->spriteInstance != this )
	{
		libBud::Warning( "_alpha: Couldn't find our display entry in our parents display list" );
		return;
	}
...
/*
========================
budSWFScriptObject_SpriteInstancePrototype
========================
*/
#define SWF_SPRITE_FUNCTION_DEFINE( x ) budSWFScriptVar budSWFScriptObject_SpriteInstancePrototype::budSWFScriptFunction_##x::Call( budSWFScriptObject * thisObject, const budSWFParmList & parms )
#define SWF_SPRITE_NATIVE_VAR_DEFINE_GET( x ) budSWFScriptVar budSWFScriptObject_SpriteInstancePrototype::budSWFScriptNativeVar_##x::Get( class budSWFScriptObject * object )
#define SWF_SPRITE_NATIVE_VAR_DEFINE_SET( x ) void  budSWFScriptObject_SpriteInstancePrototype::budSWFScriptNativeVar_##x::Set( class budSWFScriptObject * object, const budSWFScriptVar & value )

#define SWF_SPRITE_PTHIS_FUNC( x ) budSWFSpriteInstance * pThis = thisObject ? thisObject->GetSprite() : NULL; if ( !verify( pThis != NULL ) ) { libBud::Warning( "SWF: tried to call " x " on NULL sprite" ); return budSWFScriptVar(); }
#define SWF_SPRITE_PTHIS_GET( x ) budSWFSpriteInstance * pThis = object ? object->GetSprite() : NULL; if ( pThis == NULL ) { return budSWFScriptVar(); }
#define SWF_SPRITE_PTHIS_SET( x ) budSWFSpriteInstance * pThis = object ? object->GetSprite() : NULL; if ( pThis == NULL ) { return; }
...
budSWFScriptObject_SpriteInstancePrototype::budSWFScriptObject_SpriteInstancePrototype()
{
...
SWF_SPRITE_FUNCTION_DEFINE( duplicateMovieClip )
{
	...
	{
		libBud::Warning( "Tried to duplicate root movie clip" );
		return budSWFScriptVar();
	}
	if( parms.Num() < 2 )
	{
		libBud::Warning( "duplicateMovieClip: expected 2 parameters" );
		return budSWFScriptVar();
	}
	...
	{
		libBud::Warning( "duplicateMovieClip: Couldn't find our display entry in our parents display list" );
		return budSWFScriptVar();
	}
...
SWF_SPRITE_FUNCTION_DEFINE( swapDepths )
{
	...
	if( pThis->parent == NULL )
	{
		libBud::Warning( "Tried to swap depths on root movie clip" );
		return budSWFScriptVar();
	}
	if( parms.Num() < 1 )
	{
		libBud::Warning( "swapDepths: expected 1 parameters" );
		return budSWFScriptVar();
	}
...
SWF_SPRITE_NATIVE_VAR_DEFINE_GET( _brightness )
{
	...
	if( thisDisplayEntry == NULL || thisDisplayEntry->spriteInstance != pThis )
	{
		libBud::Warning( "_brightness: Couldn't find our display entry in our parents display list" );
		return 1.0f;
	}
...
SWF_SPRITE_NATIVE_VAR_DEFINE_SET( _visible )
{
	...
	if( pThis->isVisible )
	{
		for( budSWFSpriteInstance* p = pThis->parent; p != NULL; p = p->parent )
		{
			p->childrenRunning = true;
		}
	}
...
SWF_SPRITE_NATIVE_VAR_DEFINE_GET( _mousex )
{
	...
	if( thisDisplayEntry == NULL || thisDisplayEntry->spriteInstance != pThis )
	{
		libBud::Warning( "_mousex: Couldn't find our display entry in our parents display list" );
		return pThis->sprite->GetSWF()->GetMouseX();
	}
...
SWF_SPRITE_NATIVE_VAR_DEFINE_GET( _mousey )
{
	...
	if( thisDisplayEntry == NULL || thisDisplayEntry->spriteInstance != pThis )
	{
		libBud::Warning( "_mousey: Couldn't find our display entry in our parents display list" );
		return pThis->sprite->GetSWF()->GetMouseY();
	}
