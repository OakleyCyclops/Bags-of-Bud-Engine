...
int budFile_SWF::BitCountFloat( const float value )
{
...
int budFile_SWF::EnlargeBitCountS( const int value, int numBits )
{
	if( value  == 0 )
	{
		return numBits;
...
int budFile_SWF::EnlargeBitCountU( const int value, int numBits )
{
	if( value  == 0 )
	{
		return numBits;
...
int	budFile_SWF::Write( const void* buffer, int len )
{
	ByteAlign();
...
void budFile_SWF::WriteByte( byte bits )
{
	file->WriteUnsignedChar( bits );
}

void budFile_SWF::WriteUBits( int value, int numBits )
{
...
void budFile_SWF::WriteSBits( int value, int numBits )
{
...
void budFile_SWF::WriteU8( uint8 value )
{
	ByteAlign();
...
void budFile_SWF::WriteU16( uint16 value )
{
	ByteAlign();
...
void budFile_SWF::WriteU32( uint32 value )
{
	ByteAlign();
...
void budFile_SWF::WriteRect( const swfRect_t& rect )
{
...
void budFile_SWF::WriteMatrix( const swfMatrix_t& matrix )
{
	//ByteAlign();
...
void budFile_SWF::WriteColorXFormRGBA( const swfColorXform_t& xcf )
{
...
void budFile_SWF::WriteColorRGB( const swfColorRGB_t& color )
{
	ByteAlign();
...
void budFile_SWF::WriteColorRGBA( const swfColorRGBA_t& color )
{
	ByteAlign();
...
void budFile_SWF::WriteTagHeader( swfTag_t tag, int32 tagLength )
{
...
int32 budFile_SWF::GetTagHeaderSize( swfTag_t tag, int32 tagLength )
{
	int32 size = 2;
