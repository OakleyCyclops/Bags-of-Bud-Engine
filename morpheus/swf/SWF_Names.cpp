...
// RB begin
const char* budSWF::GetDictTypeName( swfDictType_t type )
{
...
const char* budSWF::GetEditTextAlignName( swfEditTextAlign_t align )
{
...
========================
*/
const char* budSWF::GetTagName( swfTag_t tag )
{
...
/*
========================
budSWF::GetActionName
========================
*/
const char* budSWF::GetActionName( swfAction_t action )
{
