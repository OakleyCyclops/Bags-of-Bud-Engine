...
class budSWFTextInstance
{
public:
	budSWFTextInstance();
	~budSWFTextInstance();
	
	void Init( budSWFEditText* editText, budSWF* _swf );
	...
	const budSWFEditText* GetEditText() const
	{
		return editText;
	}
...
================================================
*/
class budSWFScriptObject_TextInstancePrototype : public budSWFScriptObject
{
public:
...
#define SWF_TEXT_FUNCTION_DECLARE( x ) \
	class budSWFScriptFunction_##x : public budSWFScriptFunction_RefCounted { \
	public: \
		void			AddRef() {} \
		void			Release() {} \
