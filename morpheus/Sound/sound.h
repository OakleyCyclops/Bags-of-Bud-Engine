...
class idSoundShader : public budDecl
{
public:
	idSoundShader();
...
private:
	friend class budSoundWorldLocal;
...
public:
	...
	virtual void			ProcessDemoCommand( budDemoFile* demo ) = 0;
	...
	virtual void			WriteToSaveGame( budFile* savefile ) = 0;
	virtual void			ReadFromSaveGame( budFile* savefile ) = 0;
...
public:
	...
	virtual budSoundWorld* 	AllocSoundWorld( budRenderWorld* rw ) = 0;
	virtual void			FreeSoundWorld( budSoundWorld* sw ) = 0;
	
	// Specifying NULL will cause silence to be played.
	virtual void			SetPlayingSoundWorld( budSoundWorld* soundWorld ) = 0;
	
	// Some tools, like the sound dialog, may be used in both the game and the editor
	// This can return NULL, so check!
	virtual budSoundWorld* 	GetPlayingSoundWorld() = 0;
	...
	virtual void			OnReloadSound( const budDecl* sound ) = 0;
