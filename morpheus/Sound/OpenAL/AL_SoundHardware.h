...
private:
	...
	*/
	...
	//budDebugGraph* 	vuMeterRMS;
	//budDebugGraph* 	vuMeterPeak;
	...
	budStaticList<idSoundVoice_OpenAL, MAX_HARDWARE_VOICES * 2 > voices;
	budStaticList<idSoundVoice_OpenAL*, MAX_HARDWARE_VOICES * 2 > zombieVoices;
	budStaticList<idSoundVoice_OpenAL*, MAX_HARDWARE_VOICES * 2 > freeVoices;
};
