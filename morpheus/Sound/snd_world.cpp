...
/*
========================
budSoundWorldLocal::budSoundWorldLocal
========================
*/
budSoundWorldLocal::budSoundWorldLocal()
{
...
/*
========================
budSoundWorldLocal::AllocSoundEmitter

This is called from the main thread.
========================
*/
idSoundEmitter* budSoundWorldLocal::AllocSoundEmitter()
{
...
/*
========================
budSoundWorldLocal::AllocSoundChannel
========================
*/
idSoundChannel* budSoundWorldLocal::AllocSoundChannel()
{
...
/*
========================
budSoundWorldLocal::FreeSoundChannel
========================
*/
void budSoundWorldLocal::FreeSoundChannel( idSoundChannel* channel )
{
	channel->Mute();
...
/*
========================
budSoundWorldLocal::CurrentShakeAmplitude
========================
*/
float budSoundWorldLocal::CurrentShakeAmplitude()
{
...
/*
========================
budSoundWorldLocal::WriteSoundShaderLoad
========================
*/
void budSoundWorldLocal::WriteSoundShaderLoad( const idSoundShader* snd )
{
	if( writeDemo )
	{
		writeDemo->WriteInt( DS_SOUND );
...
========================
*/
class budActiveChannel
{
public:
	budActiveChannel() :
		channel( NULL ),
		sortKey( 0 ) {}
	budActiveChannel( idSoundChannel* channel_, int sortKey_ ) :
		channel( channel_ ),
		sortKey( sortKey_ ) {}
...
========================
*/
static float AdjustForCushionChannels( const budStaticList< budActiveChannel, MAX_HARDWARE_VOICES >& activeEmitterChannels,
...
/*
========================
budSoundWorldLocal::Update
========================
*/
void budSoundWorldLocal::Update()
{
	...
	budStaticList< budActiveChannel, MAX_HARDWARE_VOICES > activeEmitterChannels;
	...
	for( int e = emitters.Num() - 1; e >= 0; e-- )
	{
		...
		for( int i = 0; i < emitters[e]->channels.Num(); i++ )
		{
			...
			activeEmitterChannels.Insert( budActiveChannel( channel, sortKey ), insertIndex );
...
/*
========================
budSoundWorldLocal::OnReloadSound
========================
*/
void budSoundWorldLocal::OnReloadSound( const budDecl* shader )
{
	for( int i = 0; i < emitters.Num(); i++ )
	{
...
/*
========================
budSoundWorldLocal::EmitterForIndex
========================
*/
idSoundEmitter* budSoundWorldLocal::EmitterForIndex( int index )
{
	...
	{
		libBud::Error( "budSoundWorldLocal::EmitterForIndex: %i >= %i", index, emitters.Num() );
	}
...
/*
========================
budSoundWorldLocal::ClearAllSoundEmitters
========================
*/
void budSoundWorldLocal::ClearAllSoundEmitters()
{
	for( int i = 0; i < emitters.Num(); i++ )
	{
		emitters[i]->Reset();
...
/*
========================
budSoundWorldLocal::StopAllSounds

This is called from the main thread.
========================
*/
void budSoundWorldLocal::StopAllSounds()
{
	for( int i = 0; i < emitters.Num(); i++ )
	{
		emitters[i]->Reset();
...
/*
========================
budSoundWorldLocal::PlayShaderDirectly
========================
*/
int budSoundWorldLocal::PlayShaderDirectly( const char* name, int channel )
{
...
/*
========================
budSoundWorldLocal::Skip
========================
*/
void budSoundWorldLocal::Skip( int time )
{
...
/*
========================
budSoundWorldLocal::Pause
========================
*/
void budSoundWorldLocal::Pause()
{
	if( !isPaused )
	{
...
/*
========================
budSoundWorldLocal::UnPause
========================
*/
void budSoundWorldLocal::UnPause()
{
	if( isPaused )
	{
		isPaused = false;
...
/*
========================
budSoundWorldLocal::GetSoundTime
========================
*/
int budSoundWorldLocal::GetSoundTime()
{
	if( isPaused )
	{
...
/*
===================
budSoundWorldLocal::ResolveOrigin
...
/*
========================
budSoundWorldLocal::StartWritingDemo
========================
*/
void budSoundWorldLocal::StartWritingDemo( budDemoFile* demo )
{
	writeDemo = demo;
...
/*
========================
budSoundWorldLocal::StopWritingDemo
========================
*/
void budSoundWorldLocal::StopWritingDemo()
{
	writeDemo = NULL;
}
...
/*
========================
budSoundWorldLocal::ProcessDemoCommand
========================
*/
void budSoundWorldLocal::ProcessDemoCommand( budDemoFile* readDemo )
{
...
/*
=================
budSoundWorldLocal::AVIOpen
=================
*/
void budSoundWorldLocal::AVIOpen( const char*, const char* )
{
}

/*
=================
budSoundWorldLocal::AVIClose
=================
*/
void budSoundWorldLocal::AVIClose()
{
}

/*
=================
budSoundWorldLocal::WriteToSaveGame
=================
*/
void budSoundWorldLocal::WriteToSaveGame( budFile* savefile )
{
	struct helper
	{
		static void WriteSoundFade( budFile* savefile, idSoundFade& sf )
		{
		...
		static void WriteShaderParms( budFile* savefile, soundShaderParms_t& parms )
		{
...
/*
=================
budSoundWorldLocal::ReadFromSaveGame
=================
*/
void budSoundWorldLocal::ReadFromSaveGame( budFile* savefile )
{
	struct helper
	{
		static void ReadSoundFade( budFile* savefile, idSoundFade& sf, int timeDelta )
		{
		...
		static void ReadShaderParms( budFile* savefile, soundShaderParms_t& parms )
		{
...
/*
=================
budSoundWorldLocal::FadeSoundClasses

fade all sounds in the world with a given shader soundClass
to is in Db, over is in seconds
=================
*/
void budSoundWorldLocal::FadeSoundClasses( const int soundClass, const float to, const float over )
{
	if( soundClass < 0 || soundClass >= SOUND_MAX_CLASSES )
	{
		common->Error( "budSoundWorldLocal::FadeSoundClasses: bad soundClass %i", soundClass );
		return;
	}
...
/*
=================
budSoundWorldLocal::SetSlowmoSpeed
=================
*/
void budSoundWorldLocal::SetSlowmoSpeed( float speed )
{
	slowmoSpeed = speed;
}
...
/*
=================
budSoundWorldLocal::SetEnviroSuit
=================
*/
void budSoundWorldLocal::SetEnviroSuit( bool active )
{
