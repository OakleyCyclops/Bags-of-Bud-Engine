...
private:
	...
	void				ProjectPointOntoVector( const budVec3& point, const budVec3& vStart, const budVec3& vEnd, budVec3& vProj );
	// generate normals
	void				GenerateNormals();
	// generate triangle indexes
	void				GenerateIndexes();
	// lerp point from two patch point
	void				LerpVert( const budDrawVert& a, const budDrawVert& b, budDrawVert& out ) const;
	// sample a single 3x3 patch
	void				SampleSinglePatchPoint( const budDrawVert ctrl[3][3], float u, float v, budDrawVert* out ) const;
	void				SampleSinglePatch( const budDrawVert ctrl[3][3], int baseCol, int baseRow, int width, int horzSub, int vertSub, budDrawVert* outVerts ) const;
};
...
=================
*/
BUD_INLINE idSurface_Patch::idSurface_Patch()
{
...
=================
*/
BUD_INLINE idSurface_Patch::idSurface_Patch( int maxPatchWidth, int maxPatchHeight )
{
	width = height = 0;
...
=================
*/
BUD_INLINE idSurface_Patch::idSurface_Patch( const idSurface_Patch& patch )
{
	( *this ) = patch;
}
...
=================
*/
BUD_INLINE int idSurface_Patch::GetWidth() const
{
	return width;
}
...
=================
*/
BUD_INLINE int idSurface_Patch::GetHeight() const
{
	return height;
}
