...
*/
#if defined(USE_INTRINSICS)
BUD_INLINE_EXTERN __m128i FastF32toF16( __m128i f32_bits )
{
...
BUD_INLINE_EXTERN halfFloat_t Scalar_FastF32toF16( float f32 )
{
...
*/
#if defined(USE_INTRINSICS)
BUD_INLINE_EXTERN __m128 LoadSkinnedDrawVertPosition( const budDrawVert& base, const budJointMat* joints )
{
...
BUD_INLINE_EXTERN budVec3 Scalar_LoadSkinnedDrawVertPosition( const budDrawVert& vert, const budJointMat* joints )
{
