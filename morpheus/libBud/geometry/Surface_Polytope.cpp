...
====================
*/
void idSurface_Polytope::FromPlanes( const budPlane* planes, const int numPlanes )
{
...
====================
*/
void idSurface_Polytope::SetupTetrahedron( const budBounds& bounds )
{
	budVec3 center, scale;
	float c1, c2, c3;
	...
	verts.SetNum( 4 );
	verts[0].xyz = center + budVec3( 0.0f, 0.0f, scale.z );
	verts[1].xyz = center + budVec3( 2.0f * c1 * scale.x, 0.0f, c3 * scale.z );
	verts[2].xyz = center + budVec3( -c1 * scale.x, c2 * scale.y, c3 * scale.z );
	verts[3].xyz = center + budVec3( -c1 * scale.x, -c2 * scale.y, c3 * scale.z );
...
====================
*/
void idSurface_Polytope::SetupHexahedron( const budBounds& bounds )
{
	budVec3 center, scale;
	...
	verts.SetNum( 8 );
	verts[0].xyz = center + budVec3( -scale.x, -scale.y, -scale.z );
	verts[1].xyz = center + budVec3( scale.x, -scale.y, -scale.z );
	verts[2].xyz = center + budVec3( scale.x,  scale.y, -scale.z );
	verts[3].xyz = center + budVec3( -scale.x,  scale.y, -scale.z );
	verts[4].xyz = center + budVec3( -scale.x, -scale.y,  scale.z );
	verts[5].xyz = center + budVec3( scale.x, -scale.y,  scale.z );
	verts[6].xyz = center + budVec3( scale.x,  scale.y,  scale.z );
	verts[7].xyz = center + budVec3( -scale.x,  scale.y,  scale.z );
...
====================
*/
void idSurface_Polytope::SetupOctahedron( const budBounds& bounds )
{
	budVec3 center, scale;
	...
	verts.SetNum( 6 );
	verts[0].xyz = center + budVec3( scale.x, 0.0f, 0.0f );
	verts[1].xyz = center + budVec3( -scale.x, 0.0f, 0.0f );
	verts[2].xyz = center + budVec3( 0.0f,  scale.y, 0.0f );
	verts[3].xyz = center + budVec3( 0.0f, -scale.y, 0.0f );
	verts[4].xyz = center + budVec3( 0.0f, 0.0f,  scale.z );
	verts[5].xyz = center + budVec3( 0.0f, 0.0f, -scale.z );
...
====================
*/
void idSurface_Polytope::SetupDodecahedron( const budBounds& bounds )
{
}
...
====================
*/
void idSurface_Polytope::SetupIcosahedron( const budBounds& bounds )
{
}
...
====================
*/
void idSurface_Polytope::SetupCylinder( const budBounds& bounds, const int numSides )
{
}
...
====================
*/
void idSurface_Polytope::SetupCone( const budBounds& bounds, const int numSides )
{
}
...
====================
*/
int idSurface_Polytope::SplitPolytope( const budPlane& plane, const float epsilon, idSurface_Polytope** front, idSurface_Polytope** back ) const
{
