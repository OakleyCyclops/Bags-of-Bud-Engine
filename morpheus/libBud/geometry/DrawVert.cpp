...
============
*/
int idShadowVert::CreateShadowCache( idShadowVert* vertexCache, const budDrawVert* verts, const int numVerts )
{
...
===================
*/
int idShadowVertSkinned::CreateShadowCache( idShadowVertSkinned* vertexCache, const budDrawVert* verts, const int numVerts )
{
	for( int i = 0; i < numVerts; i++ )
	{
