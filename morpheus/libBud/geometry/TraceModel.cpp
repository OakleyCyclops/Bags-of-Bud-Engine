...
/*
============
budTraceModel::SetupBox
============
*/
void budTraceModel::SetupBox( const budBounds& boxBounds )
{
	int i;
...
============
*/
void budTraceModel::SetupBox( const float size )
{
	budBounds boxBounds;
	float halfSize;
...
/*
============
budTraceModel::InitBox

  Initialize size independent box.
============
*/
void budTraceModel::InitBox()
{
	int i;
...
/*
============
budTraceModel::SetupOctahedron
============
*/
void budTraceModel::SetupOctahedron( const budBounds& octBounds )
{
...
============
*/
void budTraceModel::SetupOctahedron( const float size )
{
	budBounds octBounds;
	float halfSize;
...
/*
============
budTraceModel::InitOctahedron

  Initialize size independent octahedron.
============
*/
void budTraceModel::InitOctahedron()
{
...
/*
============
budTraceModel::SetupDodecahedron
============
*/
void budTraceModel::SetupDodecahedron( const budBounds& dodBounds )
{
...
============
*/
void budTraceModel::SetupDodecahedron( const float size )
{
	budBounds dodBounds;
	float halfSize;
...
/*
============
budTraceModel::InitDodecahedron

  Initialize size independent dodecahedron.
============
*/
void budTraceModel::InitDodecahedron()
{
...
/*
============
budTraceModel::SetupCylinder
============
*/
void budTraceModel::SetupCylinder( const budBounds& cylBounds, const int numSides )
{
	int i, n, ii, n2;
	float angle;
	budVec3 halfSize;
	...
	{
		libBud::common->Printf( "WARNING: budTraceModel::SetupCylinder: too many vertices\n" );
		n = MAX_TRACEMODEL_VERTS / 2;
	}
	if( n * 3 > MAX_TRACEMODEL_EDGES )
	{
		libBud::common->Printf( "WARNING: budTraceModel::SetupCylinder: too many sides\n" );
		n = MAX_TRACEMODEL_EDGES / 3;
	}
	if( n + 2 > MAX_TRACEMODEL_POLYS )
	{
		libBud::common->Printf( "WARNING: budTraceModel::SetupCylinder: too many polygons\n" );
...
============
*/
void budTraceModel::SetupCylinder( const float height, const float width, const int numSides )
{
	budBounds cylBounds;
...
/*
============
budTraceModel::SetupCone
============
*/
void budTraceModel::SetupCone( const budBounds& coneBounds, const int numSides )
{
	int i, n, ii;
	float angle;
	budVec3 halfSize;
	...
	{
		libBud::common->Printf( "WARNING: budTraceModel::SetupCone: too many vertices\n" );
		n = MAX_TRACEMODEL_VERTS - 1;
	}
	if( n * 2 > MAX_TRACEMODEL_EDGES )
	{
		libBud::common->Printf( "WARNING: budTraceModel::SetupCone: too many edges\n" );
		n = MAX_TRACEMODEL_EDGES / 2;
	}
	if( n + 1 > MAX_TRACEMODEL_POLYS )
	{
		libBud::common->Printf( "WARNING: budTraceModel::SetupCone: too many polygons\n" );
...
============
*/
void budTraceModel::SetupCone( const float height, const float width, const int numSides )
{
	budBounds coneBounds;
	float halfWidth;
...
/*
============
budTraceModel::SetupBone

  The origin is placed at the center of the bone.
============
*/
void budTraceModel::SetupBone( const float length, const float width )
{
	int i, j, edgeNum;
...
/*
============
budTraceModel::InitBone

  Initialize size independent bone.
============
*/
void budTraceModel::InitBone()
{
	int i;
...
/*
============
budTraceModel::SetupPolygon
============
*/
void budTraceModel::SetupPolygon( const budVec3* v, const int count )
{
	int i, j;
	budVec3 mid;
	...
	{
		libBud::common->Printf( "WARNING: budTraceModel::SetupPolygon: too many vertices\n" );
...
============
*/
void budTraceModel::SetupPolygon( const idWinding& w )
{
	int i;
	budVec3* verts;
	
	verts = ( budVec3* ) _alloca16( w.GetNumPoints() * sizeof( budVec3 ) );
...
/*
============
budTraceModel::VolumeFromPolygon
============
*/
void budTraceModel::VolumeFromPolygon( budTraceModel& trm, float thickness ) const
{
	int i;
...
/*
============
budTraceModel::GenerateEdgeNormals
============
*/
#define SHARP_EDGE_DOT	-0.7f

int budTraceModel::GenerateEdgeNormals()
{
...
/*
============
budTraceModel::Translate
============
*/
void budTraceModel::Translate( const budVec3& translation )
{
	int i;
...
/*
============
budTraceModel::Rotate
============
*/
void budTraceModel::Rotate( const budMat3& rotation )
{
	int i, j, edgeNum;
...
/*
============
budTraceModel::Shrink
============
*/
void budTraceModel::Shrink( const float m )
{
	int i, j, edgeNum;
	traceModelEdge_t* edge;
	budVec3 dir;
...
/*
============
budTraceModel::Compare
============
*/
bool budTraceModel::Compare( const budTraceModel& trm ) const
{
	int i;
...
/*
============
budTraceModel::GetPolygonArea
============
*/
float budTraceModel::GetPolygonArea( int polyNum ) const
{
	int i;
	budVec3 base, v1, v2, cross;
	float total;
...
/*
============
budTraceModel::GetOrderedSilhouetteEdges
============
*/
int budTraceModel::GetOrderedSilhouetteEdges( const int edgeIsSilEdge[MAX_TRACEMODEL_EDGES + 1], int silEdges[MAX_TRACEMODEL_EDGES] ) const
{
...
/*
============
budTraceModel::GetProjectionSilhouetteEdges
============
*/
int budTraceModel::GetProjectionSilhouetteEdges( const budVec3& projectionOrigin, int silEdges[MAX_TRACEMODEL_EDGES] ) const
{
	int i, j, edgeNum;
...
/*
============
budTraceModel::GetParallelProjectionSilhouetteEdges
============
*/
int budTraceModel::GetParallelProjectionSilhouetteEdges( const budVec3& projectionDir, int silEdges[MAX_TRACEMODEL_EDGES] ) const
{
	int i, j, edgeNum;
	int edgeIsSilEdge[MAX_TRACEMODEL_EDGES + 1];
	const traceModelPoly_t* poly;
...
/*
============
budTraceModel::ProjectionIntegrals
============
*/
void budTraceModel::ProjectionIntegrals( int polyNum, int a, int b, struct projectionIntegrals_s& integrals ) const
{
	const traceModelPoly_t* poly;
	int i, edgeNum;
	budVec3 v1, v2;
...
/*
============
budTraceModel::PolygonIntegrals
============
*/
void budTraceModel::PolygonIntegrals( int polyNum, int a, int b, int c, struct polygonIntegrals_s& integrals ) const
{
...
/*
============
budTraceModel::VolumeIntegrals
============
*/
void budTraceModel::VolumeIntegrals( struct volumeIntegrals_s& integrals ) const
{
	const traceModelPoly_t* poly;
	...
	for( i = 0; i < numPolys; i++ )
	{
		...
		nx = budMath::Fabs( poly->normal[0] );
		ny = budMath::Fabs( poly->normal[1] );
		nz = budMath::Fabs( poly->normal[2] );
		if( nx > ny && nx > nz )
		{
			c = 0;
		}
...
/*
============
budTraceModel::GetMassProperties
============
*/
void budTraceModel::GetMassProperties( const float density, float& mass, budVec3& centerOfMass, budMat3& inertiaTensor ) const
{
