...
public:
	...
	void					SetSpline( idCurve_Spline<budVec4>* spline );
	void					SetSweptSpline( idCurve_Spline<budVec4>* sweptSpline );
...
protected:
	idCurve_Spline<budVec4>* spline;
	idCurve_Spline<budVec4>* sweptSpline;
	
	void					GetFrame( const budMat3& previousFrame, const budVec3 dir, budMat3& newFrame );
};
...
====================
*/
BUD_INLINE idSurface_SweptSpline::idSurface_SweptSpline()
{
	spline = NULL;
	sweptSpline = NULL;
}
...
====================
*/
BUD_INLINE void idSurface_SweptSpline::Clear()
{
	idSurface::Clear();
	delete spline;
	spline = NULL;
