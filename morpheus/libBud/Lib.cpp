...
budSys* 			libBud::sys			= NULL;
budCommon* 		libBud::common		= NULL;
budCVarSystem* 	libBud::cvarSystem	= NULL;
budFileSystem* 	libBud::fileSystem	= NULL;
int				libBud::frameNumber	= 0;
bool			libBud::mainThreadInitialized = 0;
ID_TLS			libBud::isMainThread = 0;
...
budVec4	colorBlack	= budVec4( 0.00f, 0.00f, 0.00f, 1.00f );
budVec4	colorWhite	= budVec4( 1.00f, 1.00f, 1.00f, 1.00f );
budVec4	colorRed	= budVec4( 1.00f, 0.00f, 0.00f, 1.00f );
budVec4	colorGreen	= budVec4( 0.00f, 1.00f, 0.00f, 1.00f );
budVec4	colorBlue	= budVec4( 0.00f, 0.00f, 1.00f, 1.00f );
budVec4	colorYellow	= budVec4( 1.00f, 1.00f, 0.00f, 1.00f );
budVec4	colorMagenta = budVec4( 1.00f, 0.00f, 1.00f, 1.00f );
budVec4	colorCyan	= budVec4( 0.00f, 1.00f, 1.00f, 1.00f );
budVec4	colorOrange	= budVec4( 1.00f, 0.50f, 0.00f, 1.00f );
budVec4	colorPurple	= budVec4( 0.60f, 0.00f, 0.60f, 1.00f );
budVec4	colorPink	= budVec4( 0.73f, 0.40f, 0.48f, 1.00f );
budVec4	colorBrown	= budVec4( 0.40f, 0.35f, 0.08f, 1.00f );
budVec4	colorLtGrey	= budVec4( 0.75f, 0.75f, 0.75f, 1.00f );
budVec4	colorMdGrey	= budVec4( 0.50f, 0.50f, 0.50f, 1.00f );
budVec4	colorDkGrey	= budVec4( 0.25f, 0.25f, 0.25f, 1.00f );
...
{
	byte dx = budMath::Ftob( color.x * 255.0f );
	byte dy = budMath::Ftob( color.y * 255.0f );
	byte dz = budMath::Ftob( color.z * 255.0f );
	byte dw = budMath::Ftob( color.w * 255.0f );
...
===============
*/
void libBud::FatalError( const char* fmt, ... )
{
	va_list		argptr;
...
===============
*/
void libBud::Error( const char* fmt, ... )
{
	va_list		argptr;
	char		text[MAX_STRING_CHARS];
...
===============
*/
void libBud::Warning( const char* fmt, ... )
{
	va_list		argptr;
	char		text[MAX_STRING_CHARS];
...
===============
*/
void libBud::WarningIf( const bool test, const char* fmt, ... )
{
	if( !test )
	{
		return;
...
===============
*/
void libBud::Printf( const char* fmt, ... )
{
	va_list		argptr;
	va_start( argptr, fmt );
	if( common )
...
===============
*/
void libBud::PrintfIf( const bool test, const char* fmt, ... )
{
	if( !test )
	{
		return;
