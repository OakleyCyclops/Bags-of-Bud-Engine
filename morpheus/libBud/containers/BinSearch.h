...
*/
template< class type >
BUD_INLINE int idBinSearch_Less( const type* array, const int arraySize, const type& value )
{
	int len = arraySize;
	int mid = len;
	int offset = 0;
...
*/
template< class type >
BUD_INLINE int idBinSearch_LessEqual( const type* array, const int arraySize, const type& value )
{
	int len = arraySize;
	int mid = len;
	int offset = 0;
...
*/
template< class type >
BUD_INLINE int idBinSearch_Greater( const type* array, const int arraySize, const type& value )
{
	int len = arraySize;
	int mid = len;
	int offset = 0;
...
*/
template< class type >
BUD_INLINE int idBinSearch_GreaterEqual( const type* array, const int arraySize, const type& value )
{
	int len = arraySize;
	int mid = len;
	int offset = 0;
