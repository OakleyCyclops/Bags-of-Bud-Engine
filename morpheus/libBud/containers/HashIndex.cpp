...
================
*/
void budHashIndex::Init( const int initialHashSize, const int initialIndexSize )
{
	assert( budMath::IsPowerOfTwo( initialHashSize ) );
...
/*
================
budHashIndex::Allocate
================
*/
void budHashIndex::Allocate( const int newHashSize, const int newIndexSize )
{
	assert( budMath::IsPowerOfTwo( newHashSize ) );
...
/*
================
budHashIndex::ResizeIndex
================
*/
void budHashIndex::ResizeIndex( const int newIndexSize )
{
...
/*
================
budHashIndex::GetSpread
================
*/
int budHashIndex::GetSpread() const
{
