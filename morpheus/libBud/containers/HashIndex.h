...
public:
	...
	budHashIndex();
	budHashIndex( const int initialHashSize, const int initialIndexSize );
	~budHashIndex();
	...
	budHashIndex& 	operator=( const budHashIndex& other );
	...
	int				GenerateKey( const budVec3& v ) const;
...
/*
================
budHashIndex::budHashIndex
================
*/
BUD_INLINE budHashIndex::budHashIndex()
{
...
================
*/
BUD_INLINE budHashIndex::budHashIndex( const int initialHashSize, const int initialIndexSize )
{
...
/*
================
budHashIndex::Allocated
================
*/
BUD_INLINE size_t budHashIndex::Allocated() const
{
...
================
*/
BUD_INLINE size_t budHashIndex::Size() const
{
...
/*
================
budHashIndex::operator=
================
*/
BUD_INLINE budHashIndex& budHashIndex::operator=( const budHashIndex& other )
{
...
================
*/
BUD_INLINE void budHashIndex::Add( const int key, const int index )
{
	int h;
...
================
*/
BUD_INLINE void budHashIndex::Remove( const int key, const int index )
{
	int k = key & hashMask;
...
================
*/
BUD_INLINE int budHashIndex::First( const int key ) const
{
...
================
*/
BUD_INLINE int budHashIndex::Next( const int index ) const
{
...
/*
================
budHashIndex::InsertIndex
================
*/
BUD_INLINE void budHashIndex::InsertIndex( const int key, const int index )
{
	int i, max;
...
/*
================
budHashIndex::RemoveIndex
================
*/
BUD_INLINE void budHashIndex::RemoveIndex( const int key, const int index )
{
	int i, max;
...
================
*/
BUD_INLINE void budHashIndex::Clear()
{
...
================
*/
BUD_INLINE void budHashIndex::Clear( const int newHashSize, const int newIndexSize )
{
	Free();
...
/*
================
budHashIndex::GetHashSize
================
*/
BUD_INLINE int budHashIndex::GetHashSize() const
{
	return hashSize;
}
...
/*
================
budHashIndex::GetIndexSize
================
*/
BUD_INLINE int budHashIndex::GetIndexSize() const
{
	return indexSize;
}
...
/*
================
budHashIndex::SetGranularity
================
*/
BUD_INLINE void budHashIndex::SetGranularity( const int newGranularity )
{
...
/*
================
budHashIndex::GenerateKey
================
*/
BUD_INLINE int budHashIndex::GenerateKey( const char* string, bool caseSensitive ) const
{
	if( caseSensitive )
	{
		return ( budStr::Hash( string ) & hashMask );
	}
	else
	{
		return ( budStr::IHash( string ) & hashMask );
	}
}
...
================
*/
BUD_INLINE int budHashIndex::GenerateKey( const budVec3& v ) const
{
...
================
*/
BUD_INLINE int budHashIndex::GenerateKey( const int n1, const int n2 ) const
{
...
================
*/
BUD_INLINE int budHashIndex::GenerateKey( const int n ) const
{
	return n & hashMask;
}
