...
To sort an array, an budList or an budStaticList, a new sort class, typically derived from
budSort_Quick, is implemented as follows:

class budSort_MySort : public budSort_Quick< idMyObject, budSort_MySort > {
public:
...
budSort_MySort().Sort( array, 100 );

To sort an budList:

budList< idMyObject > list;
list.Sort( budSort_MySort() );
...
BUD_INLINE void SwapValues( _type_ & a, _type_ & b )
{
	_type_ c = a;
	a = b;
	b = c;
...
/*
================================================
budSort is an abstract template class for sorting an array of objects of the specified data type.
...
*/
template< typename _type_ >
class budSort_QuickDefault : public budSort_Quick< _type_, budSort_QuickDefault< _type_ > >
{
public:
...
*/
template<>
class budSort_QuickDefault< float > : public budSort_Quick< float, budSort_QuickDefault< float > >
{
public:
...
/*
================================================
budSort_Heap is a sort template class that implements the
heap-sort algorithm on an array of objects of the specified data type.
================================================
*/
template< typename _type_, typename _derived_ >
class budSort_Heap : public budSort< _type_ >
{
public:
	virtual void Sort( _type_ * base, unsigned int num ) const
	{
...
*/
template< typename _type_ >
class budSort_HeapDefault : public budSort_Heap< _type_, budSort_HeapDefault< _type_ > >
{
public:
	int Compare( const _type_ & a, const _type_ & b ) const
	{
...
/*
================================================
budSort_Insertion is a sort template class that implements the
insertion-sort algorithm on an array of objects of the specified data type.
================================================
*/
template< typename _type_, typename _derived_ >
class budSort_Insertion : public budSort< _type_ >
{
public:
	virtual void Sort( _type_ * base, unsigned int num ) const
	{
...
*/
template< typename _type_ >
class budSort_InsertionDefault : public budSort_Insertion< _type_, budSort_InsertionDefault< _type_ > >
{
public:
	int Compare( const _type_ & a, const _type_ & b ) const
	{
