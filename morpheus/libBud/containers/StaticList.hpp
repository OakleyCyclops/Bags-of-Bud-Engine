...
public:
	...
	budStaticList();
	budStaticList( const budStaticList<type, size>& other );
	~budStaticList<type, size>();
	...
	int					Append( const budStaticList<type, size>& other );		// append list
	...
	void				Swap( budStaticList<type, size>& other );				// swap the contents of the lists
	void				DeleteContents( bool clear );						// delete the contents of the list
	
	void				Sort( const budSort<type>& sort = budSort_QuickDefault<type>() );
...
/*
================
budStaticList<type,size>::budStaticList()
================
*/
template<class type, int size>
BUD_INLINE budStaticList<type, size>::budStaticList()
{
	num = 0;
}
...
/*
================
budStaticList<type,size>::budStaticList( const budStaticList<type,size> &other )
================
*/
template<class type, int size>
BUD_INLINE budStaticList<type, size>::budStaticList( const budStaticList<type, size>& other )
{
	*this = other;
}
...
/*
================
budStaticList<type,size>::~budStaticList<type,size>
================
*/
template<class type, int size>
BUD_INLINE budStaticList<type, size>::~budStaticList()
...
*/
template< class type, int size >
BUD_INLINE void budStaticList<type, size>::Sort( const budSort<type>& sort )
{
	if( list == NULL )
	{
		return;
...
/*
================
budStaticList<type,size>::DeleteContents
...
*/
template<class type, int size>
BUD_INLINE void budStaticList<type, size>::DeleteContents( bool clear )
{
	int i;
...
/*
================
budStaticList<type,size>::Num

Returns the number of elements currently contained in the list.
================
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::Num() const
{
	return num;
}
...
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::Max() const
{
	return size;
}
...
/*
================
budStaticList<type>::Allocated
================
*/
template<class type, int size>
BUD_INLINE size_t budStaticList<type, size>::Allocated() const
{
...
*/
template<class type, int size>
BUD_INLINE size_t budStaticList<type, size>::Size() const
{
	return sizeof( budStaticList<type, size> ) + Allocated();
}
...
*/
template<class type, int size>
BUD_INLINE size_t budStaticList<type, size>::MemoryUsed() const
{
...
/*
================
budStaticList<type,size>::SetNum

Set number of elements in list.
================
*/
template<class type, int size>
BUD_INLINE void budStaticList<type, size>::SetNum( int newnum )
{
	assert( newnum >= 0 );
	assert( newnum <= size );
	num = newnum;
...
/*
========================
budStaticList<_type_,_tag_>::SetNum
========================
*/
template< class type, int size >
BUD_INLINE void budStaticList<type, size>::SetNum( int newNum, const type& initValue )
{
	assert( newNum >= 0 );
...
/*
================
budStaticList<type,size>::operator[] const
...
*/
template<class type, int size>
BUD_INLINE const type& budStaticList<type, size>::operator[]( int index ) const
{
	assert( index >= 0 );
	assert( index < num );
...
/*
================
budStaticList<type,size>::operator[]
...
*/
template<class type, int size>
BUD_INLINE type& budStaticList<type, size>::operator[]( int index )
{
	assert( index >= 0 );
	assert( index < num );
...
*/
template<class type, int size>
BUD_INLINE type* budStaticList<type, size>::Ptr()
{
	return &list[ 0 ];
}
...
*/
template<class type, int size>
BUD_INLINE const type* budStaticList<type, size>::Ptr() const
{
	return &list[ 0 ];
}
...
/*
================
budStaticList<type,size>::Alloc

Returns a pointer to a new data element at the end of the list.
================
*/
template<class type, int size>
BUD_INLINE type* budStaticList<type, size>::Alloc()
{
	if( num >= size )
	{
		return NULL;
...
/*
================
budStaticList<type,size>::Append
...
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::Append( type const& obj )
{
	assert( num < size );
	if( num < size )
	{
...
/*
================
budStaticList<type,size>::Insert
...
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::Insert( type const& obj, int index )
{
	int i;
...
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::Append( const budStaticList<type, size>& other )
{
	int i;
	int n = other.Num();
...
/*
================
budStaticList<type,size>::AddUnique

Adds the data to the list if it doesn't already exist.  Returns the index of the data in the list.
================
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::AddUnique( type const& obj )
{
	int index;
...
/*
================
budStaticList<type,size>::FindIndex

Searches for the specified data in the list and returns it's index.  Returns -1 if the data is not found.
================
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::FindIndex( type const& obj ) const
{
	int i;
...
/*
================
budStaticList<type,size>::FindNull
...
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::FindNull() const
{
	int i;
...
/*
================
budStaticList<type,size>::IndexOf
...
*/
template<class type, int size>
BUD_INLINE int budStaticList<type, size>::IndexOf( type const* objptr ) const
{
	int index;
...
/*
================
budStaticList<type,size>::RemoveIndex
...
*/
template<class type, int size>
BUD_INLINE bool budStaticList<type, size>::RemoveIndex( int index )
{
	int i;
...
BUD_INLINE bool budStaticList<_type_, size>::RemoveIndexFast( int index )
{
...
/*
================
budStaticList<type,size>::Remove
...
*/
template<class type, int size>
BUD_INLINE bool budStaticList<type, size>::Remove( type const& obj )
{
	int index;
...
/*
================
budStaticList<type,size>::Swap

Swaps the contents of two lists
================
*/
template<class type, int size>
BUD_INLINE void budStaticList<type, size>::Swap( budStaticList<type, size>& other )
{
	budStaticList<type, size> temp = *this;
	*this = other;
	other = temp;
}

// debug tool to find uses of budList that are dynamically growing
...
*/
template< class type, int size >
BUD_INLINE void budStaticList<type, size>::Resize( int newsize )
{
