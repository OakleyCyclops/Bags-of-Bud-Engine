...
BUD_INLINE void* budListArrayNew( int num, bool zeroBuffer )
{
	_type_ * ptr = NULL;
	if( zeroBuffer )
	{
...
BUD_INLINE void budListArrayDelete( void* ptr, int num )
{
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void* budListArrayResize( void* voldptr, int oldNum, int newNum, bool zeroBuffer )
{
	_type_ * oldptr = ( _type_* )voldptr;
	_type_ * newptr = NULL;
	if( newNum > 0 )
	{
		newptr = ( _type_* )budListArrayNew<_type_, _tag_>( newNum, zeroBuffer );
	...
	budListArrayDelete<_type_>( voldptr, oldNum );
	return newptr;
}

/*
================
budListNewElement<type>
================
*/
template< class type >
BUD_INLINE type* budListNewElement()
{
	return new type;
}

template< typename _type_, memTag_t _tag_ = TAG_libBud_LIST >
class budList
{
public:
	...
	budList( int newgranularity = 16 );
	budList( const budList& other );
	~budList();
	...
	budList<_type_, _tag_>& 		operator=( const budList<_type_, _tag_>& other );
	...
	int				Append( const budList& other );						// append list
...
//	void			Sort( cmp_t *compare = ( cmp_t * )&budListSortCompare<_type_, _tag_> );
	void			SortWithTemplate( const budSort<_type_>& sort = budSort_QuickDefault<_type_>() );
//	void			SortSubSection( int startIndex, int endIndex, cmp_t *compare = ( cmp_t * )&budListSortCompare<_type_> );
	void			Swap( budList& other );								// swap the contents of the lists
	void			DeleteContents( bool clear = true );				// delete the contents of the list
	
	//------------------------
	// auto-cast to other budList types with a different memory tag
	//------------------------
	
	template< memTag_t _t_ >
	operator budList<_type_, _t_>& ()
	{
		return *reinterpret_cast<budList<_type_, _t_> *>( this );
	}
	
	template< memTag_t _t_>
	operator const budList<_type_, _t_>& () const
	{
		return *reinterpret_cast<const budList<_type_, _t_> *>( this );
	}
...
/*
================
budList<_type_,_tag_>::budList( int )
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE budList<_type_, _tag_>::budList( int newgranularity )
{
...
/*
================
budList<_type_,_tag_>::budList( const budList< _type_, _tag_ > &other )
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE budList<_type_, _tag_>::budList( const budList& other )
{
	list = NULL;
	*this = other;
}
...
/*
================
budList<_type_,_tag_>::~budList< _type_, _tag_ >
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE budList<_type_, _tag_>::~budList()
{
	Clear();
}
...
/*
================
budList<_type_,_tag_>::Clear

Frees up the memory allocated by the list.  Assumes that _type_ automatically handles freeing up memory.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::Clear()
{
	if( list )
	{
		budListArrayDelete< _type_ >( list, size );
	}
...
/*
================
budList<_type_,_tag_>::DeleteContents
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::DeleteContents( bool clear )
{
	int i;
...
/*
================
budList<_type_,_tag_>::Size

return total size of list in bytes, but doesn't take into account additional memory allocated by _type_
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE size_t budList<_type_, _tag_>::Size() const
{
	return sizeof( budList< _type_, _tag_ > ) + Allocated();
}

/*
================
budList<_type_,_tag_>::MemoryUsed
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE size_t budList<_type_, _tag_>::MemoryUsed() const
{
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::Num() const
{
	return num;
}
...
/*
================
budList<_type_,_tag_>::NumAllocated

Returns the number of elements currently allocated for.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::NumAllocated() const
{
	return size;
}
...
/*
================
budList<_type_,_tag_>::SetNum
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::SetNum( int newnum )
{
	assert( newnum >= 0 );
	if( newnum > size )
	{
...
/*
================
budList<_type_,_tag_>::SetGranularity

Sets the base size of the array and resizes the array to match.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::SetGranularity( int newgranularity )
{
	int newsize;
...
/*
================
budList<_type_,_tag_>::GetGranularity

Get the current granularity.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::GetGranularity() const
{
	return granularity;
}
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::Resize( int newsize )
{
	assert( newsize >= 0 );
	...
	list = ( _type_* )budListArrayResize< _type_, _tag_ >( list, size, newsize, false );
	size = newsize;
	if( size < num )
	{
		num = size;
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::Resize( int newsize, int newgranularity )
{
	assert( newsize >= 0 );
...
/*
================
budList<_type_,_tag_>::AssureSize

Makes sure the list has at least the given number of elements.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::AssureSize( int newSize )
{
	int newNum = newSize;
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::AssureSize( int newSize, const _type_ &initValue )
{
	int newNum = newSize;
...
/*
================
budList<_type_,_tag_>::AssureSizeAlloc
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::AssureSizeAlloc( int newSize, new_t* allocator )
{
	int newNum = newSize;
...
/*
================
budList<_type_,_tag_>::operator=

Copies the contents and size attributes of another list.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE budList<_type_, _tag_>& budList<_type_, _tag_>::operator=( const budList<_type_, _tag_>& other )
{
	int	i;
	...
	if( size )
	{
		list = ( _type_* )budListArrayNew< _type_, _tag_ >( size, false );
		for( i = 0; i < num; i++ )
		{
			list[ i ] = other.list[ i ];
		}
...
/*
================
budList<_type_,_tag_>::operator[] const
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE const _type_& budList<_type_, _tag_>::operator[]( int index ) const
{
	assert( index >= 0 );
	assert( index < num );
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE _type_& budList<_type_, _tag_>::operator[]( int index )
{
	assert( index >= 0 );
	assert( index < num );
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE _type_* budList<_type_, _tag_>::Ptr()
{
	return list;
}
...
*/
template< typename _type_, memTag_t _tag_ >
const BUD_INLINE _type_* budList<_type_, _tag_>::Ptr() const
{
	return list;
}
...
/*
================
budList<_type_,_tag_>::Alloc

Returns a reference to a new data element at the end of the list.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE _type_& budList<_type_, _tag_>::Alloc()
{
	if( !list )
	{
		Resize( granularity );
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::Append( _type_ const& obj )
{
	if( !list )
	{
		Resize( granularity );
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::Insert( _type_ const& obj, int index )
{
	if( !list )
	{
		Resize( granularity );
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::Append( const budList< _type_, _tag_ >& other )
{
	if( !list )
	{
		if( granularity == 0 )  	// this is a hack to fix our memset classes
...
/*
================
budList<_type_,_tag_>::AddUnique

Adds the data to the list if it doesn't already exist.  Returns the index of the data in the list.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::AddUnique( _type_ const& obj )
{
	int index;
...
/*
================
budList<_type_,_tag_>::FindIndex

Searches for the specified data in the list and returns it's index.  Returns -1 if the data is not found.
================
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::FindIndex( _type_ const& obj ) const
{
	int i;
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::FindNull() const
{
	int i;
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE int budList<_type_, _tag_>::IndexOf( _type_ const* objptr ) const
{
	int index;
...
/*
================
budList<_type_,_tag_>::RemoveIndex
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE bool budList<_type_, _tag_>::RemoveIndex( int index )
{
	int i;
...
/*
========================
budList<_type_,_tag_>::RemoveIndexFast
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE bool budList<_type_, _tag_>::RemoveIndexFast( int index )
{
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE bool budList<_type_, _tag_>::Remove( _type_ const& obj )
{
	int index;
...
//*/
//template< typename _type_, memTag_t _tag_ >
//BUD_INLINE void budList<_type_,_tag_>::Sort( cmp_t *compare ) {
//	if ( !list ) {
//		return;
//	}
...
/*
========================
budList<_type_,_tag_>::SortWithTemplate
...
*/
template< typename _type_, memTag_t _tag_ >
BUD_INLINE void budList<_type_, _tag_>::SortWithTemplate( const budSort<_type_>& sort )
{
	if( list == NULL )
	{
		return;
...
///*
//================
//budList<_type_,_tag_>::SortSubSection
//
//Sorts a subsection of the list.
//================
//*/
//template< typename _type_, memTag_t _tag_ >
//BUD_INLINE void budList<_type_,_tag_>::SortSubSection( int startIndex, int endIndex, cmp_t *compare ) {
//	if ( !list ) {
//		return;
//	}
//	if ( startIndex < 0 ) {
...
_type_* FindFromGeneric( budList<_type_, _tag_>& list, const _compare_type_ & other )
{
...
*/
template< typename _type_, memTag_t _tag_, typename _compare_type_ >
_type_* FindFromGenericPtr( budList<_type_, _tag_>& list, const _compare_type_ & other )
{
	for( int i = 0; i < list.Num(); i++ )
	{
		if( *list[ i ] == other )
