...
========================
*/
BUD_INLINE_EXTERN idCallbackStatic MakeCallback( void ( *f )() )
{
...
*/
template < class T >
BUD_INLINE_EXTERN idCallbackBindMem<T> MakeCallback( T* t, void ( T::*f )() )
{
...
*/
template < class T, typename A1 >
BUD_INLINE_EXTERN idCallbackBindMemArg1<T, A1> MakeCallback( T* t, void ( T::*f )( A1 ), A1 a1 )
{
