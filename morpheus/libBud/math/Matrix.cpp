...
budMat2 mat2_zero( budVec2( 0, 0 ), budVec2( 0, 0 ) );
budMat2 mat2_identity( budVec2( 1, 0 ), budVec2( 0, 1 ) );
...
bool budMat2::InverseSelf()
{
	...
	if( budMath::Fabs( det ) < MATRIX_INVERSE_EPSILON )
	{
		return false;
	}
...
/*
============
budMat2::InverseFastSelf
============
*/
bool budMat2::InverseFastSelf()
{
#if 1
	// 2+4 = 6 multiplications
	//		 1 division
...
=============
*/
const char* budMat2::ToString( int precision ) const
{
...
budMat3 mat3_zero( budVec3( 0, 0, 0 ), budVec3( 0, 0, 0 ), budVec3( 0, 0, 0 ) );
budMat3 mat3_identity( budVec3( 1, 0, 0 ), budVec3( 0, 1, 0 ), budVec3( 0, 0, 1 ) );
...
========================
*/
budAngles budMat3::ToAngles() const
{
	budAngles angles;
	float s = budMath::Sqrt( mat[0][0] * mat[0][0] + mat[0][1] * mat[0][1] );
	if( s > budMath::FLT_EPSILON )
	{
		angles.pitch = RAD2DEG( - budMath::ATan( mat[0][2], s ) );
		angles.yaw = RAD2DEG( budMath::ATan( mat[0][1], mat[0][0] ) );
		angles.roll = RAD2DEG( budMath::ATan( mat[1][2], mat[2][2] ) );
	}
	else
	{
		angles.pitch = mat[0][2] < 0.0f ? 90.0f : -90.0f;
		angles.yaw = RAD2DEG( - budMath::ATan( mat[1][0], mat[1][1] ) );
		angles.roll = 0.0f;
	}
	return angles;
}
...
============
*/
budRotation budMat3::ToRotation() const
{
	budRotation	r;
	float		trace;
	float		s;
	...
	r.angle = budMath::ACos( r.angle );
	float lengthSqr = r.vec.LengthSqr();
	if( ( budMath::Fabs( r.angle ) < 1e-10f ) || ( lengthSqr < 1e-10f ) )
	{
	...
	{
		r.vec *= budMath::InvSqrt( lengthSqr );
		r.angle *= 2.0f * budMath::M_RAD2DEG;
	}
...
/*
=================
budMat3::ToAngularVelocity
=================
*/
budVec3 budMat3::ToAngularVelocity() const
{
	budRotation rotation = ToRotation();
...
============
*/
float budMat3::Determinant() const
{
...
/*
============
budMat3::InverseFastSelf
============
*/
bool budMat3::InverseFastSelf()
{
#if 1
	// 18+3+9 = 30 multiplications
	//			 1 division
	...
	// r3.InverseSelf();
	if( budMath::Fabs( r3 ) < MATRIX_INVERSE_EPSILON )
	{
		return false;
	}
...
/*
============
budMat3::InertiaTranslate
============
*/
budMat3 budMat3::InertiaTranslate( const float mass, const budVec3& centerOfMass, const budVec3& translation ) const
{
	budMat3 m;
	budVec3 newCenter;
...
/*
============
budMat3::InertiaTranslateSelf
============
*/
budMat3& budMat3::InertiaTranslateSelf( const float mass, const budVec3& centerOfMass, const budVec3& translation )
{
	budMat3 m;
	budVec3 newCenter;
...
/*
============
budMat3::InertiaRotate
============
*/
budMat3 budMat3::InertiaRotate( const budMat3& rotation ) const
{
...
/*
============
budMat3::InertiaRotateSelf
============
*/
budMat3& budMat3::InertiaRotateSelf( const budMat3& rotation )
{
	// NOTE: the rotation matrix is stored column-major
...
=============
*/
const char* budMat3::ToString( int precision ) const
{
	return budStr::FloatArrayToString( ToFloatPtr(), GetDimension(), precision );
}
...
budMat4 mat4_zero( budVec4( 0, 0, 0, 0 ), budVec4( 0, 0, 0, 0 ), budVec4( 0, 0, 0, 0 ), budVec4( 0, 0, 0, 0 ) );
budMat4 mat4_identity( budVec4( 1, 0, 0, 0 ), budVec4( 0, 1, 0, 0 ), budVec4( 0, 0, 1, 0 ), budVec4( 0, 0, 0, 1 ) );
...
============
*/
budMat4 budMat4::Transpose() const
{
	budMat4	transpose;
	int		i, j;
...
============
*/
float budMat4::Determinant() const
{
...
/*
============
budMat4::InverseFastSelf
============
*/
bool budMat4::InverseFastSelf()
{
#if 0
	// 84+4+16 = 104 multiplications
	//			   1 division
...
=============
*/
const char* budMat4::ToString( int precision ) const
{
	return budStr::FloatArrayToString( ToFloatPtr(), GetDimension(), precision );
}
...
budMat5 mat5_zero( budVec5( 0, 0, 0, 0, 0 ), budVec5( 0, 0, 0, 0, 0 ), budVec5( 0, 0, 0, 0, 0 ), budVec5( 0, 0, 0, 0, 0 ), budVec5( 0, 0, 0, 0, 0 ) );
budMat5 mat5_identity( budVec5( 1, 0, 0, 0, 0 ), budVec5( 0, 1, 0, 0, 0 ), budVec5( 0, 0, 1, 0, 0 ), budVec5( 0, 0, 0, 1, 0 ), budVec5( 0, 0, 0, 0, 1 ) );
...
============
*/
budMat5 budMat5::Transpose() const
{
	budMat5	transpose;
	int		i, j;
...
============
*/
float budMat5::Determinant() const
{
...
/*
============
budMat5::InverseFastSelf
============
*/
bool budMat5::InverseFastSelf()
{
#if 0
	// 280+5+25 = 310 multiplications
	//				1 division
...
=============
*/
const char* budMat5::ToString( int precision ) const
{
	return budStr::FloatArrayToString( ToFloatPtr(), GetDimension(), precision );
}
...
budMat6 mat6_zero( budVec6( 0, 0, 0, 0, 0, 0 ), budVec6( 0, 0, 0, 0, 0, 0 ), budVec6( 0, 0, 0, 0, 0, 0 ), budVec6( 0, 0, 0, 0, 0, 0 ), budVec6( 0, 0, 0, 0, 0, 0 ), budVec6( 0, 0, 0, 0, 0, 0 ) );
budMat6 mat6_identity( budVec6( 1, 0, 0, 0, 0, 0 ), budVec6( 0, 1, 0, 0, 0, 0 ), budVec6( 0, 0, 1, 0, 0, 0 ), budVec6( 0, 0, 0, 1, 0, 0 ), budVec6( 0, 0, 0, 0, 1, 0 ), budVec6( 0, 0, 0, 0, 0, 1 ) );
...
============
*/
budMat6 budMat6::Transpose() const
{
	budMat6	transpose;
	int		i, j;
...
============
*/
float budMat6::Determinant() const
{
...
/*
============
budMat6::InverseFastSelf
============
*/
bool budMat6::InverseFastSelf()
{
#if 0
	// 810+6+36 = 852 multiplications
	//				1 division
...
=============
*/
const char* budMat6::ToString( int precision ) const
{
	return budStr::FloatArrayToString( ToFloatPtr(), GetDimension(), precision );
}
