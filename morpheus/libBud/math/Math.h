...
#define DEG2RAD(a)				( (a) * budMath::M_DEG2RAD )
#define RAD2DEG(a)				( (a) * budMath::M_RAD2DEG )

#define SEC2MS(t)				( budMath::Ftoi( (t) * budMath::M_SEC2MS ) )
#define MS2SEC(t)				( (t) * budMath::M_MS2SEC )

#define	ANGLE2SHORT(x)			( budMath::Ftoi( (x) * 65536.0f / 360.0f ) & 65535 )
#define	SHORT2ANGLE(x)			( (x) * ( 360.0f / 65536.0f ) )

#define	ANGLE2BYTE(x)			( budMath::Ftoi( (x) * 256.0f / 360.0f ) & 255 )
...
========================
*/
BUD_INLINE float budMath::InvSqrt( float x )
{
...
========================
*/
BUD_INLINE float budMath::InvSqrt16( float x )
{
	return ( x > FLT_SMALLEST_NON_DENORMAL ) ? sqrtf( 1.0f / x ) : INFINITY;
}
...
========================
*/
BUD_INLINE float budMath::Sqrt( float x )
{
...
========================
*/
BUD_INLINE float budMath::Sqrt16( float x )
{
...
========================
*/
BUD_INLINE float budMath::Frac( float f )
{
	return f - floorf( f );
}
...
========================
*/
BUD_INLINE float budMath::Sin( float a )
{
	return sinf( a );
}
...
========================
*/
BUD_INLINE float budMath::Sin16( float a )
{
	float s;
...
========================
*/
BUD_INLINE float budMath::Cos( float a )
{
	return cosf( a );
}
...
========================
*/
BUD_INLINE float budMath::Cos16( float a )
{
	float s, d;
...
========================
*/
BUD_INLINE void budMath::SinCos( float a, float& s, float& c )
{
...
========================
*/
BUD_INLINE void budMath::SinCos16( float a, float& s, float& c )
{
	float t, d;
...
========================
*/
BUD_INLINE float budMath::Tan( float a )
{
	return tanf( a );
}
...
========================
*/
BUD_INLINE float budMath::Tan16( float a )
{
	float s;
	bool reciprocal;
...
========================
*/
BUD_INLINE float budMath::ASin( float a )
{
	if( a <= -1.0f )
	{
		return -HALF_PI;
...
========================
*/
BUD_INLINE float budMath::ASin16( float a )
{
	if( a < 0.0f )
	{
		if( a <= -1.0f )
		...
		a = fabsf( a );
		return ( ( ( -0.0187293f * a + 0.0742610f ) * a - 0.2121144f ) * a + 1.5707288f ) * budMath::Sqrt( 1.0f - a ) - HALF_PI;
	}
	else
	{
		if( a >= 1.0f )
		...
		return HALF_PI - ( ( ( -0.0187293f * a + 0.0742610f ) * a - 0.2121144f ) * a + 1.5707288f ) * budMath::Sqrt( 1.0f - a );
	}
}
...
========================
*/
BUD_INLINE float budMath::ACos( float a )
{
	if( a <= -1.0f )
	{
		return PI;
...
========================
*/
BUD_INLINE float budMath::ACos16( float a )
{
	if( a < 0.0f )
	{
		if( a <= -1.0f )
		...
		a = fabsf( a );
		return PI - ( ( ( -0.0187293f * a + 0.0742610f ) * a - 0.2121144f ) * a + 1.5707288f ) * budMath::Sqrt( 1.0f - a );
	}
	else
	{
		if( a >= 1.0f )
		...
		return ( ( ( -0.0187293f * a + 0.0742610f ) * a - 0.2121144f ) * a + 1.5707288f ) * budMath::Sqrt( 1.0f - a );
	}
}
...
========================
*/
BUD_INLINE float budMath::ATan( float a )
{
	return atanf( a );
}
...
========================
*/
BUD_INLINE float budMath::ATan16( float a )
{
	float s;
	if( fabsf( a ) > 1.0f )
	{
...
========================
*/
BUD_INLINE float budMath::ATan( float y, float x )
{
	assert( fabs( y ) > budMath::FLT_SMALLEST_NON_DENORMAL || fabs( x ) > budMath::FLT_SMALLEST_NON_DENORMAL );
	return atan2f( y, x );
}
...
========================
*/
BUD_INLINE float budMath::ATan16( float y, float x )
{
	assert( fabs( y ) > budMath::FLT_SMALLEST_NON_DENORMAL || fabs( x ) > budMath::FLT_SMALLEST_NON_DENORMAL );
...
========================
*/
BUD_INLINE float budMath::Pow( float x, float y )
{
	return powf( x, y );
}
...
========================
*/
BUD_INLINE float budMath::Pow16( float x, float y )
{
...
========================
*/
BUD_INLINE float budMath::Exp( float f )
{
	return expf( f );
}
...
========================
*/
BUD_INLINE float budMath::Exp16( float f )
{
...
========================
*/
BUD_INLINE float budMath::Log( float f )
{
	return logf( f );
}
...
========================
*/
BUD_INLINE float budMath::Log16( float f )
{
...
========================
*/
BUD_INLINE int budMath::IPow( int x, int y )
{
	int r;
	for( r = x; y > 1; y-- )
	{
...
========================
*/
BUD_INLINE int budMath::ILog2( float f )
{
...
========================
*/
BUD_INLINE int budMath::ILog2( int i )
{
...
/*
========================
budMath::BitsForFloat
========================
*/
BUD_INLINE int budMath::BitsForFloat( float f )
{
	return ILog2( f ) + 1;
}
...
/*
========================
budMath::BitsForInteger
========================
*/
BUD_INLINE int budMath::BitsForInteger( int i )
{
...
/*
========================
budMath::MaskForFloatSign
========================
*/
BUD_INLINE int budMath::MaskForFloatSign( float f )
{
...
/*
========================
budMath::MaskForIntegerSign
========================
*/
BUD_INLINE int budMath::MaskForIntegerSign( int i )
{
...
/*
========================
budMath::FloorPowerOfTwo
========================
*/
BUD_INLINE int budMath::FloorPowerOfTwo( int x )
{
	x |= x >> 1;
	x |= x >> 2;
	x |= x >> 4;
...
/*
========================
budMath::CeilPowerOfTwo
========================
*/
BUD_INLINE int budMath::CeilPowerOfTwo( int x )
{
	x--;
	x |= x >> 1;
	x |= x >> 2;
...
/*
========================
budMath::IsPowerOfTwo
========================
*/
BUD_INLINE bool budMath::IsPowerOfTwo( int x )
{
	return ( x & ( x - 1 ) ) == 0 && x > 0;
}
...
========================
*/
BUD_INLINE int budMath::BitCount( int x )
{
	x -= ( ( x >> 1 ) & 0x55555555 );
...
========================
*/
BUD_INLINE int budMath::BitReverse( int x )
{
...
========================
*/
BUD_INLINE int budMath::Abs( int x )
{
#if 1
	return abs( x );
#else
...
========================
*/
BUD_INLINE float budMath::Fabs( float f )
{
#if 1
	return fabsf( f );
#else
...
========================
*/
BUD_INLINE float budMath::Floor( float f )
{
	return floorf( f );
}
...
========================
*/
BUD_INLINE float budMath::Ceil( float f )
{
	return ceilf( f );
}
...
========================
*/
BUD_INLINE float budMath::Rint( float f )
{
...
========================
*/
BUD_INLINE int budMath::Ftoi( float f )
{
...
========================
*/
BUD_INLINE char budMath::Ftoi8( float f )
{
#if defined(USE_INTRINSICS)
	__m128 x = _mm_load_ss( &f );
...
========================
*/
BUD_INLINE short budMath::Ftoi16( float f )
{
#if defined(USE_INTRINSICS)
	__m128 x = _mm_load_ss( &f );
...
========================
*/
BUD_INLINE unsigned short budMath::Ftoui16( float f )
{
	// TO DO - SSE ??
...
========================
*/
BUD_INLINE byte budMath::Ftob( float f )
{
...
========================
*/
BUD_INLINE signed char budMath::ClampChar( int i )
{
	if( i < -128 )
	{
		return -128;
...
========================
*/
BUD_INLINE signed short budMath::ClampShort( int i )
{
	if( i < -32768 )
	{
		return -32768;
...
========================
*/
BUD_INLINE int budMath::ClampInt( int min, int max, int value )
{
	if( value < min )
	{
		return min;
...
========================
*/
BUD_INLINE float budMath::ClampFloat( float min, float max, float value )
{
...
/*
========================
budMath::AngleNormalize360
========================
*/
BUD_INLINE float budMath::AngleNormalize360( float angle )
{
...
/*
========================
budMath::AngleNormalize180
========================
*/
BUD_INLINE float budMath::AngleNormalize180( float angle )
{
...
========================
*/
BUD_INLINE float budMath::AngleDelta( float angle1, float angle2 )
{
...
========================
*/
BUD_INLINE int budMath::FloatHash( const float* array, const int numFloats )
{
	int i, hash = 0;
	const int* ptr;
...
{
	return budMath::Ftoi( ( float ) from + ( ( ( float ) to - ( float ) from ) * f ) );
}
...
========================
*/
inline float budMath::LerpToWithScale( const float cur, const float dest, const float scale )
{
