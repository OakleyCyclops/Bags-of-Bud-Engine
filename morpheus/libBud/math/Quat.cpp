...
=====================
*/
budAngles idQuat::ToAngles() const
{
...
=====================
*/
budRotation idQuat::ToRotation() const
{
	budVec3 vec;
	float angle;
...
============
*/
budVec3 idQuat::ToAngularVelocity() const
{
	budVec3 vec;
...
idQuat& idQuat::Slerp( const idQuat& from, const idQuat& to, float t )
{
	...
	if( ( 1.0f - cosom ) > 1e-6f )
	{
		...
		scale0 = budMath::Sin16( ( 1.0f - t ) * omega ) * sinom;
		scale1 = budMath::Sin16( t * omega ) * sinom;
#endif
	}
	else
	{
...
idQuat& idQuat::Lerp( const idQuat& from, const idQuat& to, const float t )
{
	...
	float s = budMath::InvSqrt( x * x + y * y + z * z + w * w );
...
=============
*/
budAngles idCQuat::ToAngles() const
{
...
=============
*/
budRotation idCQuat::ToRotation() const
{
