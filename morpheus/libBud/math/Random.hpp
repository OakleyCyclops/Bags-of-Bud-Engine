...
BUD_INLINE idRandom::idRandom( int seed )
{
	this->seed = seed;
}

BUD_INLINE void idRandom::SetSeed( int seed )
{
	this->seed = seed;
}

BUD_INLINE int idRandom::GetSeed() const
{
	return seed;
}

BUD_INLINE int idRandom::RandomInt()
{
	seed = 69069 * seed + 1;
	return ( seed & idRandom::MAX_RAND );
}

BUD_INLINE int idRandom::RandomInt( int max )
{
	if( max == 0 )
	{
...
BUD_INLINE float idRandom::RandomFloat()
{
	return ( RandomInt() / ( float )( idRandom::MAX_RAND + 1 ) );
}

BUD_INLINE float idRandom::CRandomFloat()
{
...
BUD_INLINE idRandom2::idRandom2( unsigned int seed )
{
	this->seed = seed;
}

BUD_INLINE void idRandom2::SetSeed( unsigned int seed )
{
	this->seed = seed;
}

BUD_INLINE unsigned int idRandom2::GetSeed() const
{
	return seed;
}

BUD_INLINE int idRandom2::RandomInt()
{
	seed = 1664525L * seed + 1013904223L;
	return ( ( int ) seed & idRandom2::MAX_RAND );
}

BUD_INLINE int idRandom2::RandomInt( int max )
{
	if( max == 0 )
	{
		return 0;		// avoid divide by zero error
	}
	return ( RandomInt() >> ( 16 - budMath::BitsForInteger( max ) ) ) % max;
}

BUD_INLINE float idRandom2::RandomFloat()
{
	unsigned int i;
	seed = 1664525L * seed + 1013904223L;
...
BUD_INLINE float idRandom2::CRandomFloat()
{
	unsigned int i;
	seed = 1664525L * seed + 1013904223L;
	i = idRandom2::IEEE_ONE | ( seed & idRandom2::IEEE_MASK );
