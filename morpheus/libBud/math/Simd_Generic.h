...
public:
	...
	virtual	void VPCALL MinMax( budVec2& min,		budVec2& max,			const budVec2* src,		const int count );
	virtual void VPCALL MinMax( budVec3& min,		budVec3& max,			const budVec3* src,		const int count );
	virtual	void VPCALL MinMax( budVec3& min,		budVec3& max,			const budDrawVert* src,	const int count );
	virtual	void VPCALL MinMax( budVec3& min,		budVec3& max,			const budDrawVert* src,	const triIndex_t* indexes,		const int count );
