...
float	budMatX::temp[MATX_MAX_TEMP + 4];
// RB: changed int to intptr_t
float* 	budMatX::tempPtr = ( float* )( ( ( intptr_t ) budMatX::temp + 15 ) & ~15 );
// RB end
int		budMatX::tempIndex = 0;
...
============
*/
void budMatX::ChangeSize( int rows, int columns, bool makeZero )
{
...
============
*/
budMatX& budMatX::RemoveRow( int r )
{
	int i;
...
/*
============
budMatX::RemoveColumn
============
*/
budMatX& budMatX::RemoveColumn( int r )
{
	int i;
...
/*
============
budMatX::RemoveRowColumn
============
*/
budMatX& budMatX::RemoveRowColumn( int r )
{
	int i;
...
/*
========================
budMatX::CopyLowerToUpperTriangle
========================
*/
void budMatX::CopyLowerToUpperTriangle()
{
...
/*
============
budMatX::IsOrthogonal

  returns true if (*this) * this->Transpose() == Identity
============
*/
bool budMatX::IsOrthogonal( const float epsilon ) const
{
	float* ptr1, *ptr2, sum;
...
============
*/
bool budMatX::IsPMatrix( const float epsilon ) const
{
	int i, j;
	float d;
	budMatX m;
...
============
*/
bool budMatX::IsZMatrix( const float epsilon ) const
{
	int i, j;
...
============
*/
bool budMatX::IsPositiveDefinite( const float epsilon ) const
{
	int i, j, k;
	float d, s;
	budMatX m;
...
/*
============
budMatX::IsSymmetricPositiveDefinite

  returns true if the matrix is Symmetric Positive Definite (PD)
============
*/
bool budMatX::IsSymmetricPositiveDefinite( const float epsilon ) const
{
	budMatX m;
...
/*
============
budMatX::IsPositiveSemiDefinite
...
============
*/
bool budMatX::IsPositiveSemiDefinite( const float epsilon ) const
{
	int i, j, k;
	float d, s;
	budMatX m;
	...
	for( i = 0; i < numRows; i++ )
	{
		...
		for( j = i; j < numColumns; j++ )
		{
			...
			for( k = 0; k < numRows; k++ )
			{
				if( budMath::Fabs( m[k][j] ) > epsilon )
				{
					return false;
				}
				if( budMath::Fabs( m[j][k] ) > epsilon )
				{
					return false;
				}
			}
...
/*
============
budMatX::IsSymmetricPositiveSemiDefinite

  returns true if the matrix is Symmetric Positive Semi Definite (PSD)
============
*/
bool budMatX::IsSymmetricPositiveSemiDefinite( const float epsilon ) const
{
...
/*
============
budMatX::LowerTriangularInverse

  in-place inversion of the lower triangular matrix
============
*/
bool budMatX::LowerTriangularInverse()
{
	int i, j, k;
	double d, sum;
...
/*
============
budMatX::UpperTriangularInverse

  in-place inversion of the upper triangular matrix
============
*/
bool budMatX::UpperTriangularInverse()
{
	int i, j, k;
	double d, sum;
...
=============
*/
const char* budMatX::ToString( int precision ) const
{
...
/*
============
budMatX::Update_RankOne

  Updates the matrix to obtain the matrix: A + alpha * v * w'
============
*/
void budMatX::Update_RankOne( const budVecX& v, const budVecX& w, float alpha )
{
	int i, j;
	float s;
...
/*
============
budMatX::Update_RankOneSymmetric

  Updates the matrix to obtain the matrix: A + alpha * v * v'
============
*/
void budMatX::Update_RankOneSymmetric( const budVecX& v, float alpha )
{
	int i, j;
	float s;
...
============
*/
void budMatX::Update_RowColumn( const budVecX& v, const budVecX& w, int r )
{
	int i;
...
/*
============
budMatX::Update_RowColumnSymmetric
...
============
*/
void budMatX::Update_RowColumnSymmetric( const budVecX& v, int r )
{
	int i;
...
============
*/
void budMatX::Update_Increment( const budVecX& v, const budVecX& w )
{
	int i;
...
/*
============
budMatX::Update_IncrementSymmetric
...
============
*/
void budMatX::Update_IncrementSymmetric( const budVecX& v )
{
	int i;
...
/*
============
budMatX::Inverse_GaussJordan

  in-place inversion using Gauss-Jordan elimination
============
*/
bool budMatX::Inverse_GaussJordan()
{
	int i, j, k, r, c;
	float d, max;
...
/*
============
budMatX::Inverse_UpdateRowColumn
...
============
*/
bool budMatX::Inverse_UpdateRowColumn( const budVecX& v, const budVecX& w, int r )
{
	budVecX s;
...
/*
============
budMatX::Inverse_UpdateIncrement
...
============
*/
bool budMatX::Inverse_UpdateIncrement( const budVecX& v, const budVecX& w )
{
	budVecX v2;
...
/*
============
budMatX::Inverse_UpdateDecrement
...
============
*/
bool budMatX::Inverse_UpdateDecrement( const budVecX& v, const budVecX& w, int r )
{
	budVecX v1, w1;
...
/*
============
budMatX::Inverse_Solve

  Solve Ax = b with A inverted
============
*/
void budMatX::Inverse_Solve( budVecX& x, const budVecX& b ) const
{
	Multiply( x, b );
}
...
============
*/
bool budMatX::LU_Factor( int* index, float* det )
{
	int i, j, k, newi, min;
	double s, t, d, w;
...
/*
============
budMatX::LU_UpdateRankOne

  Updates the in-place LU factorization to obtain the factors for the matrix: LU + alpha * v * w'
============
*/
bool budMatX::LU_UpdateRankOne( const budVecX& v, const budVecX& w, float alpha, int* index )
{
	int i, j, max;
	float* y, *z;
...
============
*/
bool budMatX::LU_UpdateRowColumn( const budVecX& v, const budVecX& w, int r, int* index )
{
#if 0
...
============
*/
bool budMatX::LU_UpdateIncrement( const budVecX& v, const budVecX& w, int* index )
{
	int i, j;
	float sum;
...
============
*/
bool budMatX::LU_UpdateDecrement( const budVecX& v, const budVecX& w, const budVecX& u, int r, int* index )
{
	int i, p;
	budVecX v1, w1;
...
============
*/
void budMatX::LU_Solve( budVecX& x, const budVecX& b, const int* index ) const
{
	int i, j;
	double sum;
...
============
*/
void budMatX::LU_Inverse( budMatX& inv, const int* index ) const
{
	int i, j;
	budVecX x, b;
...
/*
============
budMatX::LU_UnpackFactors

  Unpacks the in-place LU factorization.
============
*/
void budMatX::LU_UnpackFactors( budMatX& L, budMatX& U ) const
{
	int i, j;
...
/*
============
budMatX::LU_MultiplyFactors

  Multiplies the factors of the in-place LU factorization to form the original matrix.
============
*/
void budMatX::LU_MultiplyFactors( budMatX& m, const int* index ) const
{
	int r, rp, i, j;
	double sum;
...
============
*/
bool budMatX::QR_Factor( budVecX& c, budVecX& d )
{
	int i, j, k;
...
============
*/
void budMatX::QR_Rotate( budMatX& R, int i, float a, float b )
{
	int j;
	float f, c, s, w, y;
	...
	else if( budMath::Fabs( a ) > budMath::Fabs( b ) )
	{
		f = b / a;
		c = budMath::Fabs( 1.0f / budMath::Sqrt( 1.0f + f * f ) );
		if( a < 0.0f )
		{
			c = -c;
		}
	...
	{
		f = a / b;
		s = budMath::Fabs( 1.0f / budMath::Sqrt( 1.0f + f * f ) );
		if( b < 0.0f )
		{
			s = -s;
		}
...
/*
============
budMatX::QR_UpdateRankOne

  Updates the unpacked QR factorization to obtain the factors for the matrix: QR + alpha * v * w'
============
*/
bool budMatX::QR_UpdateRankOne( budMatX& R, const budVecX& v, const budVecX& w, float alpha )
{
	int i, k;
	float f;
	budVecX u;
	...
	for( i = k - 1; i >= 0; i-- )
	{
		...
		if( u[i] == 0.0f )
		{
			u[i] = budMath::Fabs( u[i + 1] );
		}
		else if( budMath::Fabs( u[i] ) > budMath::Fabs( u[i + 1] ) )
		{
			f = u[i + 1] / u[i];
			u[i] = budMath::Fabs( u[i] ) * budMath::Sqrt( 1.0f + f * f );
		}
		else
		{
			f = u[i] / u[i + 1];
			u[i] = budMath::Fabs( u[i + 1] ) * budMath::Sqrt( 1.0f + f * f );
		}
	}
...
============
*/
bool budMatX::QR_UpdateRowColumn( budMatX& R, const budVecX& v, const budVecX& w, int r )
{
	budVecX s;
...
============
*/
bool budMatX::QR_UpdateIncrement( budMatX& R, const budVecX& v, const budVecX& w )
{
	budVecX v2;
...
============
*/
void budMatX::QR_Solve( budVecX& x, const budVecX& b, const budVecX& c, const budVecX& d ) const
{
	int i, j;
	double sum, t;
...
============
*/
void budMatX::QR_Solve( budVecX& x, const budVecX& b, const budMatX& R ) const
{
	int i, j;
	double sum;
...
============
*/
void budMatX::QR_Inverse( budMatX& inv, const budVecX& c, const budVecX& d ) const
{
	int i, j;
	budVecX x, b;
...
/*
============
budMatX::QR_UnpackFactors

  Unpacks the in-place QR factorization.
============
*/
void budMatX::QR_UnpackFactors( budMatX& Q, budMatX& R, const budVecX& c, const budVecX& d ) const
{
	int i, j, k;
	double sum;
...
/*
============
budMatX::QR_MultiplyFactors

  Multiplies the factors of the in-place QR factorization to form the original matrix.
============
*/
void budMatX::QR_MultiplyFactors( budMatX& m, const budVecX& c, const budVecX& d ) const
{
	int i, j, k;
	double sum;
	budMatX Q;
...
============
*/
float budMatX::Pythag( float a, float b ) const
{
	double at, bt, ct;
	...
	{
		ct = bt / at;
		return at * budMath::Sqrt( 1.0f + ct * ct );
	}
	else
	{
		if( bt )
		{
			ct = at / bt;
			return bt * budMath::Sqrt( 1.0f + ct * ct );
		}
		else
		{
			return 0.0f;
...
============
*/
void budMatX::SVD_BiDiag( budVecX& w, budVecX& rv1, float& anorm )
{
	int i, j, k, l;
	...
	for( i = 0; i < numColumns; i++ )
	{
		...
		r = budMath::Fabs( w[i] ) + budMath::Fabs( rv1[i] );
		if( r > anorm )
		{
			anorm = r;
		}
...
/*
============
budMatX::SVD_InitialWV
============
*/
void budMatX::SVD_InitialWV( budVecX& w, budMatX& V, budVecX& rv1 )
{
	int i, j, k, l;
	double f, g, s;
...
============
*/
bool budMatX::SVD_Factor( budVecX& w, budMatX& V )
{
	...
	for( k = numColumns - 1; k >= 0; k-- )
	{
		for( its = 1; its <= 30; its++ )
		{
			...
			{
				nm = l - 1;
				if( ( budMath::Fabs( rv1[l] ) + anorm ) == anorm /* budMath::Fabs( rv1[l] ) < budMath::FLT_EPSILON */ )
				{
					flag = 0;
					break;
				}
				if( ( budMath::Fabs( w[nm] ) + anorm ) == anorm /* budMath::Fabs( w[nm] ) < budMath::FLT_EPSILON */ )
				{
					break;
				}
			}
			if( flag )
			{
				...
				for( i = l; i <= k; i++ )
				{
					...
					if( ( budMath::Fabs( f ) + anorm ) != anorm /* budMath::Fabs( f ) > budMath::FLT_EPSILON */ )
					{
						g = w[i];
						h = Pythag( f, g );
						w[i] = h;
...
============
*/
void budMatX::SVD_Solve( budVecX& x, const budVecX& b, const budVecX& w, const budMatX& V ) const
{
	int i, j;
	double sum;
	budVecX tmp;
...
============
*/
void budMatX::SVD_Inverse( budMatX& inv, const budVecX& w, const budMatX& V ) const
{
	int i, j, k;
	double wi, sum;
	budMatX V2;
	...
	{
		wi = w[i];
		wi = ( wi < budMath::FLT_EPSILON ) ? 0.0f : 1.0f / wi;
		for( j = 0; j < numColumns; j++ )
		{
			V2[j][i] *= wi;
		}
...
/*
============
budMatX::SVD_MultiplyFactors

  Multiplies the factors of the in-place SVD factorization to form the original matrix.
============
*/
void budMatX::SVD_MultiplyFactors( budMatX& m, const budVecX& w, const budMatX& V ) const
{
	int r, i, j;
	double sum;
...
/*
============
budMatX::Cholesky_UpdateRankOne
...
============
*/
bool budMatX::Cholesky_UpdateRankOne( const budVecX& v, float alpha, int offset )
{
	int i, j;
	float* y;
	...
	for( i = offset; i < numColumns; i++ )
	{
		...
		( *this )[i][i] = newDiag = budMath::Sqrt( newDiagSqr );
...
/*
============
budMatX::Cholesky_UpdateRowColumn
...
============
*/
bool budMatX::Cholesky_UpdateRowColumn( const budVecX& v, int r )
{
	int i, j;
	double sum;
	float* original, *y;
...
/*
============
budMatX::Cholesky_UpdateIncrement
...
============
*/
bool budMatX::Cholesky_UpdateIncrement( const budVecX& v )
{
	int i, j;
	float* x;
	double sum;
	...
	( *this )[numRows - 1][numRows - 1] = budMath::Sqrt( sum );
...
/*
============
budMatX::Cholesky_UpdateDecrement
...
============
*/
bool budMatX::Cholesky_UpdateDecrement( const budVecX& v, int r )
{
	budVecX v1;
...
/*
============
budMatX::Cholesky_Solve

  Solve Ax = b with A factored in-place as: LL'
============
*/
void budMatX::Cholesky_Solve( budVecX& x, const budVecX& b ) const
{
	int i, j;
	double sum;
...
/*
============
budMatX::Cholesky_Inverse

  Calculates the inverse of the matrix which is factored in-place as: LL'
============
*/
void budMatX::Cholesky_Inverse( budMatX& inv ) const
{
	int i, j;
	budVecX x, b;
...
/*
============
budMatX::LDLT_UpdateRankOne

  Updates the in-place LDL' factorization to obtain the factors for the matrix: LDL' + alpha * v * v'
  If offset > 0 only the lower right corner starting at (offset, offset) is updated.
============
*/
bool budMatX::LDLT_UpdateRankOne( const budVecX& v, float alpha, int offset )
{
	int i, j;
	float* y;
...
============
*/
bool budMatX::LDLT_UpdateRowColumn( const budVecX& v, int r )
{
	int i, j;
	double sum;
	float* original, *y;
...
============
*/
bool budMatX::LDLT_UpdateIncrement( const budVecX& v )
{
	int i, j;
	float* x;
	double sum, d;
...
============
*/
void budMatX::LDLT_Solve( budVecX& x, const budVecX& b ) const
{
	int i, j;
	double sum;
...
/*
============
budMatX::LDLT_UnpackFactors

  Unpacks the in-place LDL' factorization.
============
*/
void budMatX::LDLT_UnpackFactors( budMatX& L, budMatX& D ) const
{
	int i, j;
...
/*
============
budMatX::TriDiagonal_ClearTriangles
============
*/
void budMatX::TriDiagonal_ClearTriangles()
{
	int i, j;
...
/*
============
budMatX::TriDiagonal_Solve

  Solve Ax = b with A being tridiagonal.
============
*/
bool budMatX::TriDiagonal_Solve( budVecX& x, const budVecX& b ) const
{
	int i;
	float d;
	budVecX tmp;
...
/*
============
budMatX::TriDiagonal_Inverse

  Calculates the inverse of a tri-diagonal matrix.
============
*/
void budMatX::TriDiagonal_Inverse( budMatX& inv ) const
{
	int i, j;
	budVecX x, b;
...
============
*/
void budMatX::HouseholderReduction( budVecX& diag, budVecX& subd )
{
	int i0, i1, i2, i3;
...
============
*/
bool budMatX::QL( budVecX& diag, budVecX& subd )
{
	...
	for( i0 = 0; i0 < numRows; i0++ )
	{
		for( i1 = 0; i1 < maxIter; i1++ )
		{
			...
			{
				a = budMath::Fabs( diag[i2] ) + budMath::Fabs( diag[i2 + 1] );
				if( budMath::Fabs( subd[i2] ) + a == a )
				{
					break;
				}
			}
			...
			for( i3 = i2 - 1; i3 >= i0; i3-- )
			{
				f = s * subd[i3];
				b = c * subd[i3];
				if( budMath::Fabs( f ) >= budMath::Fabs( g ) )
				{
					c = g / f;
					r = budMath::Sqrt( c * c + 1.0f );
					subd[i3 + 1] = f * r;
					s = 1.0f / r;
					c *= s;
				}
...
/*
============
budMatX::Eigen_SolveSymmetricTriDiagonal
...
============
*/
bool budMatX::Eigen_SolveSymmetricTriDiagonal( budVecX& eigenValues )
{
	int i;
	budVecX subd;
...
============
*/
bool budMatX::Eigen_SolveSymmetric( budVecX& eigenValues )
{
	budVecX subd;
...
/*
============
budMatX::HessenbergReduction

  Reduction to Hessenberg form.
============
*/
void budMatX::HessenbergReduction( budMatX& H )
{
	int i, j, m;
	int low = 0;
	int high = numRows - 1;
	...
	for( m = low + 1; m <= high - 1; m++ )
	{
		...
		for( i = m; i <= high; i++ )
		{
			scale = scale + budMath::Fabs( H[i][m - 1] );
		}
		if( scale != 0.0f )
		{
...
/*
============
budMatX::ComplexDivision

  Complex scalar division.
============
*/
void budMatX::ComplexDivision( float xr, float xi, float yr, float yi, float& cdivr, float& cdivi )
{
	float r, d;
	if( budMath::Fabs( yr ) > budMath::Fabs( yi ) )
	{
		r = yi / yr;
		d = yr + r * yi;
		cdivr = ( xr + r * xi ) / d;
...
/*
============
budMatX::HessenbergToRealSchur

  Reduction from Hessenberg to real Schur form.
============
*/
bool budMatX::HessenbergToRealSchur( budMatX& H, budVecX& realEigenValues, budVecX& imaginaryEigenValues )
{
	int i, j, k;
	int n = numRows - 1;
	int low = 0;
	...
	while( n >= low )
	{
		...
		while( l > low )
		{
			s = budMath::Fabs( H[l - 1][l - 1] ) + budMath::Fabs( H[l][l] );
			if( s == 0.0f )
			{
				s = norm;
			}
			if( budMath::Fabs( H[l][l - 1] ) < eps * s )
			{
				break;
			}
			l--;
		...
		else if( l == n - 1 )  	// two roots found
		{
			...
			if( q >= 0.0f )  		// real pair
			{
				...
				imaginaryEigenValues[n] = 0.0f;
				x = H[n][n - 1];
				s = budMath::Fabs( x ) + budMath::Fabs( z );
				p = x / s;
				q = z / s;
				r = budMath::Sqrt( p * p + q * q );
				p = p / r;
				q = q / r;
		...
		else  	// no convergence yet
		{
			...
			if( iter == 10 )
			{
				...
				s = budMath::Fabs( H[n][n - 1] ) + budMath::Fabs( H[n - 1][n - 2] );
				x = y = 0.75f * s;
				w = -0.4375f * s * s;
			}
			...
			for( m = n - 2; m >= l; m-- )
			{
				...
				q = H[m + 1][m + 1] - z - r - s;
				r = H[m + 2][m + 1];
				s = budMath::Fabs( p ) + budMath::Fabs( q ) + budMath::Fabs( r );
				p = p / s;
				q = q / s;
				r = r / s;
				if( m == l )
				...
				if( budMath::Fabs( H[m][m - 1] ) * ( budMath::Fabs( q ) + budMath::Fabs( r ) ) <
						eps * ( budMath::Fabs( p ) * ( budMath::Fabs( H[m - 1][m - 1] ) + budMath::Fabs( z ) + budMath::Fabs( H[m + 1][m + 1] ) ) ) )
				{
					break;
				}
			}
			...
			for( k = m; k <= n - 1; k++ )
			{
				...
				if( k != m )
				{
					...
					x = budMath::Fabs( p ) + budMath::Fabs( q ) + budMath::Fabs( r );
					if( x != 0.0f )
					{
						p = p / x;
						q = q / x;
	...
	for( n = numRows - 1; n >= 0; n-- )
	{
			...
			for( i = n - 1; i >= 0; i-- )
			{
				...
				else
				{
					...
					else  		// solve real equations
					{
						...
						t = ( x * s - z * r ) / q;
						H[i][n] = t;
						if( budMath::Fabs( x ) > budMath::Fabs( z ) )
						{
							H[i + 1][n] = ( -r - w * t ) / x;
						}
						else
		...
		else if( q < 0.0f )  	// complex vector
		{
			...
			if( budMath::Fabs( H[n][n - 1] ) > budMath::Fabs( H[n - 1][n] ) )
			{
				H[n - 1][n - 1] = q / H[n][n - 1];
			...
			for( i = n - 2; i >= 0; i-- )
			{
				...
				else
				{
					...
					else
					{
						...
						if( vr == 0.0f && vi == 0.0f )
						{
							vr = eps * norm * ( budMath::Fabs( w ) + budMath::Fabs( q ) + budMath::Fabs( x ) + budMath::Fabs( y ) + budMath::Fabs( z ) );
						}
						ComplexDivision( x * r - z * ra + q * sa, x * s - z * sa - q * ra, vr, vi, H[i][n - 1], H[i][n] );
						if( budMath::Fabs( x ) > ( budMath::Fabs( z ) + budMath::Fabs( q ) ) )
						{
					...
					// overflow control
					t = Max( budMath::Fabs( H[i][n - 1] ), budMath::Fabs( H[i][n] ) );
					if( ( eps * t ) * t > 1 )
					{
						for( j = i; j <= n; j++ )
						{
...
============
*/
bool budMatX::Eigen_Solve( budVecX& realEigenValues, budVecX& imaginaryEigenValues )
{
	budMatX H;
...
/*
============
budMatX::Eigen_SortIncreasing
============
*/
void budMatX::Eigen_SortIncreasing( budVecX& eigenValues )
{
...
/*
============
budMatX::Eigen_SortDecreasing
============
*/
void budMatX::Eigen_SortDecreasing( budVecX& eigenValues )
{
	for( int i = 0, j = 0; i <= numRows - 2; i++ )
	{
		j = i;
...
/*
============
budMatX::DeterminantGeneric
============
*/
float budMatX::DeterminantGeneric() const
{
	int* index;
	float det;
	budMatX tmp;
...
/*
============
budMatX::InverseSelfGeneric
============
*/
bool budMatX::InverseSelfGeneric()
{
	int i, j, *index;
	budMatX tmp;
	budVecX x, b;
...
void budMatX::Test()
{
	budMatX original, m1, m2, m3, q1, q2, r1, r2;
	budVecX v, w, u, c, d;
	...
	*/
	...
	{
		libBud::common->Warning( "budMatX::LowerTriangularInverse failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::UpperTriangularInverse failed" );
	}
	...
	*/
	...
	{
		libBud::common->Warning( "budMatX::Inverse_GaussJordan failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::Inverse_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		{
			libBud::common->Warning( "budMatX::Inverse_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::Inverse_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::Inverse_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	{
		libBud::common->Warning( "budMatX::LU_Factor failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::LU_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::LU_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::LU_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::LU_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::LU_Inverse failed" );
	}
	...
	*/
	...
	if( !original.Compare( m1, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::QR_Factor failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::QR_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::QR_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::QR_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::QR_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::QR_Inverse failed" );
	}
	...
	*/
	...
	if( !original.Compare( m1, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::SVD_Factor failed" );
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::SVD_Inverse failed" );
	}
	...
	*/
	...
	{
		libBud::common->Warning( "budMatX::Cholesky_Factor failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::Cholesky_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::Cholesky_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::Cholesky_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset += size - 1 )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::Cholesky_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::Cholesky_Inverse failed" );
	}
	...
	*/
	...
	if( !original.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::LDLT_Factor failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::LDLT_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::LDLT_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::LDLT_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			libBud::common->Warning( "budMatX::LDLT_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::LDLT_Inverse failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::Eigen_SolveSymmetricTriDiagonal failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::Eigen_SolveSymmetric failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		libBud::common->Warning( "budMatX::Eigen_Solve failed" );
	}
}
