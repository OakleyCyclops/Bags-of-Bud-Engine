...
BUD_INLINE_EXTERN float __fmuls( float a, float b )
{
	return ( a * b );
}
BUD_INLINE_EXTERN float __fmadds( float a, float b, float c )
{
	return ( a * b + c );
}
BUD_INLINE_EXTERN float __fnmsubs( float a, float b, float c )
{
	return ( c - a * b );
}
BUD_INLINE_EXTERN float __fsels( float a, float b, float c )
{
	return ( a >= 0.0f ) ? b : c;
}
BUD_INLINE_EXTERN float __frcps( float x )
{
	return ( 1.0f / x );
}
BUD_INLINE_EXTERN float __fdivs( float x, float y )
{
	return ( x / y );
}
BUD_INLINE_EXTERN float __frsqrts( float x )
{
	return ( 1.0f / sqrtf( x ) );
}
BUD_INLINE_EXTERN float __frcps16( float x )
{
	return ( 1.0f / x );
}
BUD_INLINE_EXTERN float __fdivs16( float x, float y )
{
	return ( x / y );
}
BUD_INLINE_EXTERN float __frsqrts16( float x )
{
	return ( 1.0f / sqrtf( x ) );
}
BUD_INLINE_EXTERN float __frndz( float x )
{
	return ( float )( ( int )( x ) );
}
...
BUD_INLINE void Prefetch( const void* ptr, int offset ) {}
BUD_INLINE void ZeroCacheLine( void* ptr, int offset )
{
	byte* bytePtr = ( byte* )( ( ( ( uintptr_t )( ptr ) ) + ( offset ) ) & ~( CACHE_LINE_SIZE - 1 ) );
	memset( bytePtr, 0, CACHE_LINE_SIZE );
}
BUD_INLINE void FlushCacheLine( const void* ptr, int offset ) {}
...
BUD_INLINE_EXTERN int CACHE_LINE_CLEAR_OVERFLOW_COUNT( int size )
{
