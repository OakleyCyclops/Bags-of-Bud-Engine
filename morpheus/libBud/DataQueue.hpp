...
private:
	...
	budStaticList<msgItem_t, maxItems > items;
	int		dataLength;
	byte	data[ maxBuffer ];
};
...
/*
========================
budDataQueue::RemoveOlderThan
========================
*/
template< int maxItems, int maxBuffer >
void budDataQueue< maxItems, maxBuffer >::RemoveOlderThan( int sequence )
{
	int length = 0;
...
*/
template< int maxItems, int maxBuffer >
bool budDataQueue< maxItems, maxBuffer >::Append( int sequence, const byte* b1, int b1Len, const byte* b2, int b2Len )
{
