...
================
*/
bool Reachability_Write( budFile* fp, idReachability* reach )
{
...
================
*/
bool Reachability_Read( budLexer& src, idReachability* reach )
{
...
================
*/
bool Reachability_Special_Write( budFile* fp, idReachability_Special* reach )
{
	int i;
...
================
*/
bool Reachability_Special_Read( budLexer& src, idReachability_Special* reach )
{
	budToken key, value;
...
/*
============
budAASSettings::ParseBool
============
*/
bool budAASSettings::ParseBool( budLexer& src, bool& b )
{
...
/*
============
budAASSettings::ParseInt
============
*/
bool budAASSettings::ParseInt( budLexer& src, int& i )
{
	if( !src.ExpectTokenString( "=" ) )
	{
		return false;
...
/*
============
budAASSettings::ParseFloat
============
*/
bool budAASSettings::ParseFloat( budLexer& src, float& f )
{
	if( !src.ExpectTokenString( "=" ) )
	{
		return false;
...
/*
============
budAASSettings::ParseBBoxes
============
*/
bool budAASSettings::ParseBBoxes( budLexer& src )
{
	budToken token;
	budBounds bounds;
...
/*
============
budAASSettings::FromParser
============
*/
bool budAASSettings::FromParser( budLexer& src )
{
	budToken token;
...
/*
============
budAASSettings::WriteToFile
============
*/
bool budAASSettings::WriteToFile( budFile* fp ) const
{
	int i;
...
/*
============
budAASSettings::ValidForBounds
============
*/
bool budAASSettings::ValidForBounds( const budBounds& bounds ) const
{
	int i;
...
bool budAASSettings::ValidEntity( const char* classname ) const
{
	...
	const budDeclEntityDef* decl = static_cast<const budDeclEntityDef*>( declManager->FindType( DECL_ENTITYDEF, classname, false ) );
...
/*
================
budAASFileLocal::budAASFileLocal
================
*/
budAASFileLocal::budAASFileLocal()
{
...
/*
================
budAASFileLocal::Clear
================
*/
void budAASFileLocal::Clear()
{
	planeList.Clear();
	vertices.Clear();
	edges.Clear();
...
/*
================
budAASFileLocal::ParsePlanes
================
*/
bool budAASFileLocal::ParsePlanes( budLexer& src )
{
	int numPlanes, i;
	budPlane plane;
	budVec4 vec;
...
/*
================
budAASFileLocal::ParseEdges
================
*/
bool budAASFileLocal::ParseEdges( budLexer& src )
{
	int numEdges, i;
	aasEdge_t edge;
...
/*
================
budAASFileLocal::ParseFaces
================
*/
bool budAASFileLocal::ParseFaces( budLexer& src )
{
	int numFaces, i;
	aasFace_t face;
...
/*
================
budAASFileLocal::ParseReachabilities
================
*/
bool budAASFileLocal::ParseReachabilities( budLexer& src, int areaNum )
{
	int num, j;
	aasArea_t* area;
...
/*
================
budAASFileLocal::LinkReversedReachability
================
*/
void budAASFileLocal::LinkReversedReachability()
{
	int i;
	idReachability* reach;
...
/*
================
budAASFileLocal::ParseAreas
================
*/
bool budAASFileLocal::ParseAreas( budLexer& src )
{
	int numAreas, i;
	aasArea_t area;
...
/*
================
budAASFileLocal::ParseNodes
================
*/
bool budAASFileLocal::ParseNodes( budLexer& src )
{
	int numNodes, i;
	aasNode_t node;
...
/*
================
budAASFileLocal::ParsePortals
================
*/
bool budAASFileLocal::ParsePortals( budLexer& src )
{
	int numPortals, i;
	aasPortal_t portal;
...
/*
================
budAASFileLocal::ParseClusters
================
*/
bool budAASFileLocal::ParseClusters( budLexer& src )
{
	int numClusters, i;
...
/*
================
budAASFileLocal::FinishAreas
================
*/
void budAASFileLocal::FinishAreas()
{
	int i;
...
bool budAASFileLocal::Load( const budStr& fileName, unsigned int mapFileCRC )
{
	...
	while( 1 )
	{
		...
		{
			src.Error( "budAASFileLocal::Load: bad token \"%s\"", token.c_str() );
			return false;
		}
	}
	...
	{
		src.Error( "budAASFileLocal::Load: tree depth = %d", depth );
	}
...
/*
================
budAASFileLocal::MemorySize
================
*/
int budAASFileLocal::MemorySize() const
{
	int size;
...
/*
================
budAASFileLocal::PrintInfo
================
*/
void budAASFileLocal::PrintInfo() const
{
...
/*
================
budAASFileLocal::NumReachabilities
================
*/
int budAASFileLocal::NumReachabilities() const
{
	int i, num;
	idReachability* reach;
...
/*
================
budAASFileLocal::ReportRoutingEfficiency
================
*/
void budAASFileLocal::ReportRoutingEfficiency() const
{
...
/*
================
budAASFileLocal::DeleteReachabilities
================
*/
void budAASFileLocal::DeleteReachabilities()
{
	int i;
...
/*
================
budAASFileLocal::DeleteClusters
================
*/
void budAASFileLocal::DeleteClusters()
{
	aasPortal_t portal;
	aasCluster_t cluster;
