...
/*
================
budAASFileLocal::EdgeBounds
================
*/
budBounds budAASFileLocal::EdgeBounds( int edgeNum ) const
{
	const aasEdge_t* edge;
	budBounds bounds;
...
/*
================
budAASFileLocal::FaceBounds
================
*/
budBounds budAASFileLocal::FaceBounds( int faceNum ) const
{
	int i, edgeNum;
	const aasFace_t* face;
	const aasEdge_t* edge;
...
/*
================
budAASFileLocal::AreaBounds
================
*/
budBounds budAASFileLocal::AreaBounds( int areaNum ) const
{
	int i, faceNum;
	const aasArea_t* area;
	budBounds bounds;
...
/*
============
budAASFileLocal::BoundsReachableAreaNum_r
============
*/
int budAASFileLocal::BoundsReachableAreaNum_r( int nodeNum, const budBounds& bounds, const int areaFlags, const int excludeTravelFlags ) const
{
	int res;
	const aasNode_t* node;
...
/*
============
budAASFileLocal::BoundsReachableAreaNum
============
*/
int budAASFileLocal::BoundsReachableAreaNum( const budBounds& bounds, const int areaFlags, const int excludeTravelFlags ) const
{
...
void budAASFileLocal::PushPointIntoAreaNum( int areaNum, budVec3& point ) const
{
	...
	for( i = 0; i < area->numFaces; i++ )
	{
		...
		const budPlane& plane = planeList[face->planeNum ^ INT32_SIGNBITSET( faceNum )];
...
bool budAASFileLocal::Trace( aasTrace_t& trace, const budVec3& start, const budVec3& end ) const
{
	...
	while( 1 )
	{
		...
		if( front >= -ON_EPSILON && back >= -ON_EPSILON )
		{
			...
			{
				common->Error( "budAASFileLocal::Trace: stack overflow\n" );
				return false;
			}
		}
...
/*
============
budAASLocal::AreaContentsTravelFlags
============
*/
int budAASFileLocal::AreaContentsTravelFlags( int areaNum ) const
{
...
/*
============
budAASFileLocal::MaxTreeDepth_r
============
*/
void budAASFileLocal::MaxTreeDepth_r( int nodeNum, int& depth, int& maxDepth ) const
{
	const aasNode_t* node;
...
/*
============
budAASFileLocal::MaxTreeDepth
============
*/
int budAASFileLocal::MaxTreeDepth() const
{
	int depth, maxDepth;
