...
bool budAnimManager::forceExport = false;
...
/*
====================
budMD5Anim::NumFrames
====================
*/
int	budMD5Anim::NumFrames() const
{
	return numFrames;
}
...
/*
====================
budMD5Anim::NumJoints
====================
*/
int	budMD5Anim::NumJoints() const
{
	return numJoints;
}
...
=====================
*/
const char* budMD5Anim::Name() const
{
	return name;
}
...
/*
====================
budMD5Anim::Allocated
====================
*/
size_t budMD5Anim::Allocated() const
{
...
====================
*/
bool budMD5Anim::LoadAnim( const char* filename )
{
...
/*
========================
budMD5Anim::LoadBinary
========================
*/
bool budMD5Anim::LoadBinary( budFile* file, ID_TIME_T sourceTimeStamp )
{
...
/*
========================
budMD5Anim::WriteBinary
========================
*/
void budMD5Anim::WriteBinary( budFile* file, ID_TIME_T sourceTimeStamp )
{
...
/*
====================
budMD5Anim::IncreaseRefs
====================
*/
void budMD5Anim::IncreaseRefs() const
{
	ref_count++;
}
...
/*
====================
budMD5Anim::DecreaseRefs
====================
*/
void budMD5Anim::DecreaseRefs() const
{
	ref_count--;
}
...
/*
====================
budMD5Anim::GetFrameBlend
====================
*/
void budMD5Anim::GetFrameBlend( int framenum, frameBlend_t& frame ) const
{
	frame.cycleCount	= 0;
	frame.backlerp		= 0.0f;
...
/*
====================
budMD5Anim::ConvertTimeToFrame
====================
*/
void budMD5Anim::ConvertTimeToFrame( int time, int cyclecount, frameBlend_t& frame ) const
{
	int frameTime;
	int frameNum;
...
/*
====================
budMD5Anim::GetBounds
====================
*/
void budMD5Anim::GetBounds( budBounds& bnds, int time, int cyclecount ) const
{
	frameBlend_t frame;
	ConvertTimeToFrame( time, cyclecount, frame );
...
====================
*/
int DecodeInterpolatedFrames( budJointQuat* joints, budJointQuat* blendJoints, int* lerpIndex, const float* frame1, const float* frame2,
							  const jointAnimInfo_t* jointInfo, const int* index, const int numIndexes )
{
	...
	for( int i = 0; i < numIndexes; i++ )
	{
		...
		if( animBits != 0 )
		{
			...
			budJointQuat* jointPtr = &joints[j];
			budJointQuat* blendPtr = &blendJoints[j];
...
/*
====================
budMD5Anim::GetInterpolatedFrame
====================
*/
void budMD5Anim::GetInterpolatedFrame( frameBlend_t& frame, budJointQuat* joints, const int* index, int numIndexes ) const
{
	// copy the baseframe
	...
	budJointQuat* blendJoints = ( budJointQuat* )_alloca16( baseFrame.Num() * sizeof( blendJoints[ 0 ] ) );
...
====================
*/
void DecodeSingleFrame( budJointQuat* joints, const float* frame,
						const jointAnimInfo_t* jointInfo, const int* index, const int numIndexes )
{
	for( int i = 0; i < numIndexes; i++ )
	{
...
/*
====================
budMD5Anim::GetSingleFrame
====================
*/
void budMD5Anim::GetSingleFrame( int framenum, budJointQuat* joints, const int* index, int numIndexes ) const
{
	// copy the baseframe
	SIMDProcessor->Memcpy( joints, baseFrame.Ptr(), baseFrame.Num() * sizeof( baseFrame[ 0 ] ) );
...
/*
====================
budMD5Anim::CheckModelHierarchy
====================
*/
void budMD5Anim::CheckModelHierarchy( const budRenderModel* model ) const
{
	...
	const budMD5Joint* modelJoints = model->GetJoints();
	for( int i = 0; i < jointInfo.Num(); i++ )
	{
...
/*
====================
budAnimManager::Shutdown
====================
*/
void budAnimManager::Shutdown()
{
...
/*
====================
budAnimManager::GetAnim
====================
*/
budMD5Anim* budAnimManager::GetAnim( const char* name )
{
	budMD5Anim** animptrptr;
	budMD5Anim* anim;
...
/*
================
budAnimManager::Preload
================
*/
void budAnimManager::Preload( const idPreloadManifest& manifest )
{
...
/*
================
budAnimManager::ReloadAnims
================
*/
void budAnimManager::ReloadAnims()
{
	int			i;
	budMD5Anim**	animptr;
...
/*
================
budAnimManager::JointIndex
================
*/
int	budAnimManager::JointIndex( const char* name )
{
	int i, hash;
...
/*
================
budAnimManager::JointName
================
*/
const char* budAnimManager::JointName( int index ) const
{
...
/*
================
budAnimManager::ListAnims
================
*/
void budAnimManager::ListAnims() const
{
	int			i;
	budMD5Anim**	animptr;
	budMD5Anim*	anim;
...
/*
================
budAnimManager::FlushUnusedAnims
================
*/
void budAnimManager::FlushUnusedAnims()
{
	int						i;
	budMD5Anim**				animptr;
