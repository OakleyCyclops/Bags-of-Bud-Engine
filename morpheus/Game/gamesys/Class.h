...
class budAllocError : public idException
{
public:
	budAllocError( const char* text = "" ) : idException( text ) {}
};
...
================
*/
BUD_INLINE bool idTypeInfo::IsType( const idTypeInfo& type ) const
{
...
================
*/
BUD_INLINE bool idTypeInfo::RespondsTo( const idEventDef& ev ) const
{
...
================
*/
BUD_INLINE bool idClass::IsType( const idTypeInfo& superclass ) const
{
	idTypeInfo* subclass;
...
================
*/
BUD_INLINE bool idClass::RespondsTo( const idEventDef& ev ) const
{
	const idTypeInfo* c;
