...
================
*/
BUD_INLINE byte* idEvent::GetData()
{
	return data;
}
...
================
*/
BUD_INLINE const char* idEventDef::GetName() const
{
	return name;
}
...
================
*/
BUD_INLINE const char* idEventDef::GetArgFormat() const
{
	return formatspec;
}
...
================
*/
BUD_INLINE unsigned int idEventDef::GetFormatspecIndex() const
{
...
================
*/
BUD_INLINE char idEventDef::GetReturnType() const
{
	return returnType;
}
...
================
*/
BUD_INLINE int idEventDef::GetNumArgs() const
{
	return numargs;
}
...
================
*/
BUD_INLINE size_t idEventDef::GetArgSize() const
{
	return argsize;
}
...
================
*/
BUD_INLINE int idEventDef::GetArgOffset( int arg ) const
{
...
================
*/
BUD_INLINE int idEventDef::GetEventNum() const
{
	return eventnum;
}
