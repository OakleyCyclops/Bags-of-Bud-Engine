...
/*
============
budAASLocal::CalculateAreaTravelTimes
============
*/
void budAASLocal::CalculateAreaTravelTimes()
{
...
/*
============
budAASLocal::DeleteAreaTravelTimes
============
*/
void budAASLocal::DeleteAreaTravelTimes()
{
...
/*
============
budAASLocal::SetupRoutingCache
============
*/
void budAASLocal::SetupRoutingCache()
{
	int i;
	byte* bytePtr;
...
/*
============
budAASLocal::DeleteClusterCache
============
*/
void budAASLocal::DeleteClusterCache( int clusterNum )
{
	int i;
...
/*
============
budAASLocal::DeletePortalCache
============
*/
void budAASLocal::DeletePortalCache()
{
	int i;
	idRoutingCache* cache;
...
/*
============
budAASLocal::ShutdownRoutingCache
============
*/
void budAASLocal::ShutdownRoutingCache()
{
	int i;
...
/*
============
budAASLocal::SetupRouting
============
*/
bool budAASLocal::SetupRouting()
{
...
/*
============
budAASLocal::ShutdownRouting
============
*/
void budAASLocal::ShutdownRouting()
{
...
/*
============
budAASLocal::RoutingStats
============
*/
void budAASLocal::RoutingStats() const
{
	idRoutingCache* cache;
...
/*
============
budAASLocal::RemoveRoutingCacheUsingArea
============
*/
void budAASLocal::RemoveRoutingCacheUsingArea( int areaNum )
{
	int clusterNum;
...
/*
============
budAASLocal::DisableArea
============
*/
void budAASLocal::DisableArea( int areaNum )
{
...
/*
============
budAASLocal::EnableArea
============
*/
void budAASLocal::EnableArea( int areaNum )
{
	assert( areaNum > 0 && areaNum < file->GetNumAreas() );
...
/*
============
budAASLocal::SetAreaState_r
============
*/
bool budAASLocal::SetAreaState_r( int nodeNum, const budBounds& bounds, const int areaContents, bool disabled )
{
	int res;
...
/*
============
budAASLocal::SetAreaState
============
*/
bool budAASLocal::SetAreaState( const budBounds& bounds, const int areaContents, bool disabled )
{
	budBounds expBounds;
...
/*
============
budAASLocal::SetObstacleState
============
*/
void budAASLocal::SetObstacleState( const idRoutingObstacle* obstacle, bool enable )
{
	int i;
...
/*
============
budAASLocal::AddObstacle
============
*/
aasHandle_t budAASLocal::AddObstacle( const budBounds& bounds )
{
...
/*
============
budAASLocal::RemoveObstacle
============
*/
void budAASLocal::RemoveObstacle( const aasHandle_t handle )
{
	if( !file )
	{
		return;
...
/*
============
budAASLocal::RemoveAllObstacles
============
*/
void budAASLocal::RemoveAllObstacles()
{
	int i;
...
/*
============
budAASLocal::LinkCache

  link the cache in the cache list sorted from oldest to newest cache
============
*/
void budAASLocal::LinkCache( idRoutingCache* cache ) const
{
...
/*
============
budAASLocal::UnlinkCache
============
*/
void budAASLocal::UnlinkCache( idRoutingCache* cache ) const
{
...
/*
============
budAASLocal::DeleteOldestCache
============
*/
void budAASLocal::DeleteOldestCache() const
{
	idRoutingCache* cache;
...
/*
============
budAASLocal::GetAreaReachability
============
*/
idReachability* budAASLocal::GetAreaReachability( int areaNum, int reachabilityNum ) const
{
...
/*
============
budAASLocal::ClusterAreaNum
============
*/
BUD_INLINE int budAASLocal::ClusterAreaNum( int clusterNum, int areaNum ) const
{
...
/*
============
budAASLocal::UpdateAreaRoutingCache
============
*/
void budAASLocal::UpdateAreaRoutingCache( idRoutingCache* areaCache ) const
{
...
/*
============
budAASLocal::GetAreaRoutingCache
============
*/
idRoutingCache* budAASLocal::GetAreaRoutingCache( int clusterNum, int areaNum, int travelFlags ) const
{
	int clusterAreaNum;
...
/*
============
budAASLocal::UpdatePortalRoutingCache
============
*/
void budAASLocal::UpdatePortalRoutingCache( idRoutingCache* portalCache ) const
{
...
/*
============
budAASLocal::GetPortalRoutingCache
============
*/
idRoutingCache* budAASLocal::GetPortalRoutingCache( int clusterNum, int areaNum, int travelFlags ) const
{
	idRoutingCache* cache;
