...
typedef struct pvsPortal_s
{
	...
	budBounds			bounds;		// winding bounds
	budPlane				plane;		// winding plane, normal points towards the area this portal leads to
...
typedef struct pvsArea_s
{
	...
	budBounds			bounds;		// bounds of the whole area
...
void idPVS::CreatePassages() const
{
	...
	budPlane passageBounds[MAX_PASSAGE_BOUNDS];
...
================
*/
int idPVS::GetPVSAreas( const budBounds& bounds, int* areas, int maxAreas ) const
{
...
================
*/
pvsHandle_t idPVS::SetupCurrentPVS( const budBounds& source, const pvsType_t type ) const
{
...
================
*/
bool idPVS::InCurrentPVS( const pvsHandle_t handle, const budBounds& target ) const
{
...
================
*/
void idPVS::DrawPVS( const budBounds& source, const pvsType_t type ) const
{
