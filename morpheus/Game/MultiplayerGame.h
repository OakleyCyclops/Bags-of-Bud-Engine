...
public:
	...
	void			ClientReadWarmupTime( const budBitMsg& msg );
	void			ClientReadMatchStartedTime( const budBitMsg& msg );
	void			ClientReadAchievementUnlock( const budBitMsg& msg );
...
BUD_INLINE idMultiplayerGame::gameState_t idMultiplayerGame::GetGameState() const
{
	return gameState;
}

BUD_INLINE bool idMultiplayerGame::IsPureReady() const
{
	return pureReady;
}

BUD_INLINE void idMultiplayerGame::ClearFrags( int clientNum )
{
