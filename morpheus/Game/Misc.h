...
class budActivator : public idEntity
{
public:
	CLASS_PROTOTYPE( budActivator );
...
class budAnimated : public budAFEntity_Gibbable
{
public:
	CLASS_PROTOTYPE( budAnimated );
