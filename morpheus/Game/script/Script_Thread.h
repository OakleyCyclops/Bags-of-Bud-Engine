...
================
*/
BUD_INLINE idThread* idThread::WaitingOnThread()
{
...
================
*/
BUD_INLINE void idThread::SetThreadNum( int num )
{
	threadNum = num;
}
...
================
*/
BUD_INLINE int idThread::GetThreadNum()
{
	return threadNum;
}
...
================
*/
BUD_INLINE const char* idThread::GetThreadName()
{
...
================
*/
BUD_INLINE bool idThread::IsDoneProcessing()
{
...
================
*/
BUD_INLINE bool idThread::IsDying()
{
	return interpreter.threadDying;
}
