...
template<class type, etype_t etype, class returnType>
BUD_INLINE idScriptVariable<type, etype, returnType>::idScriptVariable()
{
	data = NULL;
}

template<class type, etype_t etype, class returnType>
BUD_INLINE bool idScriptVariable<type, etype, returnType>::IsLinked() const
{
	return ( data != NULL );
}

template<class type, etype_t etype, class returnType>
BUD_INLINE void idScriptVariable<type, etype, returnType>::Unlink()
{
	data = NULL;
}

template<class type, etype_t etype, class returnType>
BUD_INLINE void idScriptVariable<type, etype, returnType>::LinkTo( idScriptObject& obj, const char* name )
{
...
template<class type, etype_t etype, class returnType>
BUD_INLINE idScriptVariable<type, etype, returnType>& idScriptVariable<type, etype, returnType>::operator=( const returnType& value )
{
...
template<class type, etype_t etype, class returnType>
BUD_INLINE idScriptVariable<type, etype, returnType>::operator returnType() const
{
	// check if we attempt to access the object before it's been linked
	assert( data );
...
public:
	...
	void					PrintInfo( budFile* file, int instructionPointer ) const;
...
public:
	...
	void										DisassembleStatement( budFile* file, int instructionPointer ) const;
...
================
*/
BUD_INLINE statement_t& idProgram::GetStatement( int index )
{
...
================
*/
BUD_INLINE function_t* idProgram::GetFunction( int index )
{
...
================
*/
BUD_INLINE int idProgram::GetFunctionIndex( const function_t* func )
{
...
================
*/
BUD_INLINE int idProgram::GetReturnedInteger()
{
...
================
*/
BUD_INLINE void idProgram::ReturnFloat( float value )
{
...
================
*/
BUD_INLINE void idProgram::ReturnInteger( int value )
{
...
================
*/
BUD_INLINE const char* idProgram::GetFilename( int num )
{
	return fileList[ num ];
}
...
================
*/
BUD_INLINE int idProgram::GetLineNumberForStatement( int index )
{
...
================
*/
BUD_INLINE const char* idProgram::GetFilenameForStatement( int index )
{
