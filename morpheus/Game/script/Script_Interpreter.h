...
====================
*/
BUD_INLINE void idInterpreter::PopParms( int numParms )
{
...
*/
// RB: 64 bit fix, changed int to intptr_t
BUD_INLINE void idInterpreter::Push( intptr_t value )
{
...
====================
*/
BUD_INLINE void idInterpreter::PushString( const char* string )
{
...
====================
*/
BUD_INLINE const char* idInterpreter::FloatToString( float value )
{
	static char	text[ 32 ];
...
====================
*/
BUD_INLINE void idInterpreter::AppendString( idVarDef* def, const char* from )
{
...
====================
*/
BUD_INLINE void idInterpreter::SetString( idVarDef* def, const char* from )
{
	if( def->initialized == idVarDef::stackVariable )
	{
...
====================
*/
BUD_INLINE const char* idInterpreter::GetString( idVarDef* def )
{
	if( def->initialized == idVarDef::stackVariable )
	{
...
====================
*/
BUD_INLINE varEval_t idInterpreter::GetVariable( idVarDef* def )
{
	if( def->initialized == idVarDef::stackVariable )
	{
		varEval_t val;
...
====================
*/
BUD_INLINE void idInterpreter::NextInstruction( int position )
{
