...
============
*/
BUD_INLINE idVarDef* idCompiler::VirtualFunctionConstant( idVarDef* func )
{
	eval_t eval;
...
============
*/
BUD_INLINE idVarDef* idCompiler::SizeConstant( int size )
{
	eval_t eval;
...
============
*/
BUD_INLINE idVarDef* idCompiler::JumpConstant( int value )
{
	eval_t eval;
...
============
*/
BUD_INLINE idVarDef* idCompiler::JumpDef( int jumpfrom, int jumpto )
{
...
============
*/
BUD_INLINE idVarDef* idCompiler::JumpTo( int jumpto )
{
...
============
*/
BUD_INLINE idVarDef* idCompiler::JumpFrom( int jumpfrom )
{
...
============
*/
BUD_INLINE float idCompiler::Divide( float numerator, float denominator )
{
	if( denominator == 0 )
	{
...
============
*/
BUD_INLINE idVarDef* idCompiler::EmitOpcode( int op, idVarDef* var_a, idVarDef* var_b )
{
...
void idCompiler::NextToken()
{
	...
	switch( token.type )
	{
		...
		case TT_LITERAL:
		{
			...
			budLexer lex( token, token.Length(), parserPtr->GetFileName(), LEXFL_NOERRORS );
			budToken token2;
			for( i = 0; i < 3; i++ )
			{
