...
CLASS_DECLARATION( budAnimatedEntity, budAFAttachment )
END_CLASS

/*
=====================
budAFAttachment::budAFAttachment
=====================
*/
budAFAttachment::budAFAttachment()
{
...
/*
=====================
budAFAttachment::Spawn
=====================
*/
void budAFAttachment::Spawn()
{
...
/*
=====================
budAFAttachment::SetBody
=====================
*/
void budAFAttachment::SetBody( idEntity* bodyEnt, const char* model, jointHandle_t attachJoint )
{
	bool bleed;
...
/*
=====================
budAFAttachment::ClearBody
=====================
*/
void budAFAttachment::ClearBody()
{
	body = NULL;
	attachJoint = INVALID_JOINT;
	Hide();
...
/*
=====================
budAFAttachment::GetBody
=====================
*/
idEntity* budAFAttachment::GetBody() const
{
	return body;
}
...
/*
================
budAFAttachment::Save

archive object for savegame file
================
*/
void budAFAttachment::Save( idSaveGame* savefile ) const
{
...
/*
================
budAFAttachment::Restore

unarchives object from save game file
================
*/
void budAFAttachment::Restore( idRestoreGame* savefile )
{
...
/*
================
budAFAttachment::Hide
================
*/
void budAFAttachment::Hide()
{
	idEntity::Hide();
	UnlinkCombat();
}
...
/*
================
budAFAttachment::Show
================
*/
void budAFAttachment::Show()
{
	idEntity::Show();
	LinkCombat();
}
...
/*
================
budAFAttachment::PlayIdleAnim
================
*/
void budAFAttachment::PlayIdleAnim( int blendTime )
{
...
/*
================
budAfAttachment::Think
================
*/
void budAFAttachment::Think()
{
	budAnimatedEntity::Think();
...
/*
================
budAFAttachment::SetCombatModel
================
*/
void budAFAttachment::SetCombatModel()
{
	if( combatModel )
	{
		combatModel->Unlink();
	...
	{
		combatModel = new( TAG_PHYSICS_CLIP_AF ) budClipModel( modelDefHandle );
	}
...
/*
================
budAFAttachment::GetCombatModel
================
*/
budClipModel* budAFAttachment::GetCombatModel() const
{
	return combatModel;
}
...
/*
================
budAFAttachment::LinkCombat
================
*/
void budAFAttachment::LinkCombat()
{
	if( fl.hidden )
	{
		return;
...
/*
================
budAFAttachment::UnlinkCombat
================
*/
void budAFAttachment::UnlinkCombat()
{
	if( combatModel )
	{
		combatModel->Unlink();
...
CLASS_DECLARATION( budAnimatedEntity, budAFEntity_Base )
EVENT( EV_SetConstraintPosition,	budAFEntity_Base::Event_SetConstraintPosition )
END_CLASS
...
/*
================
budAFEntity_Base::budAFEntity_Base
================
*/
budAFEntity_Base::budAFEntity_Base()
{
...
/*
================
budAFEntity_Base::Save
================
*/
void budAFEntity_Base::Save( idSaveGame* savefile ) const
{
...
/*
================
budAFEntity_Base::Restore
================
*/
void budAFEntity_Base::Restore( idRestoreGame* savefile )
{
...
/*
================
budAFEntity_Base::Spawn
================
*/
void budAFEntity_Base::Spawn()
{
...
bool budAFEntity_Base::LoadAF()
{
	...
	{
		gameLocal.Error( "budAFEntity_Base::LoadAF: Couldn't load af file '%s' on entity '%s'", fileName.c_str(), name.c_str() );
	}
...
/*
================
budAFEntity_Base::Think
================
*/
void budAFEntity_Base::Think()
{
	RunPhysics();
	UpdateAnimation();
	if( thinkFlags & TH_UPDATEVISUALS )
...
/*
================
budAFEntity_Base::BodyForClipModelId
================
*/
int budAFEntity_Base::BodyForClipModelId( int id ) const
{
...
/*
================
budAFEntity_Base::AddBindConstraints
================
*/
void budAFEntity_Base::AddBindConstraints()
{
...
/*
================
budAFEntity_Base::RemoveBindConstraints
================
*/
void budAFEntity_Base::RemoveBindConstraints()
{
...
/*
================
budAFEntity_Base::UpdateAnimationControllers
================
*/
bool budAFEntity_Base::UpdateAnimationControllers()
{
	if( af.IsActive() )
	{
...
/*
================
budAFEntity_Base::SetCombatModel
================
*/
void budAFEntity_Base::SetCombatModel()
{
	if( combatModel )
	{
		combatModel->Unlink();
...
/*
================
budAFEntity_Base::GetCombatModel
================
*/
budClipModel* budAFEntity_Base::GetCombatModel() const
{
	return combatModel;
}
...
/*
================
budAFEntity_Base::SetCombatContents
================
*/
void budAFEntity_Base::SetCombatContents( bool enable )
{
	assert( combatModel );
...
/*
================
budAFEntity_Base::LinkCombat
================
*/
void budAFEntity_Base::LinkCombat()
{
	if( fl.hidden )
	{
		return;
...
/*
================
budAFEntity_Base::UnlinkCombat
================
*/
void budAFEntity_Base::UnlinkCombat()
{
	if( combatModel )
	{
		combatModel->Unlink();
...
================
*/
void budAFEntity_Base::FreeModelDef()
{
	UnlinkCombat();
...
/*
===============
budAFEntity_Base::ShowEditingDialog
===============
*/
void budAFEntity_Base::ShowEditingDialog()
{
}

/*
================
budAFEntity_Base::DropAFs
...
void budAFEntity_Base::DropAFs( idEntity* ent, const char* type, List<idEntity*>* list )
{
	...
	while( kv )
	{
		...
		if( newEnt && newEnt->IsType( budAFEntity_Base::Type ) )
		{
			af = static_cast<budAFEntity_Base*>( newEnt );
...
CLASS_DECLARATION( budAFEntity_Base, budAFEntity_Gibbable )
EVENT( EV_Gib,		budAFEntity_Gibbable::Event_Gib )
EVENT( EV_Gibbed,	budAFEntity_Base::Event_Remove )
END_CLASS


/*
================
budAFEntity_Gibbable::budAFEntity_Gibbable
================
*/
budAFEntity_Gibbable::budAFEntity_Gibbable()
{
...
/*
================
budAFEntity_Gibbable::Save
================
*/
void budAFEntity_Gibbable::Save( idSaveGame* savefile ) const
{
...
/*
================
budAFEntity_Gibbable::Restore
================
*/
void budAFEntity_Gibbable::Restore( idRestoreGame* savefile )
{
	bool hasCombatModel;
...
/*
================
budAFEntity_Gibbable::Spawn
================
*/
void budAFEntity_Gibbable::Spawn()
{
	InitSkeletonModel();
...
/*
================
budAFEntity_Gibbable::InitSkeletonModel
================
*/
void budAFEntity_Gibbable::InitSkeletonModel()
{
...
/*
================
budAFEntity_Gibbable::Present
================
*/
void budAFEntity_Gibbable::Present()
{
...
void budAFEntity_Gibbable::Damage( idEntity* inflictor, idEntity* attacker, const Vector3& dir, const char* damageDefName, const float damageScale, const int location )
{
	...
	budAFEntity_Base::Damage( inflictor, attacker, dir, damageDefName, damageScale, location );
...
/*
=====================
budAFEntity_Gibbable::SetThrown
=====================
*/
void budAFEntity_Gibbable::SetThrown( bool isThrown )
{
...
bool budAFEntity_Gibbable::Collide( const trace_t& collision, const Vector3& velocity )
{
	...
	return budAFEntity_Base::Collide( collision, velocity );
}
...
void budAFEntity_Gibbable::SpawnGibs( const Vector3& dir, const char* damageDefName )
{
	...
	budAFEntity_Base::DropAFs( this, "gib", &list );
...
/*
============
budAFEntity_Gibbable::Event_Gib
============
*/
...
CLASS_DECLARATION( budAFEntity_Gibbable, budAFEntity_Generic )
EVENT( EV_Activate,			budAFEntity_Generic::Event_Activate )
END_CLASS

/*
================
budAFEntity_Generic::budAFEntity_Generic
================
*/
budAFEntity_Generic::budAFEntity_Generic()
{
...
/*
================
budAFEntity_Generic::Save
================
*/
void budAFEntity_Generic::Save( idSaveGame* savefile ) const
{
...
/*
================
budAFEntity_Generic::Restore
================
*/
void budAFEntity_Generic::Restore( idRestoreGame* savefile )
{
...
/*
================
budAFEntity_Generic::Think
================
*/
void budAFEntity_Generic::Think()
{
	budAFEntity_Base::Think();
...
/*
================
budAFEntity_Generic::Spawn
================
*/
void budAFEntity_Generic::Spawn()
{
	if( !LoadAF() )
	{
...
/*
================
budAFEntity_Generic::Event_Activate
================
*/
...
CLASS_DECLARATION( budAFEntity_Gibbable, budAFEntity_WithAttachedHead )
EVENT( EV_Gib,				budAFEntity_WithAttachedHead::Event_Gib )
EVENT( EV_Activate,			budAFEntity_WithAttachedHead::Event_Activate )
END_CLASS

/*
================
budAFEntity_WithAttachedHead::budAFEntity_WithAttachedHead
================
*/
budAFEntity_WithAttachedHead::budAFEntity_WithAttachedHead()
{
...
/*
================
budAFEntity_WithAttachedHead::Spawn
================
*/
void budAFEntity_WithAttachedHead::Spawn()
{
	SetupHead();
...
/*
================
budAFEntity_WithAttachedHead::Save
================
*/
void budAFEntity_WithAttachedHead::Save( idSaveGame* savefile ) const
{
	head.Save( savefile );
}
...
/*
================
budAFEntity_WithAttachedHead::Restore
================
*/
void budAFEntity_WithAttachedHead::Restore( idRestoreGame* savefile )
{
...
/*
================
budAFEntity_WithAttachedHead::SetupHead
================
*/
void budAFEntity_WithAttachedHead::SetupHead()
{
	...
	if( headModel[ 0 ] )
	{
		...
		headEnt = static_cast<budAFAttachment*>( gameLocal.SpawnEntityType( budAFAttachment::Type, NULL ) );
...
/*
================
budAFEntity_WithAttachedHead::Think
================
*/
void budAFEntity_WithAttachedHead::Think()
{
	budAFEntity_Base::Think();
}
...
/*
================
budAFEntity_WithAttachedHead::LinkCombat
================
*/
void budAFEntity_WithAttachedHead::LinkCombat()
{
	budAFAttachment* headEnt;
...
/*
================
budAFEntity_WithAttachedHead::UnlinkCombat
================
*/
void budAFEntity_WithAttachedHead::UnlinkCombat()
{
	budAFAttachment* headEnt;
...
/*
================
budAFEntity_WithAttachedHead::Hide
================
*/
void budAFEntity_WithAttachedHead::Hide()
{
...
/*
================
budAFEntity_WithAttachedHead::Show
================
*/
void budAFEntity_WithAttachedHead::Show()
{
...
/*
============
budAFEntity_WithAttachedHead::Event_Gib
============
*/
...
/*
================
budAFEntity_WithAttachedHead::Event_Activate
================
*/
...
CLASS_DECLARATION( budAFEntity_Base, budAFEntity_Vehicle )
END_CLASS

/*
================
budAFEntity_Vehicle::budAFEntity_Vehicle
================
*/
budAFEntity_Vehicle::budAFEntity_Vehicle()
{
...
/*
================
budAFEntity_Vehicle::Spawn
================
*/
void budAFEntity_Vehicle::Spawn()
{
	...
	if( !eyesJointName[0] )
	{
		gameLocal.Error( "budAFEntity_Vehicle '%s' no eyes joint specified", name.c_str() );
	}
	eyesJoint = animator.GetJointHandle( eyesJointName );
	if( !steeringWheelJointName[0] )
	{
		gameLocal.Error( "budAFEntity_Vehicle '%s' no steering wheel joint specified", name.c_str() );
	}
	...
	if( *smokeName != '\0' )
	{
		dustSmoke = static_cast<const budDeclParticle*>( declManager->FindType( DECL_PARTICLE, smokeName ) );
	}
}
...
/*
================
budAFEntity_Vehicle::GetSteerAngle
================
*/
float budAFEntity_Vehicle::GetSteerAngle()
{
...
CLASS_DECLARATION( budAFEntity_Vehicle, budAFEntity_VehicleSimple )
END_CLASS

/*
================
budAFEntity_VehicleSimple::budAFEntity_VehicleSimple
================
*/
budAFEntity_VehicleSimple::budAFEntity_VehicleSimple()
{
...
/*
================
budAFEntity_VehicleSimple::Spawn
================
*/
void budAFEntity_VehicleSimple::Spawn()
{
	...
	for( i = 0; i < 4; i++ )
	{
		...
		if( !wheelJointName[0] )
		{
			gameLocal.Error( "budAFEntity_VehicleSimple '%s' no '%s' specified", name.c_str(), wheelJointKeys[i] );
		}
		wheelJoints[i] = animator.GetJointHandle( wheelJointName );
		if( wheelJoints[i] == INVALID_JOINT )
		{
			gameLocal.Error( "budAFEntity_VehicleSimple '%s' can't find wheel joint '%s'", name.c_str(), wheelJointName );
		}
		
		GetAnimator()->GetJointTransform( wheelJoints[i], 0, origin, axis );
		origin = renderEntity.origin + origin * renderEntity.axis;
		
		suspension[i] = new( TAG_PHYSICS_AF ) budAFConstraint_Suspension();
...
/*
================
budAFEntity_VehicleSimple::Think
================
*/
void budAFEntity_VehicleSimple::Think()
{
	int i;
	...
	if( thinkFlags & TH_THINK )
	{
		...
		for( i = 0; i < 4; i++ )
		{
			budAFBody* body = af.GetPhysics()->GetBody( 0 );
		...
		/*
				...
				if ( force != 0.0f && !( gameLocal.framenum & 7 ) ) {
					int numContacts;
					budAFConstraint_Contact *contacts[2];
					for ( i = 0; i < 4; i++ ) {
...
CLASS_DECLARATION( budAFEntity_Vehicle, budAFEntity_VehicleFourWheels )
END_CLASS


/*
================
budAFEntity_VehicleFourWheels::budAFEntity_VehicleFourWheels
================
*/
budAFEntity_VehicleFourWheels::budAFEntity_VehicleFourWheels()
{
...
/*
================
budAFEntity_VehicleFourWheels::Spawn
================
*/
void budAFEntity_VehicleFourWheels::Spawn()
{
	int i;
	...
	for( i = 0; i < 4; i++ )
	{
		...
		if( !wheelBodyName[0] )
		{
			gameLocal.Error( "budAFEntity_VehicleFourWheels '%s' no '%s' specified", name.c_str(), wheelBodyKeys[i] );
		}
		wheels[i] = af.GetPhysics()->GetBody( wheelBodyName );
		if( !wheels[i] )
		{
			gameLocal.Error( "budAFEntity_VehicleFourWheels '%s' can't find wheel body '%s'", name.c_str(), wheelBodyName );
		}
		wheelJointName = spawnArgs.GetString( wheelJointKeys[i], "" );
		if( !wheelJointName[0] )
		{
			gameLocal.Error( "budAFEntity_VehicleFourWheels '%s' no '%s' specified", name.c_str(), wheelJointKeys[i] );
		}
		wheelJoints[i] = animator.GetJointHandle( wheelJointName );
		if( wheelJoints[i] == INVALID_JOINT )
		{
			gameLocal.Error( "budAFEntity_VehicleFourWheels '%s' can't find wheel joint '%s'", name.c_str(), wheelJointName );
		}
	}
	...
	for( i = 0; i < 2; i++ )
	{
		...
		{
			gameLocal.Error( "budAFEntity_VehicleFourWheels '%s' no '%s' specified", name.c_str(), steeringHingeKeys[i] );
		}
		steering[i] = static_cast<budAFConstraint_Hinge*>( af.GetPhysics()->GetConstraint( steeringHingeName ) );
		if( !steering[i] )
		{
			gameLocal.Error( "budAFEntity_VehicleFourWheels '%s': can't find steering hinge '%s'", name.c_str(), steeringHingeName );
		}
	}
...
/*
================
budAFEntity_VehicleFourWheels::Think
================
*/
void budAFEntity_VehicleFourWheels::Think()
{
	int i;
	float force = 0.0f, velocity = 0.0f, steerAngle = 0.0f;
	Vector3 origin;
...
CLASS_DECLARATION( budAFEntity_Vehicle, budAFEntity_VehicleSixWheels )
END_CLASS

/*
================
budAFEntity_VehicleSixWheels::budAFEntity_VehicleSixWheels
================
*/
budAFEntity_VehicleSixWheels::budAFEntity_VehicleSixWheels()
{
...
/*
================
budAFEntity_VehicleSixWheels::Spawn
================
*/
void budAFEntity_VehicleSixWheels::Spawn()
{
	int i;
	static const char* wheelBodyKeys[] =
	{
	...
	for( i = 0; i < 6; i++ )
	{
		...
		if( !wheelBodyName[0] )
		{
			gameLocal.Error( "budAFEntity_VehicleSixWheels '%s' no '%s' specified", name.c_str(), wheelBodyKeys[i] );
		}
		wheels[i] = af.GetPhysics()->GetBody( wheelBodyName );
		if( !wheels[i] )
		{
			gameLocal.Error( "budAFEntity_VehicleSixWheels '%s' can't find wheel body '%s'", name.c_str(), wheelBodyName );
		}
		wheelJointName = spawnArgs.GetString( wheelJointKeys[i], "" );
		if( !wheelJointName[0] )
		{
			gameLocal.Error( "budAFEntity_VehicleSixWheels '%s' no '%s' specified", name.c_str(), wheelJointKeys[i] );
		}
		wheelJoints[i] = animator.GetJointHandle( wheelJointName );
		if( wheelJoints[i] == INVALID_JOINT )
		{
			gameLocal.Error( "budAFEntity_VehicleSixWheels '%s' can't find wheel joint '%s'", name.c_str(), wheelJointName );
		}
	}
	...
	for( i = 0; i < 4; i++ )
	{
		...
		if( !steeringHingeName[0] )
		{
			gameLocal.Error( "budAFEntity_VehicleSixWheels '%s' no '%s' specified", name.c_str(), steeringHingeKeys[i] );
		}
		steering[i] = static_cast<budAFConstraint_Hinge*>( af.GetPhysics()->GetConstraint( steeringHingeName ) );
		if( !steering[i] )
		{
			gameLocal.Error( "budAFEntity_VehicleSixWheels '%s': can't find steering hinge '%s'", name.c_str(), steeringHingeName );
		}
	}
...
/*
================
budAFEntity_VehicleSixWheels::Think
================
*/
...
CLASS_DECLARATION( budAFEntity_VehicleSixWheels, budAFEntity_VehicleAutomated )
EVENT( EV_PostSpawn,				budAFEntity_VehicleAutomated::PostSpawn )
EVENT( EV_Vehicle_setVelocity,		budAFEntity_VehicleAutomated::Event_SetVelocity )
EVENT( EV_Vehicle_setTorque,		budAFEntity_VehicleAutomated::Event_SetTorque )
EVENT( EV_Vehicle_setSteeringSpeed,	budAFEntity_VehicleAutomated::Event_SetSteeringSpeed )
EVENT( EV_Vehicle_setWaypoint,		budAFEntity_VehicleAutomated::Event_SetWayPoint )
END_CLASS

/*
================
budAFEntity_VehicleAutomated::Spawn
================
*/
void budAFEntity_VehicleAutomated::Spawn()
{
...
/*
================
budAFEntity_VehicleAutomated::PostSpawn
================
*/
void budAFEntity_VehicleAutomated::PostSpawn()
{
...
/*
================
budAFEntity_VehicleAutomated::Event_SetVelocity
================
*/
void budAFEntity_VehicleAutomated::Event_SetVelocity( float _velocity )
{
	velocity = _velocity;
}
...
/*
================
budAFEntity_VehicleAutomated::Event_SetTorque
================
*/
void budAFEntity_VehicleAutomated::Event_SetTorque( float _torque )
{
	force = _torque;
}
...
/*
================
budAFEntity_VehicleAutomated::Event_SetSteeringSpeed
================
*/
void budAFEntity_VehicleAutomated::Event_SetSteeringSpeed( float _steeringSpeed )
{
...
/*
================
budAFEntity_VehicleAutomated::Event_SetWayPoint
================
*/
void budAFEntity_VehicleAutomated::Event_SetWayPoint( idEntity* _waypoint )
{
	waypoint = _waypoint;
}
...
/*
================
budAFEntity_VehicleAutomated::Think
================
*/
#define	HIT_WAYPOINT_THRESHOLD	80.f

void budAFEntity_VehicleAutomated::Think()
{
...
CLASS_DECLARATION( budAFEntity_Base, budAFEntity_SteamPipe )
END_CLASS


/*
================
budAFEntity_SteamPipe::budAFEntity_SteamPipe
================
*/
budAFEntity_SteamPipe::budAFEntity_SteamPipe()
{
...
/*
================
budAFEntity_SteamPipe::Save
================
*/
void budAFEntity_SteamPipe::Save( idSaveGame* savefile ) const
{
}

/*
================
budAFEntity_SteamPipe::Restore
================
*/
void budAFEntity_SteamPipe::Restore( idRestoreGame* savefile )
{
	Spawn();
}
...
/*
================
budAFEntity_SteamPipe::InitSteamRenderEntity
================
*/
void budAFEntity_SteamPipe::InitSteamRenderEntity()
{
	const char*	temp;
	const budDeclModelDef* modelDef;
	...
	if( *temp != '\0' )
	{
		if( !strstr( temp, "." ) )
		{
			modelDef = static_cast<const budDeclModelDef*>( declManager->FindType( DECL_MODELDEF, temp, false ) );
			if( modelDef )
			{
...
CLASS_DECLARATION( budAFEntity_Base, budAFEntity_ClawFourFingers )
EVENT( EV_SetFingerAngle,		budAFEntity_ClawFourFingers::Event_SetFingerAngle )
EVENT( EV_StopFingers,			budAFEntity_ClawFourFingers::Event_StopFingers )
END_CLASS
...
/*
================
budAFEntity_ClawFourFingers::budAFEntity_ClawFourFingers
================
*/
budAFEntity_ClawFourFingers::budAFEntity_ClawFourFingers()
{
...
/*
================
budAFEntity_ClawFourFingers::Save
================
*/
void budAFEntity_ClawFourFingers::Save( idSaveGame* savefile ) const
{
	int i;
...
/*
================
budAFEntity_ClawFourFingers::Restore
================
*/
void budAFEntity_ClawFourFingers::Restore( idRestoreGame* savefile )
{
	int i;
	
	for( i = 0; i < 4; i++ )
	{
		fingers[i] = static_cast<budAFConstraint_Hinge*>( af.GetPhysics()->GetConstraint( clawConstraintNames[i] ) );
...
/*
================
budAFEntity_ClawFourFingers::Spawn
================
*/
void budAFEntity_ClawFourFingers::Spawn()
{
	int i;
...
/*
================
budAFEntity_ClawFourFingers::Event_SetFingerAngle
================
*/
void budAFEntity_ClawFourFingers::Event_SetFingerAngle( float angle )
{
	int i;
...
/*
================
budAFEntity_ClawFourFingers::Event_StopFingers
================
*/
void budAFEntity_ClawFourFingers::Event_StopFingers()
{
	int i;
...
bool budGameEdit::AF_SpawnEntity( const char* fileName )
{
	...
	af = static_cast<const budDeclAF*>( declManager->FindType( DECL_AF, fileName ) );
	if( !af )
	{
		return false;
	}
	...
	args.Set( "nodrop", "1" );
	ent = static_cast<budAFEntity_Generic*>( gameLocal.SpawnEntityType( budAFEntity_Generic::Type, &args ) );
...
/*
================
budGameEdit::AF_UpdateEntities
================
*/
void budGameEdit::AF_UpdateEntities( const char* fileName )
{
	idEntity* ent;
	budAFEntity_Base* af;
	String name;
	...
	// reload any budAFEntity_Generic which uses the given articulated figure file
...
/*
================
budGameEdit::AF_UndoChanges
================
*/
void budGameEdit::AF_UndoChanges()
{
	int i, c;
	idEntity* ent;
	budAFEntity_Base* af;
	...
	for( i = 0; i < c; i++ )
	{
		decl = static_cast<budDeclAF*>( const_cast<budDecl*>( declManager->DeclByIndex( DECL_AF, i, false ) ) );
		if( !decl->modified )
		{
			continue;
		}
...
budRenderModel* budGameEdit::AF_CreateMesh( const Dict& args, Vector3& meshOrigin, Matrix3& meshAxis, bool& poseIsSet )
{
	...
	const budDeclModelDef* modelDef = NULL;
	const budMD5Anim* MD5anim = NULL;
	const budMD5Joint* MD5joint = NULL;
	const budMD5Joint* MD5joints = NULL;
	int numMD5joints;
	budJointMat* originalJoints = NULL;
	int parentNum;
	...
	af = static_cast<const budDeclAF*>( declManager->FindType( DECL_AF, afName ) );
	if( !af )
	{
		return NULL;
	}
	...
	ent.joints = ( budJointMat* )_alloca16( ent.numJoints * sizeof( *ent.joints ) );
	...
	originalJoints = ( budJointMat* )_alloca16( numMD5joints * sizeof( originalJoints[0] ) );
...
void idHarvestable::Init( idEntity* parent )
{
	...
	idEntity* head = NULL;
	if( parent->IsType( budActor::Type ) )
	{
		budActor* withHead = ( budActor* )parent;
		head = withHead->GetHeadEntity();
	}
	if( parent->IsType( budAFEntity_WithAttachedHead::Type ) )
	{
		budAFEntity_WithAttachedHead* withHead = ( budAFEntity_WithAttachedHead* )parent;
...
/*
================
budAFEntity_Harvest::CalcTriggerBounds
================
*/
void idHarvestable::CalcTriggerBounds( float size, budBounds& bounds )
{
...
/*
================
budAFEntity_Harvest::Event_SpawnHarvestTrigger
================
*/
void idHarvestable::Event_SpawnHarvestTrigger()
{
	...
	trigger = new( TAG_PHYSICS_CLIP_AF ) budClipModel( budTraceModel( bounds ) );
...
/*
================
budAFEntity_Harvest::Event_Touch
================
*/
void idHarvestable::Event_Touch( idEntity* other, trace_t* trace )
{
	...
	if( parent->IsType( budAFEntity_Gibbable::Type ) )
	{
		budAFEntity_Gibbable* gibParent = ( budAFEntity_Gibbable* )parent;
...
CLASS_DECLARATION( budAFEntity_WithAttachedHead, budAFEntity_Harvest )
EVENT( EV_Harvest_SpawnHarvestEntity,	budAFEntity_Harvest::Event_SpawnHarvestEntity )
END_CLASS

/*
================
budAFEntity_Harvest::budAFEntity_Harvest
================
*/
budAFEntity_Harvest::budAFEntity_Harvest()
{
...
/*
================
budAFEntity_Harvest::Save
================
*/
void budAFEntity_Harvest::Save( idSaveGame* savefile ) const
{
...
/*
================
budAFEntity_Harvest::Restore
================
*/
void budAFEntity_Harvest::Restore( idRestoreGame* savefile )
{
...
/*
================
budAFEntity_Harvest::Spawn
================
*/
void budAFEntity_Harvest::Spawn()
{
...
/*
================
budAFEntity_Harvest::Think
================
*/
void budAFEntity_Harvest::Think()
{
...
void budAFEntity_Harvest::Gib( const Vector3& dir, const char* damageDefName )
{
	...
	budAFEntity_WithAttachedHead::Gib( dir, damageDefName );
}
