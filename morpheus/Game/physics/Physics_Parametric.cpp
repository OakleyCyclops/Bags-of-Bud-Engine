...
================
*/
void idPhysics_Parametric::SetClipModel( budClipModel* model, float density, int id, bool freeOld )
{
...
================
*/
budClipModel* idPhysics_Parametric::GetClipModel( int id ) const
{
	return clipModel;
}
...
================
*/
const budBounds& idPhysics_Parametric::GetBounds( int id ) const
{
	if( clipModel )
	{
...
================
*/
const budBounds& idPhysics_Parametric::GetAbsBounds( int id ) const
{
	if( clipModel )
	{
...
================
*/
void idPhysics_Parametric::ReadFromSnapshot( const budBitMsg& msg )
{
