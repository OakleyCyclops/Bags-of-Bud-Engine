...
================
*/
void idPhysics_Base::SetClipModel( budClipModel* model, float density, int id, bool freeOld )
{
}
...
================
*/
budClipModel* idPhysics_Base::GetClipModel( int id ) const
{
	return NULL;
}
...
================
*/
const budBounds& idPhysics_Base::GetBounds( int id ) const
{
	return bounds_zero;
}
...
================
*/
const budBounds& idPhysics_Base::GetAbsBounds( int id ) const
{
	return bounds_zero;
}
...
================
*/
int idPhysics_Base::ClipContents( const budClipModel* model ) const
{
	return 0;
}
...
================
*/
void idPhysics_Base::WriteToSnapshot( budBitMsg& msg ) const
{
}
...
================
*/
void idPhysics_Base::ReadFromSnapshot( const budBitMsg& msg )
{
}
