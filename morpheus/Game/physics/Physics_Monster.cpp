...
monsterMoveResult_t idPhysics_Monster::StepMove( Vector3& start, Vector3& velocity, const Vector3& delta )
{
	...
	if( blockingEntity && blockingEntity->IsType( budActor::Type ) )
	{
...
================
*/
void idPhysics_Monster::WriteToSnapshot( budBitMsg& msg ) const
{
...
================
*/
void idPhysics_Monster::ReadFromSnapshot( const budBitMsg& msg )
{
