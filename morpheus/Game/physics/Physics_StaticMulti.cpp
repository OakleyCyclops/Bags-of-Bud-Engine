...
================
*/
void idPhysics_StaticMulti::SetClipModel( budClipModel* model, float density, int id, bool freeOld )
{
	int i;
...
================
*/
budClipModel* idPhysics_StaticMulti::GetClipModel( int id ) const
{
...
================
*/
const budBounds& idPhysics_StaticMulti::GetBounds( int id ) const
{
	int i;
	static budBounds bounds;
...
================
*/
const budBounds& idPhysics_StaticMulti::GetAbsBounds( int id ) const
{
	int i;
...
================
*/
int idPhysics_StaticMulti::ClipContents( const budClipModel* model ) const
{
	int i, contents;
