...
================
*/
void idPhysics_Actor::SetClipModel( budClipModel* model, const float density, int id, bool freeOld )
{
	assert( self );
...
================
*/
budClipModel* idPhysics_Actor::GetClipModel( int id ) const
{
	return clipModel;
}
...
================
*/
const budBounds& idPhysics_Actor::GetBounds( int id ) const
{
...
================
*/
const budBounds& idPhysics_Actor::GetAbsBounds( int id ) const
{
...
================
*/
int idPhysics_Actor::ClipContents( const budClipModel* model ) const
{
	if( model )
	{
