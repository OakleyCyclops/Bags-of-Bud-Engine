...
static budTimer timer_total, timer_collision;
#endif
...
================
*/
budClipModel* idPhysics_RigidBody::GetClipModel( int id ) const
{
	return clipModel;
}
...
================
*/
const budBounds& idPhysics_RigidBody::GetBounds( int id ) const
{
...
================
*/
const budBounds& idPhysics_RigidBody::GetAbsBounds( int id ) const
{
...
================
*/
int idPhysics_RigidBody::ClipContents( const budClipModel* model ) const
{
	if( model )
	{
