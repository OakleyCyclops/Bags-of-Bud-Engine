...
budRenderModelManager* 		renderModelManager = NULL;
budUserInterfaceManager* 	uiManager = NULL;
...
budRenderWorld* 				gameRenderWorld = NULL;		// all drawing is done to this world
budSoundWorld* 				gameSoundWorld = NULL;		// all audio goes to this world

static gameExport_t			gameExport;

// global animation lib
budAnimManager				animationLib;

// the rest of the engine will only reference the "game" variable, while all local aspects stay hidden
budGameLocal					gameLocal;
budGame* 					game = &gameLocal;	// statically pointed at an budGameLocal

const char* budGameLocal::sufaceTypeNames[ MAX_SURFACE_TYPES ] =
{
...
void budGameLocal::Init()
{
	...
	declManager->RegisterDeclType( "model",				DECL_MODELDEF,		budDeclAllocator<budDeclModelDef> );
	declManager->RegisterDeclType( "export",			DECL_MODELEXPORT,	budDeclAllocator<budDecl> );
...
/*
===========
budGameLocal::Shutdown

  shut down the entire game
============
*/
void budGameLocal::Shutdown()
{
	...
	budAI::FreeObstacleAvoidanceNodes();
...
void budGameLocal::SaveGame( budFile* f, budFile* strings )
{
	...
	if( g_recordSaveGameTrace.GetBool() )
	{
		...
		if( !result )
		{
			//libBud::Printf( "BeginTraceRecording: error %d\n", GetLastError() );
		}
	}
	...
	for( i = 0; i < numClients; i++ )
	{
		...
		// Now that usercmds are handled by the budUserCmdMgr,
...
/*
===========
budGameLocal::GetSaveGameDetails
============
*/
void budGameLocal::GetSaveGameDetails( idSaveGameDetails& gameDetails )
{
...
============
*/
void budGameLocal::Printf( const char* fmt, ... ) const // DG: FIXME: printf-annotation
{
	va_list		argptr;
...
/*
============
budGameLocal::DPrintf
============
*/
void budGameLocal::DPrintf( const char* fmt, ... ) const
{
	va_list		argptr;
	char		text[MAX_STRING_CHARS];
...
/*
============
budGameLocal::Warning
============
*/
void budGameLocal::Warning( const char* fmt, ... ) const
{
	va_list		argptr;
	char		text[MAX_STRING_CHARS];
	idThread* 	thread;
...
/*
============
budGameLocal::DWarning
============
*/
void budGameLocal::DWarning( const char* fmt, ... ) const
{
	va_list		argptr;
	char		text[MAX_STRING_CHARS];
	idThread* 	thread;
...
============
*/
void budGameLocal::Error( const char* fmt, ... ) const
{
	va_list		argptr;
	char		text[MAX_STRING_CHARS];
	idThread* 	thread;
...
/*
========================
budGameLocal::SetServerGameTimeMs
========================
*/
void budGameLocal::SetServerGameTimeMs( const int time )
{
...
/*
========================
budGameLocal::GetServerGameTimeMs
========================
*/
int budGameLocal::GetServerGameTimeMs() const
{
	return serverTime;
}
...
/*
===================
budGameLocal::LocalMapRestart
===================
*/
void budGameLocal::LocalMapRestart( )
{
...
/*
===================
budGameLocal::MapRestart
===================
*/
void budGameLocal::MapRestart()
{
	if( common->IsClient() )
	{
		LocalMapRestart();
...
/*
===================
budGameLocal::MapPopulate
===================
*/
void budGameLocal::MapPopulate()
{
...
/*
=================
budGameLocal::InitFromSaveGame
=================
*/
bool budGameLocal::InitFromSaveGame( const char* mapName, budRenderWorld* renderWorld, budSoundWorld* soundWorld, budFile* saveGameFile, budFile* stringTableFile, int saveGameVersion )
{
	int i;
	int num;
	idEntity* ent;
	...
	budFile_SaveGamePipelined* pipelineFile = new( TAG_SAVEGAMES ) budFile_SaveGamePipelined();
	...
	// the localClientNum member of budGameLocal was removed,
	...
	if( num )
	{
		...
		{
			savegame.Error( "budGameLocal::InitFromSaveGame: number of areas in map differs from save game." );
		}
...
/*
===========
budGameLocal::MapClear
===========
*/
void budGameLocal::MapClear( bool clearClients )
{
	int i;
...
/*
===========
budGameLocal::MapShutdown
============
*/
void budGameLocal::MapShutdown()
{
	...
	clip.Shutdown();
	budClipModel::ClearTraceModelCache();
...
void budGameLocal::GetAimAssistAngles( Angles& angles )
{
	...
	budAimAssist* aimAssist = player->GetAimAssist();
	if( aimAssist == NULL )
	{
		return;
	}
...
/*
========================
budGameLocal::GetAimAssistSensitivity
========================
*/
...
/*
========================
budGameLocal::MapPeerToClient
========================
*/
int budGameLocal::MapPeerToClient( int peer ) const
{
	idLobbyBase& lobby = session->GetActingGameStateLobbyBase();
...
/*
========================
budGameLocal::GetLocalClientNum
========================
*/
int budGameLocal::GetLocalClientNum() const
{
...
/*
===================
budGameLocal::Preload

===================
*/
void budGameLocal::Preload( const idPreloadManifest& manifest )
{
...
/*
===================
budGameLocal::CacheDictionaryMedia
	...
	while( kv )
	{
		if( kv->GetValue().Length() )
		{
			...
			else
			{
				...
				budUserInterface* gui = uiManager->Alloc();
				if( gui )
				{
...
/*
===========
budGameLocal::InitScriptForMap
============
*/
void budGameLocal::InitScriptForMap()
{
...
/*
===================
budGameLocal::SetScriptFPS
===================
*/
void budGameLocal::SetScriptFPS( const float engineHz )
{
...
/*
===========
budGameLocal::GetMPPlayerDefName
============
*/
const char* budGameLocal::GetMPPlayerDefName() const
{
...
/*
================
budGameLocal::GetNextClientNum
================
*/
int budGameLocal::GetNextClientNum( int _current ) const
{
	int i, current;
...
/*
================
budGameLocal::SetupPlayerPVS
================
*/
void budGameLocal::SetupPlayerPVS()
{
	int			i;
	idEntity* 	ent;
	budPlayer* 	player;
...
/*
================
budGameLocal::FreePlayerPVS
================
*/
void budGameLocal::FreePlayerPVS()
{
	if( playerPVS.i != -1 )
	{
		pvs.FreeCurrentPVS( playerPVS );
...
/*
================
budGameLocal::InPlayerPVS

  should only be called during entity thinking and event handling
================
*/
bool budGameLocal::InPlayerPVS( idEntity* ent ) const
{
	if( playerPVS.i == -1 )
	{
		return false;
...
/*
================
budGameLocal::InPlayerConnectedArea

  should only be called during entity thinking and event handling
================
*/
bool budGameLocal::InPlayerConnectedArea( idEntity* ent ) const
{
	if( playerConnectedAreas.i == -1 )
	{
		return false;
...
/*
================
budGameLocal::UpdateGravity
================
*/
void budGameLocal::UpdateGravity()
{
	idEntity* ent;
	...
	if( g_gravity.IsModified() )
	{
		...
		for( ent = spawnedEntities.Next(); ent != NULL; ent = ent->spawnNode.Next() )
		{
			if( ent->IsType( budAFEntity_Generic::Type ) )
			{
...
/*
================
budGameLocal::SortActiveEntityList
...
================
*/
void budGameLocal::SortActiveEntityList()
{
...
/*
========================
budGameLocal::SetInterpolation
========================
*/
void budGameLocal::SetInterpolation( const float fraction, const int serverGameMS, const int ssStartTime, const int ssEndTime )
{
...
/*
================
budGameLocal::RunTimeGroup2
================
*/
void budGameLocal::RunTimeGroup2( budUserCmdMgr& userCmdMgr )
{
	idEntity* ent;
	int num = 0;
...
/*
================
budGameLocal::RunEntityThink
================
*/
void budGameLocal::RunEntityThink( idEntity& ent, budUserCmdMgr& userCmdMgr )
{
...
/*
================
budGameLocal::RunFrame
================
*/
void budGameLocal::RunFrame( budUserCmdMgr& cmdMgr, gameReturn_t& ret )
{
	idEntity* 	ent;
	int			num;
	float		ms;
...
/*
====================
budGameLocal::BuildReturnValue

Fills out gameReturn_t, called on server and clients.
====================
*/
void budGameLocal::BuildReturnValue( gameReturn_t& ret )
{
...
/*
====================
budGameLocal::RunSinglelUserCmd
...
/*
====================
budGameLocal::RunAllUserCmdsForPlayer
...
====================
*/
void budGameLocal::RunAllUserCmdsForPlayer( budUserCmdMgr& cmdMgr, const int playerNumber )
{
//libBud::Printf( "Frame: %i = [%i-%i] ", gameLocal.framenum,
//cmdMgr.readFrame[0], cmdMgr.writeFrame[0] );	// !@#
	...
	if( player.IsLocallyControlled() )
	{
		if( cmdMgr.HasUserCmdForPlayer( playerNumber ) )
		{
			...
			{
				libBud::Printf( "[%d]Running local cmd for player %d, %d buffered.\n",
	...
	if( cmdMgr.HasUserCmdForPlayer( player.GetEntityNumber() ) )
	{
		...
		if( timeDeltaBetweenClientCommands - timeSinceServerRanLastCommand <= 1 )
		{
			while( clientTimeRunSoFar < ( timeSinceServerRanLastCommand - 1 ) && cmdMgr.HasUserCmdForPlayer( player.GetEntityNumber() ) )
			{
				...
				if( net_usercmd_timing_debug.GetBool() )
				{
					libBud::Printf( "[%d]Running initial cmd for player %d, %d buffered, %d so far, %d serverDelta.\n",
								   common->GetGameFrame(), playerNumber, cmdMgr.GetNumUnreadFrames( playerNumber ),
		...
		else
		{
			...
			if( net_usercmd_timing_debug.GetBool() )
			{
				libBud::Printf( "[%d]Running duplicated command for player %d to prevent server from starving. clientCmdTimeDelta = %d, runCmdTimeDeltaOnServer = %d.\n",
	...
	else
	{
		...
		if( net_usercmd_timing_debug.GetBool() )
		{
			libBud::Printf( "[%d]Ran out of commands for player %d.\n", common->GetGameFrame(), playerNumber );
		}
	}
...
================
*/
bool budGameLocal::Draw( int clientNum )
{
	...
	if( common->IsMultiplayer() && session->GetState() == budSession::INGAME )
	{
...
/*
================
budGameLocal::HandleGuiCommands
================
*/
...
/*
================
budGameLocal::GetLevelMap

  should only be used for in-game level editing
================
*/
budMapFile* budGameLocal::GetLevelMap()
{
...
/*
================
budGameLocal::GetMapName
================
*/
const char* budGameLocal::GetMapName() const
{
...
/*
================
budGameLocal::CallFrameCommand
================
*/
void budGameLocal::CallFrameCommand( idEntity* ent, const function_t* frameCommand )
{
...
/*
================
budGameLocal::CallObjectFrameCommand
================
*/
void budGameLocal::CallObjectFrameCommand( idEntity* ent, const char* frameCommand )
{
...
void budGameLocal::RunDebugInfo()
{
	...
	if( g_showEntityInfo.GetBool() )
	{
		...
		for( ent = spawnedEntities.Next(); ent != NULL; ent = ent->spawnNode.Next() )
		{
			...
			const budBounds& entBounds = ent->GetPhysics()->GetAbsBounds();
	...
	if( g_showActiveEntities.GetBool() )
	{
		for( ent = activeEntities.Next(); ent != NULL; ent = ent->activeNode.Next() )
		{
			budBounds	b = ent->GetPhysics()->GetBounds();
			if( b.GetVolume() <= 0 )
			{
				b[0][0] = b[0][1] = b[0][2] = -8;
				b[1][0] = b[1][1] = b[1][2] = 8;
	...
	{
		budAAS* aas = GetAAS( aas_test.GetInteger() );
		if( aas )
		{
			aas->Test( origin );
			if( ai_testPredictPath.GetBool() )
			{
				...
				velocity.z = 0.0f;
				budAI::PredictPath( player, aas, origin, velocity, 1000, 100, SE_ENTER_OBSTACLE | SE_BLOCKED | SE_ENTER_LEDGE_AREA, path );
			}
		}
	}
	...
	if( ai_showObstacleAvoidance.GetInteger() == 2 )
	{
		...
		if( aas )
		{
			...
			budAI::FindPathAroundObstacles( player->GetPhysics(), aas, NULL, player->GetPhysics()->GetOrigin(), seekPos, path );
		}
	}
...
==================
*/
budAAS* budGameLocal::GetAAS( int num ) const
{
...
==================
*/
budAAS* budGameLocal::GetAAS( const char* name ) const
{
	int i;
...
/*
==================
budGameLocal::SetAASAreaState
==================
*/
void budGameLocal::SetAASAreaState( const budBounds& bounds, const int areaContents, bool closed )
{
	int i;
...
/*
==================
budGameLocal::AddAASObstacle
==================
*/
aasHandle_t budGameLocal::AddAASObstacle( const budBounds& bounds )
{
	int i;
...
/*
==================
budGameLocal::RemoveAASObstacle
==================
*/
void budGameLocal::RemoveAASObstacle( const aasHandle_t handle )
{
	int i;
...
/*
==================
budGameLocal::RemoveAllAASObstacles
==================
*/
void budGameLocal::RemoveAllAASObstacles()
{
	int i;
...
void budGameLocal::RegisterEntity( idEntity* ent, int forceSpawnId, const Dict& spawnArgsToCopy )
{
	...
	{
		Error( "budGameLocal::RegisterEntity: spawn count overflow" );
	}
...
/*
===================
budGameLocal::UnregisterEntity
===================
*/
void budGameLocal::UnregisterEntity( idEntity* ent )
{
	assert( ent );
	...
	{
		libBud::Error( "invalid entity number" );
		return;
	}
...
bool budGameLocal::SpawnEntityDef( const Dict& args, idEntity** ent, bool setDefaults )
{
	...
	const budDeclEntityDef* def = FindEntityDef( classname, false );
...
/*
================
budGameLocal::FindEntityDef
================
*/
const budDeclEntityDef* budGameLocal::FindEntityDef( const char* name, bool makeDefault ) const
{
	const budDecl* decl = NULL;
	if( common->IsMultiplayer() )
	{
	...
	return static_cast<const budDeclEntityDef*>( decl );
}
...
/*
==============
budGameLocal::SpawnMapEntities

Parses textual entity definitions out of an entstring and spawns gentities.
==============
*/
void budGameLocal::SpawnMapEntities()
{
	int			i;
	int			num;
	int			inhibit;
...
/*
================
budGameLocal::AddEntityToHash
================
*/
void budGameLocal::AddEntityToHash( const char* name, idEntity* ent )
{
	if( FindEntity( name ) )
	{
...
/*
================
budGameLocal::RemoveEntityFromHash
================
*/
bool budGameLocal::RemoveEntityFromHash( const char* name, idEntity* ent )
{
	int hash, i;
...
/*
=============
budGameLocal::GetTraceEntity

returns the master entity of a trace.  for example, if the trace entity is the player's head, it will return the player.
=============
*/
idEntity* budGameLocal::GetTraceEntity( const trace_t& trace ) const
{
	idEntity* master;
...
/*
=============
budGameLocal::ArgCompletion_EntityName
...
/*
=============
budGameLocal::FindEntity

Returns the entity whose name matches the specified string.
=============
*/
idEntity* budGameLocal::FindEntity( const char* name ) const
{
	int hash, i;
...
/*
=============
budGameLocal::FindEntityUsingDef
...
=============
*/
idEntity* budGameLocal::FindEntityUsingDef( idEntity* from, const char* match ) const
{
	idEntity*	ent;
...
=================
*/
void budGameLocal::KillBox( idEntity* ent, bool catch_teleport )
{
	int			i;
	int			num;
	idEntity* 	hit;
...
/*
============
budGameLocal::AlertAI
============
*/
void budGameLocal::AlertAI( idEntity* ent )
{
	if( ent && ent->IsType( budActor::Type ) )
	{
		// alert them for the next frame
		lastAIAlertTime = time + 1;
		lastAIAlertEntity = static_cast<budActor*>( ent );
	}
}

/*
============
budGameLocal::GetAlertEntity
============
*/
budActor* budGameLocal::GetAlertEntity()
{
	int timeGroup = 0;
...
void budGameLocal::RadiusDamage( const Vector3& origin, idEntity* inflictor, idEntity* attacker, idEntity* ignoreDamage, idEntity* ignorePush, const char* damageDefName, float dmgPower )
{
	...
	bounds = budBounds( origin ).Expand( radius );
	
	// get all entities touching the bounds
	numListedEntities = clip.EntitiesTouchingBounds( bounds, -1, entityList, MAX_GENTITIES );
	
	if( inflictor && inflictor->IsType( budAFAttachment::Type ) )
	{
		inflictor = static_cast<budAFAttachment*>( inflictor )->GetBody();
	}
	if( attacker && attacker->IsType( budAFAttachment::Type ) )
	{
		attacker = static_cast<budAFAttachment*>( attacker )->GetBody();
	}
	if( ignoreDamage && ignoreDamage->IsType( budAFAttachment::Type ) )
	{
		ignoreDamage = static_cast<budAFAttachment*>( ignoreDamage )->GetBody();
	}
	...
	for( e = 0; e < numListedEntities; e++ )
	{
		...
		if( ent == inflictor || ( ent->IsType( budAFAttachment::Type ) && static_cast<budAFAttachment*>( ent )->GetBody() == inflictor ) )
		{
			continue;
		}
		
		if( ent == ignoreDamage || ( ent->IsType( budAFAttachment::Type ) && static_cast<budAFAttachment*>( ent )->GetBody() == ignoreDamage ) )
		{
			continue;
		}
		...
		if( ent->CanDamage( origin, damagePoint ) )
		{
			...
			if( ent == attacker || ( ent->IsType( budAFAttachment::Type ) && static_cast<budAFAttachment*>( ent )->GetBody() == attacker ) )
			{
...
void budGameLocal::RadiusPush( const Vector3& origin, const float radius, const float push, const idEntity* inflictor, const idEntity* ignore, float inflictorScale, const bool quake )
{
	...
	if( inflictor && inflictor->IsType( budAFAttachment::Type ) )
	{
		inflictor = static_cast<const budAFAttachment*>( inflictor )->GetBody();
	}
	if( ignore && ignore->IsType( budAFAttachment::Type ) )
	{
		ignore = static_cast<const budAFAttachment*>( ignore )->GetBody();
	}
	...
	for( i = 0; i < numListedClipModels; i++ )
	{
		...
		if( ent == ignore || ( ent->IsType( budAFAttachment::Type ) && static_cast<budAFAttachment*>( ent )->GetBody() == ignore ) )
		{
			continue;
		}
...
/*
=============
budGameLocal::SetCamera
=============
*/
void budGameLocal::SetCamera( idCamera* cam )
{
	int i;
	idEntity* ent;
	budAI* ai;
...
/*
=============
budGameLocal::GetCamera
=============
*/
idCamera* budGameLocal::GetCamera() const
{
	return camera;
}
...
/*
=============
budGameLocal::SkipCinematic
=============
*/
bool budGameLocal::SkipCinematic( void )
{
	if( camera )
	{
...
/*
=============
budGameLocal::SkipCinematicScene
=============
*/
bool budGameLocal::SkipCinematicScene()
{
	return SkipCinematic();
}
/*
=============
budGameLocal::CheckInCinematic
=============
*/
bool budGameLocal::CheckInCinematic()
{
	return inCinematic;
}
/*
======================
budGameLocal::SpreadLocations

Now that everything has been spawned, associate areas with location entities
======================
*/
void budGameLocal::SpreadLocations()
{
	idEntity* ent;
	...
	for( ent = spawnedEntities.Next(); ent != NULL; ent = ent->spawnNode.Next() )
	{
		...
		if( areaNum >= numAreas )
		{
			Error( "budGameLocal::SpreadLocations: areaNum >= gameRenderWorld->NumAreas()" );
		}
...
idLocationEntity* budGameLocal::LocationForPoint( const Vector3& point )
{
	...
	{
		Error( "budGameLocal::LocationForPoint: areaNum >= gameRenderWorld->NumAreas()" );
	}
...
/*
============
budGameLocal::SetPortalState
============
*/
void budGameLocal::SetPortalState( qhandle_t portal, int blockingBits )
{
...
/*
============
budGameLocal::sortSpawnPoints
============
*/
int budGameLocal::sortSpawnPoints( const void* ptr1, const void* ptr2 )
{
...
/*
===========
budGameLocal::SelectInitialSpawnPoint
...
/*
================
budGameLocal::SetGlobalMaterial
================
*/
void budGameLocal::SetGlobalMaterial( const budMaterial* mat )
{
	globalMaterial = mat;
}
...
/*
================
budGameLocal::GetGlobalMaterial
================
*/
const budMaterial* budGameLocal::GetGlobalMaterial()
{
...
/*
================
budGameLocal::GetSpawnId
================
*/
int budGameLocal::GetSpawnId( const idEntity* ent ) const
{
...
/*
===========
budGameLocal::SelectTimeGroup
============
*/
void budGameLocal::SelectTimeGroup( int timeGroup )
{
	if( timeGroup )
	{
...
/*
===========
budGameLocal::GetTimeGroupTime
============
*/
int budGameLocal::GetTimeGroupTime( int timeGroup )
{
	if( timeGroup )
	{
		return fast.time;
...
/*
===========
budGameLocal::ComputeSlowScale
============
*/
void budGameLocal::ComputeSlowScale()
{
...
/*
===========
budGameLocal::ResetSlowTimeVars
============
*/
void budGameLocal::ResetSlowTimeVars()
{
	slowmoScale			= 1.0f;
	slowmoState			= SLOWMO_STATE_OFF;
...
/*
===========
budGameLocal::QuickSlowmoReset
============
*/
void budGameLocal::QuickSlowmoReset()
{
...
/*
================
budGameLocal::GetClientStats
================
*/
void budGameLocal::GetClientStats( int clientNum, char* data, const int len )
{
...
/*
================
budGameLocal::GetMPGameModes
================
*/
int budGameLocal::GetMPGameModes( const char** * gameModes, const char** * gameModesDisplay )
{
...
/*
========================
budGameLocal::IsPDAOpen
========================
*/
bool budGameLocal::IsPDAOpen() const
{
...
/*
========================
budGameLocal::IsPlayerChatting
========================
*/
bool budGameLocal::IsPlayerChatting() const
{
...
/*
========================
budGameLocal::InhibitControls
========================
*/
bool budGameLocal::InhibitControls()
{
...
/*
===============================
budGameLocal::Leaderboards_Init
===============================
*/
void budGameLocal::Leaderboards_Init()
{
...
/*
===============================
budGameLocal::Leaderboards_Shutdown
===============================
*/
void budGameLocal::Leaderboards_Shutdown()
{
...
/*
========================
budGameLocal::Shell_ClearRepeater
========================
*/
void budGameLocal::Shell_ClearRepeater()
{
...
/*
========================
budGameLocal::Shell_Init
========================
*/
void budGameLocal::Shell_Init( const char* filename, budSoundWorld* sw )
{
	if( shellHandler != NULL )
	{
...
========================
*/
void budGameLocal::Shell_Cleanup()
{
	if( shellHandler != NULL )
	{
		delete shellHandler;
...
/*
========================
budGameLocal::Shell_CreateMenu
========================
*/
void budGameLocal::Shell_CreateMenu( bool inGame )
{
	Shell_ResetMenu();
...
/*
========================
budGameLocal::Shell_ClosePause
========================
*/
void budGameLocal::Shell_ClosePause()
{
	if( shellHandler != NULL )
	{
...
/*
========================
budGameLocal::Shell_Show
========================
*/
void budGameLocal::Shell_Show( bool show )
{
	if( shellHandler != NULL )
	{
...
/*
========================
budGameLocal::Shell_IsActive
========================
*/
bool budGameLocal::Shell_IsActive() const
{
	if( shellHandler != NULL )
	{
...
/*
========================
budGameLocal::Shell_HandleGuiEvent
========================
*/
bool budGameLocal::Shell_HandleGuiEvent( const sysEvent_t* sev )
{
	if( shellHandler != NULL )
	{
...
/*
========================
budGameLocal::Shell_Render
========================
*/
void budGameLocal::Shell_Render()
{
	if( shellHandler != NULL )
	{
		shellHandler->Update();
...
/*
========================
budGameLocal::Shell_ResetMenu
========================
*/
void budGameLocal::Shell_ResetMenu()
{
	if( shellHandler != NULL )
	{
		delete shellHandler;
...
/*
=================
budGameLocal::Shell_SyncWithSession
=================
*/
void budGameLocal::Shell_SyncWithSession()
{
	if( shellHandler == NULL )
	{
		return;
...
/*
========================
budGameLocal::Shell_SetState_GameLobby
========================
*/
void budGameLocal::Shell_UpdateSavedGames()
{
	if( shellHandler != NULL )
	{
...
/*
========================
budGameLocal::Shell_SetCanContinue
========================
*/
void budGameLocal::Shell_SetCanContinue( bool valid )
{
	if( shellHandler != NULL )
	{
...
========================
*/
void budGameLocal::Shell_UpdateClientCountdown( int countdown )
{
	if( shellHandler != NULL )
	{
...
========================
*/
void budGameLocal::Shell_UpdateLeaderboard( const idLeaderboardCallback* callback )
{
	if( shellHandler != NULL )
	{
...
/*
========================
budGameLocal::StartDemoPlayback
========================
*/
void budGameLocal::StartDemoPlayback( budRenderWorld* renderworld )
{
	gameRenderWorld = renderworld;
	smokeParticles->Init();
}
...
/*
========================
budGameLocal::SimulateProjectiles
========================
*/
bool budGameLocal::SimulateProjectiles()
{
...
/*
===============
budGameLocal::DemoWriteGameInfo
===============
*/
void budGameLocal::DemoWriteGameInfo()
{
...
bool budGameLocal::ProcessDemoCommand( budDemoFile* readDemo )
{
