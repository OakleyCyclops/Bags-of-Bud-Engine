...
void idMenuWidget_NavButton::Update()
{
	...
	budSWFTextInstance* const text = spriteObject->GetNestedText( "txtVal" );
	if( text != NULL )
	{
	...
	{
		budSWFSpriteInstance* backing = GetSprite()->GetScriptObject()->GetNestedSprite( "backing" );
	...
	budSWFScriptObject* textObj = spriteObject->GetNestedObj( "txtVal" );
...
void idMenuWidget_MenuButton::Update()
{
	...
	if( text != NULL )
	{
		...
		budSWFSpriteInstance* selBar = spriteObject->GetNestedSprite( "sel", "bar" );
		budSWFSpriteInstance* hoverBar = spriteObject->GetNestedSprite( "hover", "bar" );
		...
		budSWFSpriteInstance* hitBox = spriteObject->GetNestedSprite( "hitBox" );
		if( hitBox != NULL )
		{
