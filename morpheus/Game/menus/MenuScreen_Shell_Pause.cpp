...
void idMenuScreen_Shell_Pause::HandleExitGameBtn()
{
	...
	{
	public:
		budSWFScriptFunction_QuitDialog( idMenuScreen_Shell_Pause* _menu, gameDialogMessages_t _msg, bool _accept )
		{
			menu = _menu;
			msg = _msg;
			accept = _accept;
	...
	common->Dialog().AddDialog( msg, DIALOG_ACCEPT_CANCEL, new budSWFScriptFunction_QuitDialog( this, msg, true ), new budSWFScriptFunction_QuitDialog( this, msg, false ), false );
}
...
{
	class budSWFScriptFunction_RestartDialog : public budSWFScriptFunction_RefCounted
	{
	public:
		budSWFScriptFunction_RestartDialog( idMenuScreen_Shell_Pause* _menu, gameDialogMessages_t _msg, bool _accept )
		{
			menu = _menu;
			msg = _msg;
			accept = _accept;
	...
	common->Dialog().AddDialog( GDM_SP_RESTART_SAVE, DIALOG_ACCEPT_CANCEL, new budSWFScriptFunction_RestartDialog( this, GDM_SP_RESTART_SAVE, true ), new budSWFScriptFunction_RestartDialog( this, GDM_SP_RESTART_SAVE, false ), false );
}
