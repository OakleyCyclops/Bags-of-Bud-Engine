...
void idMenuWidget_InfoBox::Update()
{
	...
	budSWFTextInstance* txtHeading = GetSprite()->GetScriptObject()->GetNestedText( "info", "heading", "txtVal" );
	budSWFTextInstance* txtBody = GetSprite()->GetScriptObject()->GetNestedText( "info", "txtBody" );
	...
	budSWFScriptObject* info = GetSprite()->GetScriptObject()->GetNestedObj( "info" );
	if( info != NULL )
	{
