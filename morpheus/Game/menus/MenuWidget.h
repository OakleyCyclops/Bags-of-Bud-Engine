...
struct widgetTransition_t
{
	...
	budStaticList< const char*, 4 >		prefixes;				// prefixes to try to use for animation
};
...
public:
	...
	virtual budSWFScriptVar		GetField( const int fieldIndex ) const	= 0;
...
public:
	...
	idWidgetEvent( const widgetEvent_t type_, const int arg_, budSWFScriptObject* thisObject_, const budSWFParmList& parms_ ) :
		type( type_ ),
		arg( arg_ ),
...
public:
	...
	void Set( budSWFScriptFunction* function )
	{
	...
	void Set( widgetAction_t action_, const budSWFScriptVar& var1 )
	{
		action = action_;
		parms.Clear();
		parms.Append( var1 );
	...
	void Set( widgetAction_t action_, const budSWFScriptVar& var1, const budSWFScriptVar& var2 )
	{
		action = action_;
		parms.Clear();
		parms.Append( var1 );
	...
	void Set( widgetAction_t action_, const budSWFScriptVar& var1, const budSWFScriptVar& var2, const budSWFScriptVar& var3 )
	{
		action = action_;
		parms.Clear();
		parms.Append( var1 );
	...
	void Set( widgetAction_t action_, const budSWFScriptVar& var1, const budSWFScriptVar& var2, const budSWFScriptVar& var3, const budSWFScriptVar& var4 )
	{
		action = action_;
		parms.Clear();
		parms.Append( var1 );
	...
	budSWFScriptFunction* 	GetScriptFunction()
	{
	...
	const budSWFParmList& 	GetParms() const
	{
		return parms;
	}
...
public:
	...
	================================================
	*/
	class WrapWidgetSWFEvent : public budSWFScriptFunction_RefCounted
	{
	public:
	...
	bool								BindSprite( budSWFScriptObject& root );
	void								ClearSprite();
...
public:
	...
	void					SetOnPressFunction( budSWFScriptFunction* func )
	{
		scriptFunction = func;
	}
...
private:
	budStaticList< buttonInfo_t, MAX_BUTTONS >	buttons;
...
public:
	...
	virtual void	Update();
	void			SetIcon( int index, const budMaterial* icon );
	void			FindFreeSpot();
	int				GetSlotIndex()
	{
		return slotIndex;
...
private:
	const budMaterial* images[ NUM_QUICK_SLOTS ];
	int				slotIndex;
...
================================================
*/
class idWidgetActionHandler : public budSWFScriptFunction_RefCounted
{
public:
