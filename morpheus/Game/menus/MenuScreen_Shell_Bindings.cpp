...
void idMenuScreen_Shell_Bindings::HandleRestoreDefaults()
{
	...
	class budSWFScriptFunction_Restore : public budSWFScriptFunction_RefCounted
	{
	public:
		budSWFScriptFunction_Restore( gameDialogMessages_t _msg, bool _accept, idMenuScreen_Shell_Bindings* _menu )
		{
			msg = _msg;
			accept = _accept;
			menu = _menu;
	...
	common->Dialog().AddDialog( GDM_BINDINGS_RESTORE, DIALOG_ACCEPT_CANCEL, new budSWFScriptFunction_Restore( GDM_BINDINGS_RESTORE, true, this ), new budSWFScriptFunction_Restore( GDM_BINDINGS_RESTORE, false, this ), false );
