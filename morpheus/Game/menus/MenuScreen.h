...
public:
	...
	virtual void				SetScreenGui( budSWF* gui )
	{
		menuGUI = gui;
	}
...
public:
	...
	const budDeclVideo* 			GetActiveVideo()
	{
		return activeVideo;
	}
private:
...
private:
	...
	idMenuWidget_DynamicList* 	options;
	idMenuWidget_Carousel* 		itemList;
	const budMaterial* 			doomCover;
	const budMaterial* 			doom2Cover;
	const budMaterial* 			doom3Cover;
};
...
protected:
	...
	budSWFSpriteInstance* 		blinder;
	budSWFSpriteInstance* 		txtBlinder;
	idMenuWidget_Button*		btnBack;
...
public:
	...
	*/
	...
	public:
		...
		virtual budSWFScriptVar		GetField( const int fieldIndex ) const
		{
	...
	private:
		budStaticList< budSWFScriptVar, MAX_GAME_FIELDS >	fields;
		budStaticList< budSWFScriptVar, MAX_GAME_FIELDS >	originalFields;
	};
...
public:
	...
	*/
	...
	private:
		budStaticList< budSWFScriptVar, MAX_CONTROL_FIELDS >	fields;
		budStaticList< budSWFScriptVar, MAX_CONTROL_FIELDS >	originalFields;
	};
...
public:
	...
	*/
	...
	private:
		budStaticList< budSWFScriptVar, MAX_GAMEPAD_FIELDS >	fields;
		budStaticList< budSWFScriptVar, MAX_GAMEPAD_FIELDS >	originalFields;
	};
...
public:
	...
	*/
	...
	private:
		budStaticList< budSWFScriptVar, MAX_LAYOUT_FIELDS >	fields;
		budStaticList< budSWFScriptVar, MAX_LAYOUT_FIELDS >	originalFields;
	};
...
public:
	...
	*/
	...
	private:
		budStaticList< budSWFScriptVar, MAX_STEREO_FIELDS >	fields;
		budStaticList< budSWFScriptVar, MAX_STEREO_FIELDS >	originalFields;
	};
...
private:
	...
	idMenuWidget_Button*			btnBack;
	const budMaterial* 			leftEyeMat;
	const budMaterial* 			rightEyeMat;
};
...
public:
	...
	void					HideTip();
	void					DownloadVideo();
	void					DownloadPDA( const budDeclPDA* pda, bool newSecurity );
...
private:
	...
	budSWFScriptObject* 		weaponInfo;
	budSWFScriptObject* 		playerInfo;
	budSWFScriptObject* 		stamina;
	budSWFScriptObject* 		weaponName;
	budSWFScriptObject* 		weaponPills;
	budSWFScriptObject* 		downloadPda;
	budSWFScriptObject* 		downloadVideo;
	budSWFScriptObject* 		tipInfo;
	budSWFScriptObject* 		mpChat;
	budSWFScriptObject* 		mpWeapons;
	
	budSWFSpriteInstance* 	healthBorder;
	budSWFSpriteInstance* 	healthPulse;
	budSWFSpriteInstance* 	armorFrame;
	budSWFSpriteInstance* 	security;
	budSWFSpriteInstance* 	newPDADownload;
	budSWFSpriteInstance* 	newVideoDownload;
	budSWFSpriteInstance* 	newPDA;
	budSWFSpriteInstance* 	newVideo;
	budSWFSpriteInstance* 	audioLog;
	budSWFSpriteInstance* 	communication;
	budSWFSpriteInstance* 	oxygen;
	budSWFSpriteInstance* 	objective;
	budSWFSpriteInstance* 	objectiveComplete;
	budSWFSpriteInstance* 	ammoInfo;
	budSWFSpriteInstance* 	weaponImg;
	budSWFSpriteInstance* 	newWeapon;
	budSWFSpriteInstance* 	pickupInfo;
	budSWFSpriteInstance* 	talkCursor;
	budSWFSpriteInstance* 	combatCursor;
	budSWFSpriteInstance* 	grabberCursor;
	budSWFSpriteInstance* 	bsInfo;
	budSWFSpriteInstance* 	soulcubeInfo;
	budSWFSpriteInstance* 	newItem;
	budSWFSpriteInstance*		respawnMessage;
	budSWFSpriteInstance* 	flashlight;
	budSWFSpriteInstance* 	mpChatObject;
	budSWFSpriteInstance* 	mpConnection;
	
	budSWFSpriteInstance* 	mpInfo;
	budSWFSpriteInstance* 	mpHitInfo;
	
	budSWFTextInstance* 		locationName;
	budSWFTextInstance* 		securityText;
	budSWFTextInstance* 		newPDAName;
	budSWFTextInstance* 		newPDAHeading;
	budSWFTextInstance* 		newVideoHeading;
	
	budSWFTextInstance* 		mpMessage;
	budSWFTextInstance* 		mpTime;
