...
void idMenuScreen_Shell_Load::LoadDamagedGame( int index )
{
	...
	class budSWFScriptFunction_LoadDamaged : public budSWFScriptFunction_RefCounted
	{
	public:
		budSWFScriptFunction_LoadDamaged( gameDialogMessages_t _msg, bool _accept, int _index, idMenuScreen_Shell_Load* _screen )
		{
			msg = _msg;
			accept = _accept;
			index = _index;
...
void idMenuScreen_Shell_Load::LoadGame( int index )
{
	...
	if( mgr != NULL && mgr->GetInGame() && !isDead )
	{
		...
		class budSWFScriptFunction_LoadDialog : public budSWFScriptFunction_RefCounted
		{
		public:
			budSWFScriptFunction_LoadDialog( gameDialogMessages_t _msg, bool _accept, const char* _name )
			{
				msg = _msg;
				accept = _accept;
				name = _name;
...
void idMenuScreen_Shell_Load::DeleteGame( int index )
{
	...
	{
	public:
		budSWFScriptFunction_DeleteGame( gameDialogMessages_t _msg, bool _accept, int _index, idMenuScreen_Shell_Load* _screen )
		{
			msg = _msg;
			accept = _accept;
			index = _index;
