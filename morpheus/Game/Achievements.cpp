...
/*
========================
budAchievementManager::budAchievementManager
========================
*/
budAchievementManager::budAchievementManager() :
...
/*
========================
budAchievementManager::SyncAchievments
========================
*/
void budAchievementManager::SyncAchievments()
{
...
/*
========================
budAchievementManager::GetLocalUser
========================
*/
idLocalUser* budAchievementManager::GetLocalUser()
{
...
/*
========================
budAchievementManager::Save
========================
*/
void budAchievementManager::Save( idSaveGame* savefile ) const
{
	owner.Save( savefile );
...
/*
========================
budAchievementManager::Restore
========================
*/
void budAchievementManager::Restore( idRestoreGame* savefile )
{
...
/*
========================
budAchievementManager::EventCompletesAchievement
========================
*/
void budAchievementManager::EventCompletesAchievement( const achievement_t eventId )
{
	...
	if( localUser == NULL || localUser->GetProfile() == NULL )
	{
		...
		if( owner != NULL )
		{
			...
			msg.WriteByteAlign();
			libBud::Printf( "Host Sending Achievement\n" );
...
/*
========================
budAchievementManager::IncrementHellTimeKills
========================
*/
void budAchievementManager::IncrementHellTimeKills()
{
...
/*
========================
budAchievementManager::LocalUser_CompleteAchievement
========================
*/
void budAchievementManager::LocalUser_CompleteAchievement( achievement_t id )
{
...
/*
========================
budAchievementManager::CheckDoomClassicsAchievements
...
void budAchievementManager::CheckDoomClassicsAchievements( int killcount, int itemcount, int secretcount, int skill, int mission, int map, int episode, int totalkills, int totalitems, int totalsecret )
{
