...
public:
	...
	// returns false if there was an error
	virtual bool	GetAchievementState( idLocalUser* user, budArray< bool, budAchievementSystem::MAX_ACHIEVEMENTS >& achievements ) const
	{
		return false;
	}
	...
	// returns false if there was an error
	virtual bool	SetAchievementState( idLocalUser* user, budArray< bool, budAchievementSystem::MAX_ACHIEVEMENTS >& achievements )
	{
		return false;
	}
...
protected:
	...
	budStaticList< idLocalUser*, MAX_LOCAL_PLAYERS > users;
};
