...
public:
	...
	void			GetActiveLocalTalkers( budStaticList< int, MAX_PLAYERS >& localTalkers );
	void			GetRecipientsForTalker( int talkerIndex, budStaticList< const lobbyAddress_t*, MAX_PLAYERS >& recipients );
...
protected:
	...
	budStaticList< talker_t, MAX_PLAYERS * 2 >			talkers;			// * 2 to account for handling both session types
	budStaticList< remoteMachine_t, MAX_PLAYERS * 2 >	remoteMachines;		// * 2 to account for handling both session types
