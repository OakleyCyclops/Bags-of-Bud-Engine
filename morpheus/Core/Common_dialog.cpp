...
budCVar popupDialog_debug( "popupDialog_debug", "0", CVAR_BOOL | CVAR_ARCHIVE, "display debug spam" );
...
budCVar dialog_saveClearLevel( "dialog_saveClearLevel", "1000", CVAR_INTEGER, "Time required to show long message" );
...
/*
================================================
budCommonDialog::ClearDialogs
================================================
*/
void budCommonDialog::ClearDialogs( bool forceClear )
{
...
/*
================================================
budCommonDialog::AddDialogIntVal
================================================
*/
void budCommonDialog::AddDialogIntVal( const char* name, int val )
{
	if( dialog != NULL )
	{
...
/*
================================================
budCommonDialog::AddDialog
================================================
*/
void budCommonDialog::AddDialog( gameDialogMessages_t msg, dialogType_t type, budSWFScriptFunction* acceptCallback,
								budSWFScriptFunction* cancelCallback, bool pause, const char* location, int lineNumber,
...
/*
========================
budCommonDialog::AddDynamicDialog
========================
*/
void budCommonDialog::AddDynamicDialog( gameDialogMessages_t msg, const budStaticList< budSWFScriptFunction*, 4 >& callbacks,
									   const budStaticList< budStrId, 4 >& optionText, bool pause, budStrStatic< 256 > overrideMsg,
									   bool leaveOnMapHeapReset, bool waitOnAtlas, bool renderDuringLoad )
{
	...
	info.txt1 = 0 < optionText.Num() ? optionText[0] : budStrId();
	info.txt2 = 1 < optionText.Num() ? optionText[1] : budStrId();
	info.txt3 = 2 < optionText.Num() ? optionText[2] : budStrId();
	info.txt4 = 3 < optionText.Num() ? optionText[3] : budStrId();
	info.renderDuringLoad = renderDuringLoad;
...
/*
========================
budCommonDialog::AddDialogInternal
========================
*/
void budCommonDialog::AddDialogInternal( idDialogInfo& info )
{
	...
	else
	{
		...
		if( messageList.Num() > 0 )
		{
			libBud::PrintfIf( popupDialog_debug.GetBool(), "[%s] msg: %s new dialog added over old\n", __FUNCTION__, dialogStateToString[info.msg] );
...
/*
========================
budCommonDialog::ActivateDialog
========================
*/
void budCommonDialog::ActivateDialog( bool activate )
{
...
/*
================================================
budCommonDialog::ShowDialog
================================================
*/
void budCommonDialog::ShowDialog( const idDialogInfo& info )
{
	libBud::PrintfIf( popupDialog_debug.GetBool(), "[%s] msg: %s, m.clear = %d, m.waitClear = %d, m.killTime = %d\n",
	...
	{
		class budSWFScriptFunction_Accept : public budSWFScriptFunction_RefCounted
		{
		public:
			budSWFScriptFunction_Accept( gameDialogMessages_t _msg )
			{
				msg = _msg;
			}
		...
		dialog->SetGlobal( "acceptCallBack", new( TAG_SWF ) budSWFScriptFunction_Accept( info.msg ) );
...
/*
================================================
budCommonDialog::ShowNextDialog
================================================
*/
void budCommonDialog::ShowNextDialog()
{
	for( int index = 0; index < messageList.Num(); ++index )
	{
...
/*
================================================
budCommonDialog::ShowSaveIndicator
================================================
*/
void budCommonDialog::ShowSaveIndicator( bool show )
{
	libBud::PrintfIf( popupDialog_debug.GetBool(), "[%s]\n", __FUNCTION__ );
	
	if( show )
	{
		budStr msg = budStrId( "#str_dlg_pc_saving" ).GetLocalizedString();
...
/*
========================
budCommonDialog::RemoveSaveDialog
...
========================
*/
void budCommonDialog::RemoveWaitDialogs()
{
	bool topMessageCleared = false;
	for( int index = 0; index < messageList.Num(); ++index )
	{
...
/*
================================================
budCommonDialog::ClearAllDialogHack
================================================
*/
void budCommonDialog::ClearAllDialogHack()
{
	for( int index = 0; index < messageList.Num(); ++index )
	{
		messageList[index].clear = true;
...
/*
================================================
budCommonDialog::HasDialogMsg
================================================
*/
bool budCommonDialog::HasDialogMsg( gameDialogMessages_t msg, bool* isNowActive )
{
	for( int index = 0; index < messageList.Num(); ++index )
	{
		idDialogInfo& info = messageList[index];
...
/*
================================================
budCommonDialog::ClearDialog
================================================
*/
void budCommonDialog::ClearDialog( gameDialogMessages_t msg, const char* location, int lineNumber )
{
	bool topMessageCleared = false;
	...
	for( int index = 0; index < messageList.Num(); ++index )
	{
		...
		if( info.msg == msg && !info.clear )
		{
			...
			libBud::PrintfIf( popupDialog_debug.GetBool(), "[%s] msg: %s, from: %s:%d, topMessageCleared = %d, m.clear = %d, m.waitClear = %d, m.killTime = %d\n",
...
/*
================================================
budCommonDialog::ReleaseCallBacks
================================================
*/
void budCommonDialog::ReleaseCallBacks( int index )
{
...
/*
================================================
budCommonDialog::Render
================================================
*/
void budCommonDialog::Render( bool loading )
{
	...
	for( int index = 0; index < messageList.Num(); ++index )
	{
		if( messageList[index].clear )
		{
			libBud::PrintfIf( popupDialog_debug.GetBool(), "[%s] removing %s\n", __FUNCTION__, dialogStateToString[messageList[index].msg] );
			ReleaseCallBacks( index );
			messageList.RemoveIndex( index );
			index--;
		}
	...
	if( messageList.Num() > 0 && messageList[0].type == DIALOG_TIMER_ACCEPT_REVERT )
	{
		...
		{
			budStrId txtTime = budStrId( "#str_time_remaining" );
...
/*
================================================
budCommonDialog::Init
================================================
*/
void budCommonDialog::Init()
{
	...
	dialog = new( TAG_SWF ) budSWF( "dialog" );
	saveIndicator = new( TAG_SWF ) budSWF( "save_indicator" );
...
/*
================================================
budCommonDialog::Shutdown
================================================
*/
void budCommonDialog::Shutdown()
{
	libBud::PrintfIf( popupDialog_debug.GetBool(), "[%s]\n", __FUNCTION__ );
...
/*
========================
budCommonDialog::Restart
========================
*/
void budCommonDialog::Restart()
{
	Shutdown();
	Init();
}
...
/*
================================================
budCommonDialog::GetDialogMsg
================================================
*/
budStr budCommonDialog::GetDialogMsg( gameDialogMessages_t msg, budStr& message, budStr& title )
{
	...
	switch( msg )
	{
		...
		{
			title = budLocalization::GetString( "#str_04215" );
			title.ToUpper();
		...
		{
			title = budLocalization::GetString( "#str_02187" );
			title.ToUpper();
		...
		{
			title = budLocalization::GetString( "#str_04271" );
			title.ToUpper();
...
/*
================================================
budCommonDialog::HandleDialogEvent
================================================
*/
bool budCommonDialog::HandleDialogEvent( const sysEvent_t* sev )
{
...
/*
================================================
budCommonDialog::IsDialogActive
================================================
*/
bool budCommonDialog::IsDialogActive()
{
	if( dialog != NULL )
	{
