...
/*
==================
budCommonLocal::BeginRedirect
==================
*/
void budCommonLocal::BeginRedirect( char* buffer, int buffersize, void ( *flush )( const char* ) )
{
...
/*
==================
budCommonLocal::EndRedirect
==================
*/
void budCommonLocal::EndRedirect()
{
...
/*
==================
budCommonLocal::CloseLogFile
==================
*/
void budCommonLocal::CloseLogFile()
{
	if( logFile )
	{
...
/*
==================
budCommonLocal::SetRefreshOnPrint
==================
*/
void budCommonLocal::SetRefreshOnPrint( bool set )
{
...
/*
==================
budCommonLocal::VPrintf

A raw string should NEVER be passed as fmt, because of "%f" type crashes.
==================
*/
void budCommonLocal::VPrintf( const char* fmt, va_list args )
{
	...
	// don't overflow
	if( budStr::vsnPrintf( msg + timeLength, MAX_PRINT_MSG_SIZE - timeLength - 1, fmt, args ) < 0 )
	{
		msg[sizeof( msg ) - 2] = '\n';
		msg[sizeof( msg ) - 1] = '\0'; // avoid output garbling
		Sys_Printf( "budCommon::VPrintf: truncated to %d characters\n", strlen( msg ) - 1 );
	}
	...
	{
		budStrStatic< 4096 > filterBuf = com_printFilter.GetString();
		budStrStatic< 4096 > msgBuf = msg;
		filterBuf.ToLower();
		msgBuf.ToLower();
...
==================
*/
void budCommonLocal::Printf( const char* fmt, ... )
{
	va_list argptr;
	va_start( argptr, fmt );
	VPrintf( fmt, argptr );
...
/*
==================
budCommonLocal::DPrintf

prints message that only shows up if the "developer" cvar is set
==================
*/
void budCommonLocal::DPrintf( const char* fmt, ... )
{
	va_list		argptr;
	char		msg[MAX_PRINT_MSG_SIZE];
	...
	va_start( argptr, fmt );
	budStr::vsnPrintf( msg, sizeof( msg ), fmt, argptr );
	va_end( argptr );
	msg[sizeof( msg ) - 1] = '\0';
...
/*
==================
budCommonLocal::PrintWarnings
==================
*/
void budCommonLocal::PrintWarnings()
{
	int i;
...
/*
==================
budCommonLocal::ClearWarnings
==================
*/
void budCommonLocal::ClearWarnings( const char* reason )
{
...
/*
==================
budCommonLocal::DumpWarnings
==================
*/
void budCommonLocal::DumpWarnings()
{
	int			i;
	budFile*		warningFile;
...
/*
==================
budCommonLocal::Error
==================
*/
void budCommonLocal::Error( const char* fmt, ... )
{
	va_list		argptr;
	...
	va_start( argptr, fmt );
	budStr::vsnPrintf( errorMessage, sizeof( errorMessage ), fmt, argptr );
	va_end( argptr );
...
/*
==================
budCommonLocal::FatalError

Dump out of the game to a system dialog
==================
*/
void budCommonLocal::FatalError( const char* fmt, ... )
{
	va_list		argptr;
