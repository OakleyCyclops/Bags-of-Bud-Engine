...
#pragma hdrstop
#include "corePCH.hpp"
#include "coreConsoleHistory.hpp"
...
/*
========================
budConsoleHistory::AddToHistory
========================
*/
void budConsoleHistory::AddToHistory( const char* line, bool writeHistoryFile )
{
...
//	//mem.PopHeap();
	...
	if( writeHistoryFile )
	{
		budFile* f = fileSystem->OpenFileWrite( HISTORY_FILE_NAME );
		if( f != NULL )
		{
...
/*
========================
budConsoleHistory::RetrieveFromHistory
========================
*/
budStr budConsoleHistory::RetrieveFromHistory( bool backward )
{
...
/*
========================
budConsoleHistory::LoadHistoryFile
========================
*/
void budConsoleHistory::LoadHistoryFile()
{
	budLexer lex;
...
/*
========================
budConsoleHistory::PrintHistory
========================
*/
void budConsoleHistory::PrintHistory()
{
	for( int i = numHistory - COMMAND_HISTORY; i < numHistory; i++ )
	{
		if( i < 0 )
...
/*
========================
budConsoleHistory::ClearHistory
========================
*/
void budConsoleHistory::ClearHistory()
{
	upPoint = 0;
	downPoint = 0;
	returnLine = 0;
