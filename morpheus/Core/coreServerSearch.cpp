...
========================
*/
void idDedicatedServerSearch::HandleQueryAck( lobbyAddress_t& addr, budBitMsg& msg )
{
	bool found = false;
...
========================
*/
const budList< budStr >* idDedicatedServerSearch::GetServerPlayersAtIndex( int i ) const
{
	if( i >= 0 && i < list.Num() )
	{
