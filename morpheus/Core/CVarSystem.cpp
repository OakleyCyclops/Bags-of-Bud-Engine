...
private:
	budStr					nameString;				// name
	budStr					resetString;			// resetting will change to this value
	budStr					valueString;			// value
	budStr					descriptionString;		// description
...
============
*/
idInternalCVar::idInternalCVar( const budCVar* cvar )
{
...
const char** idInternalCVar::CopyValueStrings( const char** strings )
{
	...
	{
		totalLength += budStr::Length( strings[i] ) + 1;
	}
...
============
*/
void idInternalCVar::Update( const budCVar* cvar )
{
...
void idInternalCVar::UpdateValue()
{
	...
	if( flags & CVAR_BOOL )
	{
		...
		if( budStr::Icmp( value, "0" ) != 0 && budStr::Icmp( value, "1" ) != 0 )
		{
			valueString = budStr( ( bool )( integerValue != 0 ) );
			value = valueString.c_str();
		}
	}
	else if( flags & CVAR_INTEGER )
	{
		...
		if( clamped || !budStr::IsNumeric( value ) || budStr::FindChar( value, '.' ) )
		{
			valueString = budStr( integerValue );
			value = valueString.c_str();
		}
	...
	else if( flags & CVAR_FLOAT )
	{
		...
		if( clamped || !budStr::IsNumeric( value ) )
		{
			valueString = budStr( floatValue );
			value = valueString.c_str();
		}
...
{
	Set( budStr( newValue ), true, false );
}
...
class budCVarSystemLocal : public budCVarSystem
{
public:
	budCVarSystemLocal();
	
	virtual					~budCVarSystemLocal() {}
	
	virtual void			Init();
	virtual void			Shutdown();
	virtual bool			IsInitialized() const;
	
	virtual void			Register( budCVar* cvar );
	
	virtual budCVar* 		Find( const char* name );
	...
	virtual bool			Command( const budCmdArgs& args );
	...
	virtual void			WriteFlaggedVariables( int flags, const char* setCmd, budFile* f ) const;
	...
	void					RegisterInternal( budCVar* cvar );
	idInternalCVar* 		FindInternal( const char* name ) const;
	void					SetInternal( const char* name, const char* value, int flags );
	
private:
	bool					initialized;
	budList<idInternalCVar*, TAG_CVAR>	cvars;
	budHashIndex				cvarHash;
	int						modifiedFlags;
	
private:
	static void				Toggle_f( const budCmdArgs& args );
	static void				Set_f( const budCmdArgs& args );
	static void				Reset_f( const budCmdArgs& args );
	static void				ListByFlags( const budCmdArgs& args, cvarFlags_t flags );
	static void				List_f( const budCmdArgs& args );
	static void				Restart_f( const budCmdArgs& args );
	static void				CvarAdd_f( const budCmdArgs& args );
};

budCVarSystemLocal			localCVarSystem;
budCVarSystem* 				cvarSystem = &localCVarSystem;
...
const char* CreateColumn( const char* text, int columnWidth, const char* indent, budStr& string )
{
	int i, lastLine;
...
/*
============
budCVarSystemLocal::FindInternal
============
*/
idInternalCVar* budCVarSystemLocal::FindInternal( const char* name ) const
{
...
/*
============
budCVarSystemLocal::SetInternal
============
*/
void budCVarSystemLocal::SetInternal( const char* name, const char* value, int flags )
{
	int hash;
...
/*
============
budCVarSystemLocal::budCVarSystemLocal
============
*/
budCVarSystemLocal::budCVarSystemLocal()
{
...
/*
============
budCVarSystemLocal::Init
============
*/
void budCVarSystemLocal::Init()
{
...
/*
============
budCVarSystemLocal::Shutdown
============
*/
void budCVarSystemLocal::Shutdown()
{
...
/*
============
budCVarSystemLocal::IsInitialized
============
*/
bool budCVarSystemLocal::IsInitialized() const
{
	return initialized;
}
...
/*
============
budCVarSystemLocal::Register
============
*/
void budCVarSystemLocal::Register( budCVar* cvar )
{
	int hash;
	idInternalCVar* internal;
...
/*
============
budCVarSystemLocal::Find
============
*/
budCVar* budCVarSystemLocal::Find( const char* name )
{
...
/*
============
budCVarSystemLocal::SetCVarString
============
*/
void budCVarSystemLocal::SetCVarString( const char* name, const char* value, int flags )
{
...
/*
============
budCVarSystemLocal::SetCVarBool
============
*/
void budCVarSystemLocal::SetCVarBool( const char* name, const bool value, int flags )
{
	SetInternal( name, budStr( value ), flags );
}

/*
============
budCVarSystemLocal::SetCVarInteger
============
*/
void budCVarSystemLocal::SetCVarInteger( const char* name, const int value, int flags )
{
	SetInternal( name, budStr( value ), flags );
}
...
/*
============
budCVarSystemLocal::SetCVarFloat
============
*/
void budCVarSystemLocal::SetCVarFloat( const char* name, const float value, int flags )
{
	SetInternal( name, budStr( value ), flags );
}
...
/*
============
budCVarSystemLocal::GetCVarString
============
*/
const char* budCVarSystemLocal::GetCVarString( const char* name ) const
{
...
/*
============
budCVarSystemLocal::GetCVarBool
============
*/
bool budCVarSystemLocal::GetCVarBool( const char* name ) const
{
	idInternalCVar* internal = FindInternal( name );
	if( internal )
	{
...
/*
============
budCVarSystemLocal::GetCVarInteger
============
*/
int budCVarSystemLocal::GetCVarInteger( const char* name ) const
{
	idInternalCVar* internal = FindInternal( name );
	if( internal )
	{
...
/*
============
budCVarSystemLocal::GetCVarFloat
============
*/
float budCVarSystemLocal::GetCVarFloat( const char* name ) const
{
	idInternalCVar* internal = FindInternal( name );
	if( internal )
	{
...
/*
============
budCVarSystemLocal::Command
============
*/
bool budCVarSystemLocal::Command( const budCmdArgs& args )
{
	idInternalCVar* internal;
	...
	if( args.Argc() == 1 )
	{
		...
		if( budStr::Length( internal->GetDescription() ) > 0 )
		{
...
/*
============
budCVarSystemLocal::CommandCompletion
============
*/
void budCVarSystemLocal::CommandCompletion( void( *callback )( const char* s ) )
{
...
/*
============
budCVarSystemLocal::ArgCompletion
============
*/
void budCVarSystemLocal::ArgCompletion( const char* cmdString, void( *callback )( const char* s ) )
{
	budCmdArgs args;
	...
	for( int i = 0; i < cvars.Num(); i++ )
	{
		...
		if( budStr::Icmp( args.Argv( 0 ), cvars[i]->nameString.c_str() ) == 0 )
		{
...
/*
============
budCVarSystemLocal::SetModifiedFlags
============
*/
void budCVarSystemLocal::SetModifiedFlags( int flags )
{
	modifiedFlags |= flags;
}
...
/*
============
budCVarSystemLocal::GetModifiedFlags
============
*/
int budCVarSystemLocal::GetModifiedFlags() const
{
...
/*
============
budCVarSystemLocal::ClearModifiedFlags
============
*/
void budCVarSystemLocal::ClearModifiedFlags( int flags )
{
	modifiedFlags &= ~flags;
}
...
/*
============
budCVarSystemLocal::ResetFlaggedVariables
============
*/
void budCVarSystemLocal::ResetFlaggedVariables( int flags )
{
	for( int i = 0; i < cvars.Num(); i++ )
	{
...
/*
============
budCVarSystemLocal::RemoveFlaggedAutoCompletion
============
*/
void budCVarSystemLocal::RemoveFlaggedAutoCompletion( int flags )
{
	for( int i = 0; i < cvars.Num(); i++ )
	{
		idInternalCVar* cvar = cvars[i];
...
/*
============
budCVarSystemLocal::WriteFlaggedVariables

Appends lines containing "set variable value" for all variables
with the "flags" flag set to true.
============
*/
void budCVarSystemLocal::WriteFlaggedVariables( int flags, const char* setCmd, budFile* f ) const
{
	for( int i = 0; i < cvars.Num(); i++ )
	{
		idInternalCVar* cvar = cvars[i];
...
/*
============
budCVarSystemLocal::MoveCVarsToDict
============
*/
void budCVarSystemLocal::MoveCVarsToDict( int flags, idDict& dict, bool onlyModified ) const
{
	dict.Clear();
	for( int i = 0; i < cvars.Num(); i++ )
	{
		budCVar* cvar = cvars[i];
		if( cvar->GetFlags() & flags )
		{
			if( onlyModified && budStr::Icmp( cvar->GetString(), cvar->GetDefaultString() ) == 0 )
			{
				continue;
			}
...
/*
============
budCVarSystemLocal::SetCVarsFromDict
============
*/
void budCVarSystemLocal::SetCVarsFromDict( const idDict& dict )
{
	idInternalCVar* internal;
...
/*
============
budCVarSystemLocal::Toggle_f
============
*/
void budCVarSystemLocal::Toggle_f( const budCmdArgs& args )
{
	int argc, i;
	float current, set;
	const char* text;
	...
	if( argc > 3 )
	{
		...
		for( i = 2; i < argc; i++ )
		{
			if( !budStr::Icmp( text, args.Argv( i ) ) )
			{
				// point to next value
				i++;
				break;
	...
	else
	{
		...
		cvar->Set( budStr( current ), false, false );
	}
}

/*
============
budCVarSystemLocal::Set_f
============
*/
void budCVarSystemLocal::Set_f( const budCmdArgs& args )
{
	const char* str;
...
/*
============
budCVarSystemLocal::Reset_f
============
*/
void budCVarSystemLocal::Reset_f( const budCmdArgs& args )
{
	idInternalCVar* cvar;
...
/*
============
budCVarSystemLocal::CvarAdd_f
============
*/
void budCVarSystemLocal::CvarAdd_f( const budCmdArgs& args )
{
	if( args.Argc() != 3 )
	{
...
//================================================
//*/
//class budSort_InternalCVar : public budSort_Quick< const idInternalCVar *, budSort_InternalCVar > {
//public:
//	int Compare( const idInternalCVar * & a, const idInternalCVar * & b ) const { return budStr::Icmp( a.GetName(), b.GetName() ); }
//};

void budCVarSystemLocal::ListByFlags( const budCmdArgs& args, cvarFlags_t flags )
{
	int i, argNum;
	budStr match, indent, string;
	const idInternalCVar* cvar;
	budList<const idInternalCVar*, TAG_CVAR>cvarList;
	...
	if( budStr::Icmp( args.Argv( argNum ), "-" ) == 0 || budStr::Icmp( args.Argv( argNum ), "/" ) == 0 )
	{
		if( budStr::Icmp( args.Argv( argNum + 1 ), "help" ) == 0 || budStr::Icmp( args.Argv( argNum + 1 ), "?" ) == 0 )
		{
			argNum = 3;
			show = SHOW_DESCRIPTION;
		}
		else if( budStr::Icmp( args.Argv( argNum + 1 ), "type" ) == 0 || budStr::Icmp( args.Argv( argNum + 1 ), "range" ) == 0 )
		{
			argNum = 3;
			show = SHOW_TYPE;
		}
		else if( budStr::Icmp( args.Argv( argNum + 1 ), "flags" ) == 0 )
		{
			argNum = 3;
			show = SHOW_FLAGS;
		}
	...
	//cvarList.SortWithTemplate( budSort_InternalCVar() );
		...
		case SHOW_TYPE:
		{
			for( i = 0; i < cvarList.Num(); i++ )
			{
				...
				else if( cvar->GetFlags() & CVAR_FLOAT )
				{
					if( cvar->GetMinValue() < cvar->GetMaxValue() )
					{
						common->Printf( FORMAT_STRING S_COLOR_RED "float " S_COLOR_WHITE "[%s, %s]\n", cvar->GetName(), budStr( cvar->GetMinValue() ).c_str(), budStr( cvar->GetMaxValue() ).c_str() );
					}
					else
					{
...
/*
============
budCVarSystemLocal::List_f
============
*/
void budCVarSystemLocal::List_f( const budCmdArgs& args )
{
...
/*
============
budCVarSystemLocal::Restart_f
============
*/
void budCVarSystemLocal::Restart_f( const budCmdArgs& args )
{
	int i, hash;
	idInternalCVar* cvar;
