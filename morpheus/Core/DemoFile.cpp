...
budCVar budDemoFile::com_compressDemos( "com_compressDemos", "1", CVAR_SYSTEM | CVAR_INTEGER | CVAR_ARCHIVE, "Compression scheme for demo files\n0: None    (Fast, large files)\n1: LZW     (Fast to compress, Fast to decompress, medium/small files)\n2: LZSS    (Slow to compress, Fast to decompress, small files)\n3: Huffman (Fast to compress, Slow to decompress, medium files)\nSee also: The 'CompressDemo' command" );
budCVar budDemoFile::com_preloadDemos( "com_preloadDemos", "0", CVAR_SYSTEM | CVAR_BOOL | CVAR_ARCHIVE, "Load the whole demo in to RAM before running it" );

#define DEMO_MAGIC GAME_NAME " RDEMO"

/*
================
budDemoFile::budDemoFile
================
*/
budDemoFile::budDemoFile()
{
...
/*
================
budDemoFile::OpenForReading
================
*/
bool budDemoFile::OpenForReading( const char* fileName )
{
	...
	if( com_preloadDemos.GetBool() )
	{
		...
		f = new( TAG_SYSTEM ) budFile_Memory( va( "preloaded(%s)", fileName ), ( const char* )fileImage, fileLength );
	}
...
================
*/
void budDemoFile::SetLog( bool b, const char* p )
{
	log = b;
	if( p )
	{
...
================
*/
void budDemoFile::Log( const char* p )
{
	if( fLog && p && *p )
	{
...
/*
================
budDemoFile::OpenForWriting
================
*/
bool budDemoFile::OpenForWriting( const char* fileName )
{
	Close();
...
/*
================
budDemoFile::ReadHashString
================
*/
const char* budDemoFile::ReadHashString()
{
	int		index;
	...
	if( index == -1 )
	{
		...
		budStr*	str = new( TAG_SYSTEM ) budStr;
...
/*
================
budDemoFile::WriteHashString
================
*/
void budDemoFile::WriteHashString( const char* str )
{
	if( log && fLog )
	{
	...
	budStr*	copy = new( TAG_SYSTEM ) budStr( str );
...
/*
================
budDemoFile::ReadDict
================
*/
void budDemoFile::ReadDict( idDict& dict )
{
	int i, c;
	budStr key, val;
...
/*
================
budDemoFile::WriteDict
================
*/
void budDemoFile::WriteDict( const idDict& dict )
{
	int i, c;
...
/*
 ...
 ================
 */
int budDemoFile::Read( void* buffer, int len )
{
...
/*
 ...
 ================
 */
int budDemoFile::Write( const void* buffer, int len )
{
