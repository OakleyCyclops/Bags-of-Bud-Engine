...
public:
	struct row_t
	{
		...
		budStr		name;
		int64		rank;
		budArray<int64, MAX_LEADERBOARD_COLUMNS> 	columns;
...
//		CSteamID	user_id;
	...
	const budList< row_t >& 			GetRows() const
	{
		return rows;
	}
...
protected:
	...
	budList< row_t >					rows;					// leaderboard entries for the request
