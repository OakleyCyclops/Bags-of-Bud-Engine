...
public:
	...
	virtual int				ReadString( budStr& string );
	virtual int				ReadVec2( budVec2& vec );
	virtual int				ReadVec3( budVec3& vec );
	virtual int				ReadVec4( budVec4& vec );
	virtual int				ReadVec6( budVec6& vec );
	virtual int				ReadMat3( budMat3& mat );
	...
	virtual int				WriteVec2( const budVec2& vec );
	virtual int				WriteVec3( const budVec3& vec );
	virtual int				WriteVec4( const budVec4& vec );
	virtual int				WriteVec6( const budVec6& vec );
	virtual int				WriteMat3( const budMat3& mat );
