...
/*
================================================
budAchievementSystemWin
================================================
*/
class budAchievementSystemWin : public budAchievementSystem
{
public:
	budAchievementSystemWin();
	...
	bool	GetAchievementState( idLocalUser* user, budArray< bool, budAchievementSystem::MAX_ACHIEVEMENTS >& achievements ) const;
};
