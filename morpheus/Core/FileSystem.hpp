...
public:
	...
	virtual void			StartPreload( const budStrList& _preload ) = 0;
	virtual void			StopPreload() = 0;
	virtual int				ReadFromBGL( budFile* _resourceFile, void* _buffer, int _offset, int _len ) = 0;
	virtual bool			IsBinaryModel( const budStr& resName ) const = 0;
	virtual bool			IsSoundSample( const budStr& resName ) const = 0;
...
extern budFileSystem* 		fileSystem;
