...
class budPlayerProfileLocal : public budPlayerProfile
{
};
budPlayerProfileLocal playerProfiles[MAX_INPUT_DEVICES];
...
/*
========================
budPlayerProfile * CreatePlayerProfile
========================
*/
budPlayerProfile* budPlayerProfile::CreatePlayerProfile( int deviceIndex )
{
...
/*
========================
budPlayerProfile::budPlayerProfile
========================
*/
budPlayerProfile::budPlayerProfile()
{
...
/*
========================
budPlayerProfile::SetDefaults
========================
*/
void budPlayerProfile::SetDefaults()
{
	achievementBits = 0;
	achievementBits2	= 0;
	dlcReleaseVersion	= 0;
...
/*
========================
budPlayerProfile::Serialize
========================
*/
bool budPlayerProfile::Serialize( budSerializer& ser )
{
	// NOTE:
	...
	else
	{
		...
		for( int i = 0; i < K_LAST_KEY; ++i )
		{
			budStr bind = idKeyInput::GetBinding( i );
			ser.SerializeString( bind );
		}
	}
...
/*
========================
budPlayerProfile::StatSetInt
========================
*/
void budPlayerProfile::StatSetInt( int s, int v )
{
	stats[s].i = v;
	MarkDirty( true );
}
...
/*
========================
budPlayerProfile::StatSetFloat
========================
*/
void budPlayerProfile::StatSetFloat( int s, float v )
{
	stats[s].f = v;
	MarkDirty( true );
}
...
/*
========================
budPlayerProfile::StatGetInt
========================
*/
int	budPlayerProfile::StatGetInt( int s ) const
{
	return stats[s].i;
}
...
/*
========================
budPlayerProfile::StatGetFloat
========================
*/
float budPlayerProfile::StatGetFloat( int s ) const
{
	return stats[s].f;
}
...
/*
========================
budPlayerProfile::SaveSettings
========================
*/
void budPlayerProfile::SaveSettings( bool forceDirty )
{
	if( state != SAVING )
	{
		if( forceDirty )
...
========================
*/
void budPlayerProfile::LoadSettings()
{
	if( state != LOADING )
	{
...
/*
========================
budPlayerProfile::SetAchievement
========================
*/
void budPlayerProfile::SetAchievement( const int id )
{
	if( id >= budAchievementSystem::MAX_ACHIEVEMENTS )
	{
...
/*
========================
budPlayerProfile::ClearAchievement
========================
*/
void budPlayerProfile::ClearAchievement( const int id )
{
	if( id >= budAchievementSystem::MAX_ACHIEVEMENTS )
	{
		assert( false );		// FIXME: add another set of achievement bit flags
...
/*
========================
budPlayerProfile::GetAchievement
========================
*/
bool budPlayerProfile::GetAchievement( const int id ) const
{
	if( id >= budAchievementSystem::MAX_ACHIEVEMENTS )
	{
		assert( false );		// FIXME: add another set of achievement bit flags
...
/*
========================
budPlayerProfile::SetConfig
========================
*/
void budPlayerProfile::SetConfig( int config, bool save )
{
	configSet = config;
	ExecConfig( save );
}
...
========================
*/
void budPlayerProfile::RestoreDefault()
{
...
/*
========================
budPlayerProfile::SetLeftyFlip
========================
*/
void budPlayerProfile::SetLeftyFlip( bool lf )
{
	leftyFlip = lf;
	ExecConfig( true );
}
...
/*
========================
budPlayerProfile::ExecConfig
========================
*/
void budPlayerProfile::ExecConfig( bool save, bool forceDefault )
{
...
CONSOLE_COMMAND( setProfileDefaults, "sets profile settings to default and saves", 0 )
{
	...
	budPlayerProfile* profile = session->GetSignInManager().GetMasterLocalUser()->GetProfile();
