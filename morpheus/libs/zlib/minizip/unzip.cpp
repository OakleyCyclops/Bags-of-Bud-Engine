...
#else // 0
// doom3 headers are included through PCH.hpp at the beginning of the file
/*
#include "sys/platform.h"
#include "libBud/Heap.h"
...
#endif
#else // 0
#define ALLOC(size) (Mem_Alloc(size, TAG_BUDFILE))
...
#if 0
    // DG: if we wanna use budFile_Cached like the original code in D3 BFG did
    // we may need this code
    budFile_Cached *icFile = (budFile_Cached *)us.filestream;
 ...
 *
 * * uses budFile_Cached instead of FILE
