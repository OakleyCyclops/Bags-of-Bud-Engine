...
// RB: changed CFileReadCallback to use the libBud filesystem
...
public:
	...
	{
		// open file
		_file = libBud::fileSystem->OpenFileRead( filename );
		if( _file != NULL )
		{
			getFileSize();
		}
	...
	CFileReadCallBack(budFile* file)
	...
	virtual ~CFileReadCallBack()
	{
		if( _close && _file )
		{
			libBud::fileSystem->CloseFile( _file );
		}
	}
...
//! Creates an instance of an UFT-8 or ASCII character xml parser. 
IrrXMLReader* createIrrXMLReader(budFile* file)
{
...
//! Creates an instance of an UTF-16 xml parser. 
IrrXMLReaderUTF16* createIrrXMLReaderUTF16(budFile* file)
{
...
//! Creates an instance of an UTF-32 xml parser. 
IrrXMLReaderUTF32* createIrrXMLReaderUTF32(budFile* file)
{
