...
/*
================
budCollisionModelManagerLocal::WriteNodes
================
*/
void budCollisionModelManagerLocal::WriteNodes( budFile* fp, cm_node_t* node )
{
...
/*
================
budCollisionModelManagerLocal::CountPolygonMemory
================
*/
int budCollisionModelManagerLocal::CountPolygonMemory( cm_node_t* node ) const
{
...
/*
================
budCollisionModelManagerLocal::WritePolygons
================
*/
void budCollisionModelManagerLocal::WritePolygons( budFile* fp, cm_node_t* node )
{
	cm_polygonRef_t* pref;
	cm_polygon_t* p;
	int i;
...
/*
================
budCollisionModelManagerLocal::CountBrushMemory
================
*/
int budCollisionModelManagerLocal::CountBrushMemory( cm_node_t* node ) const
{
	cm_brushRef_t* bref;
	cm_brush_t* b;
	int memory;
...
/*
================
budCollisionModelManagerLocal::WriteBrushes
================
*/
void budCollisionModelManagerLocal::WriteBrushes( budFile* fp, cm_node_t* node )
{
	cm_brushRef_t* bref;
	cm_brush_t* b;
	int i;
...
/*
================
budCollisionModelManagerLocal::WriteCollisionModel
================
*/
void budCollisionModelManagerLocal::WriteCollisionModel( budFile* fp, cm_model_t* model )
{
...
/*
================
budCollisionModelManagerLocal::WriteCollisionModelsToFile
================
*/
void budCollisionModelManagerLocal::WriteCollisionModelsToFile( const char* filename, int firstModel, int lastModel, unsigned int mapFileCRC )
{
	int i;
	budFile* fp;
	budStr name;
	...
	if( !fp )
	{
		common->Warning( "budCollisionModelManagerLocal::WriteCollisionModelsToFile: Error opening file %s\n", name.c_str() );
		return;
	}
...
/*
================
budCollisionModelManagerLocal::WriteCollisionModelForMapEntity
================
*/
bool budCollisionModelManagerLocal::WriteCollisionModelForMapEntity( const idMapEntity* mapEnt, const char* filename, const bool testTraceModel )
{
	...
	if( !fp )
	{
		common->Printf( "budCollisionModelManagerLocal::WriteCollisionModelForMapEntity: Error opening file %s\n", name.c_str() );
		FreeModel( model );
		return false;
	}
...
/*
================
budCollisionModelManagerLocal::ParseVertices
================
*/
void budCollisionModelManagerLocal::ParseVertices( budLexer* src, cm_model_t* model )
{
	int i;
...
/*
================
budCollisionModelManagerLocal::ParseEdges
================
*/
void budCollisionModelManagerLocal::ParseEdges( budLexer* src, cm_model_t* model )
{
	int i;
...
/*
================
budCollisionModelManagerLocal::ParseNodes
================
*/
cm_node_t* budCollisionModelManagerLocal::ParseNodes( budLexer* src, cm_model_t* model, cm_node_t* parent )
{
	cm_node_t* node;
...
/*
================
budCollisionModelManagerLocal::ParsePolygons
================
*/
void budCollisionModelManagerLocal::ParsePolygons( budLexer* src, cm_model_t* model )
{
	cm_polygon_t* p;
	int i, numEdges;
	budVec3 normal;
...
/*
================
budCollisionModelManagerLocal::ParseBrushes
================
*/
void budCollisionModelManagerLocal::ParseBrushes( budLexer* src, cm_model_t* model )
{
	cm_brush_t* b;
	int i, numPlanes;
	budVec3 normal;
...
/*
================
budCollisionModelManagerLocal::ParseCollisionModel
================
*/
cm_model_t* budCollisionModelManagerLocal::ParseCollisionModel( budLexer* src )
{
...
/*
================
budCollisionModelManagerLocal::LoadCollisionModelFile
================
*/
bool budCollisionModelManagerLocal::LoadCollisionModelFile( const char* name, unsigned int mapFileCRC )
{
	budToken token;
	budLexer* src;
	unsigned int crc;
	...
	if( !loaded )
	{
		...
		src = new( TAG_COLLISION ) budLexer( fileName );
		...
		while( 1 )
		{
			...
			src->Error( "budCollisionModelManagerLocal::LoadCollisionModelFile: bad token \"%s\"", token.c_str() );
		}
		delete src;
		if( outputFile != NULL )
		{
