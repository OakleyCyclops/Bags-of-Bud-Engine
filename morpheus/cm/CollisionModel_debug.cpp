...
budCVar cm_drawMask(	"cm_drawMask",			"none",		CVAR_GAME,				"collision mask", cm_contentsNameByIndex, idCmdSystem::ArgCompletion_String<cm_contentsNameByIndex> );
...
/*
================
budCollisionModelManagerLocal::ContentsFromString
================
*/
...
/*
================
budCollisionModelManagerLocal::StringFromContents
================
*/
const char* budCollisionModelManagerLocal::StringFromContents( const int contents ) const
{
	int i, length = 0;
...
/*
================
budCollisionModelManagerLocal::DrawNodePolygons
================
*/
