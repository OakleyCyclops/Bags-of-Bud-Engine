...
budCollisionModelManagerLocal	collisionModelManagerLocal;
budCollisionModelManager* 		collisionModelManager = &collisionModelManagerLocal;

cm_windingList_t* 				cm_windingList;
cm_windingList_t* 				cm_outList;
cm_windingList_t* 				cm_tmpList;

budHashIndex* 					cm_vertexHash;
budHashIndex* 					cm_edgeHash;

budBounds						cm_modelBounds;
int								cm_vertexShift;
...
/*
================
budCollisionModelManagerLocal::ParseProcNodes
================
*/
void budCollisionModelManagerLocal::ParseProcNodes( budLexer* src )
{
	int i;
...
/*
================
budCollisionModelManagerLocal::LoadProcBSP
...
void budCollisionModelManagerLocal::LoadProcBSP( const char* name )
{
	...
	src = new( TAG_COLLISION ) budLexer( filename, LEXFL_NOSTRINGCONCAT | LEXFL_NODOLLARPRECOMPILE );
	if( !src->IsLoaded() )
	{
		common->Warning( "budCollisionModelManagerLocal::LoadProcBSP: couldn't load %s", filename.c_str() );
		delete src;
		return;
	}
	...
	{
		common->Warning( "budCollisionModelManagerLocal::LoadProcBSP: bad id '%s' instead of '%s'", token.c_str(), PROC_FILE_ID );
		delete src;
		return;
	}
	...
	while( 1 )
	{
		...
		src->Error( "budCollisionModelManagerLocal::LoadProcBSP: bad token \"%s\"", token.c_str() );
	}
...
/*
================
budCollisionModelManagerLocal::Clear
================
*/
void budCollisionModelManagerLocal::Clear()
{
	mapName.Clear();
	mapFileTime = 0;
	loaded = 0;
...
/*
================
budCollisionModelManagerLocal::RemovePolygonReferences_r
================
*/
void budCollisionModelManagerLocal::RemovePolygonReferences_r( cm_node_t* node, cm_polygon_t* p )
{
...
/*
================
budCollisionModelManagerLocal::RemoveBrushReferences_r
================
*/
void budCollisionModelManagerLocal::RemoveBrushReferences_r( cm_node_t* node, cm_brush_t* b )
{
	cm_brushRef_t* bref;
...
/*
================
budCollisionModelManagerLocal::FreeNode
================
*/
void budCollisionModelManagerLocal::FreeNode( cm_node_t* node )
{
...
/*
================
budCollisionModelManagerLocal::FreePolygonReference
================
*/
void budCollisionModelManagerLocal::FreePolygonReference( cm_polygonRef_t* pref )
{
...
/*
================
budCollisionModelManagerLocal::FreeBrushReference
================
*/
void budCollisionModelManagerLocal::FreeBrushReference( cm_brushRef_t* bref )
{
...
/*
================
budCollisionModelManagerLocal::FreePolygon
================
*/
void budCollisionModelManagerLocal::FreePolygon( cm_model_t* model, cm_polygon_t* poly )
{
	model->numPolygons--;
...
/*
================
budCollisionModelManagerLocal::FreeBrush
================
*/
void budCollisionModelManagerLocal::FreeBrush( cm_model_t* model, cm_brush_t* brush )
{
	model->numBrushes--;
...
/*
================
budCollisionModelManagerLocal::FreeTree_r
================
*/
void budCollisionModelManagerLocal::FreeTree_r( cm_model_t* model, cm_node_t* headNode, cm_node_t* node )
{
	cm_polygonRef_t* pref;
	cm_polygon_t* p;
	cm_brushRef_t* bref;
...
/*
================
budCollisionModelManagerLocal::FreeModel
================
*/
void budCollisionModelManagerLocal::FreeModel( cm_model_t* model )
{
...
/*
================
budCollisionModelManagerLocal::FreeMap
================
*/
void budCollisionModelManagerLocal::FreeMap()
{
	int i;
...
/*
================
budCollisionModelManagerLocal::FreeTrmModelStructure
================
*/
void budCollisionModelManagerLocal::FreeTrmModelStructure()
{
	int i;
...
/*
================
budCollisionModelManagerLocal::CalculateEdgeNormals
================
*/
#define SHARP_EDGE_DOT	-0.7f

void budCollisionModelManagerLocal::CalculateEdgeNormals( cm_model_t* model, cm_node_t* node )
{
	cm_polygonRef_t* pref;
	cm_polygon_t* p;
	cm_edge_t* edge;
...
/*
================
budCollisionModelManagerLocal::AllocModel
================
*/
cm_model_t* budCollisionModelManagerLocal::AllocModel()
{
	cm_model_t* model;
...
/*
================
budCollisionModelManagerLocal::AllocNode
================
*/
cm_node_t* budCollisionModelManagerLocal::AllocNode( cm_model_t* model, int blockSize )
{
	int i;
	cm_node_t* node;
...
/*
================
budCollisionModelManagerLocal::AllocPolygonReference
================
*/
cm_polygonRef_t* budCollisionModelManagerLocal::AllocPolygonReference( cm_model_t* model, int blockSize )
{
	int i;
	cm_polygonRef_t* pref;
...
/*
================
budCollisionModelManagerLocal::AllocBrushReference
================
*/
cm_brushRef_t* budCollisionModelManagerLocal::AllocBrushReference( cm_model_t* model, int blockSize )
{
	int i;
	cm_brushRef_t* bref;
...
/*
================
budCollisionModelManagerLocal::AllocPolygon
================
*/
cm_polygon_t* budCollisionModelManagerLocal::AllocPolygon( cm_model_t* model, int numEdges )
{
	cm_polygon_t* poly;
	int size;
...
/*
================
budCollisionModelManagerLocal::AllocBrush
================
*/
cm_brush_t* budCollisionModelManagerLocal::AllocBrush( cm_model_t* model, int numPlanes )
{
	cm_brush_t* brush;
	int size;
...
/*
================
budCollisionModelManagerLocal::AddPolygonToNode
================
*/
void budCollisionModelManagerLocal::AddPolygonToNode( cm_model_t* model, cm_node_t* node, cm_polygon_t* p )
{
	cm_polygonRef_t* pref;
...
/*
================
budCollisionModelManagerLocal::AddBrushToNode
================
*/
void budCollisionModelManagerLocal::AddBrushToNode( cm_model_t* model, cm_node_t* node, cm_brush_t* b )
{
	cm_brushRef_t* bref;
...
/*
================
budCollisionModelManagerLocal::SetupTrmModelStructure
================
*/
void budCollisionModelManagerLocal::SetupTrmModelStructure()
{
	int i;
	cm_node_t* node;
	cm_model_t* model;
...
/*
================
budCollisionModelManagerLocal::SetupTrmModel
...
================
*/
cmHandle_t budCollisionModelManagerLocal::SetupTrmModel( const budTraceModel& trm, const budMaterial* material )
{
	int i, j;
	cm_vertex_t* vertex;
	cm_edge_t* edge;
...
/*
============
budCollisionModelManagerLocal::ChoppedAwayByProcBSP
============
*/
int budCollisionModelManagerLocal::ChoppedAwayByProcBSP( const budFixedWinding& w, const budPlane& plane, int contents )
{
...
/*
=============
budCollisionModelManagerLocal::ChopWindingWithBrush

  returns the least number of winding fragments outside the brush
=============
*/
void budCollisionModelManagerLocal::ChopWindingListWithBrush( cm_windingList_t* list, cm_brush_t* b )
{
	int i, k, res, startPlane, planeNum, bestNumWindings;
	budFixedWinding back, front;
	budPlane plane;
	bool chopped;
		...
		do
		{
			...
			for( planeNum = startPlane, i = 0; i < b->numPlanes; i++, planeNum++ )
			{
				...
				if( res == SIDE_BACK )
				{
					...
					{
						common->Warning( "budCollisionModelManagerLocal::ChopWindingWithBrush: primitive %d more than %d windings", list->primitiveNum, MAX_WINDING_LIST );
						return;
					}
...
/*
============
budCollisionModelManagerLocal::R_ChopWindingListWithTreeBrushes
============
*/
void budCollisionModelManagerLocal::R_ChopWindingListWithTreeBrushes( cm_windingList_t* list, cm_node_t* node )
{
	int i;
	cm_brushRef_t* bref;
	cm_brush_t* b;
...
/*
============
budCollisionModelManagerLocal::WindingOutsideBrushes
...
============
*/
budFixedWinding* budCollisionModelManagerLocal::WindingOutsideBrushes( budFixedWinding* w, const budPlane& plane, int contents, int primitiveNum, cm_node_t* headNode )
{
	int i, windingLeft;
...
/*
=============
budCollisionModelManagerLocal::ReplacePolygons

  does not allow for a node to have multiple references to the same polygon
=============
*/
void budCollisionModelManagerLocal::ReplacePolygons( cm_model_t* model, cm_node_t* node, cm_polygon_t* p1, cm_polygon_t* p2, cm_polygon_t* newp )
{
...
/*
=============
budCollisionModelManagerLocal::TryMergePolygons
=============
*/
#define	CONTINUOUS_EPSILON	0.005f
#define NORMAL_EPSILON		0.01f

cm_polygon_t* budCollisionModelManagerLocal::TryMergePolygons( cm_model_t* model, cm_polygon_t* p1, cm_polygon_t* p2 )
{
	int i, j, nexti, prevj;
...
/*
=============
budCollisionModelManagerLocal::MergePolygonWithTreePolygons
=============
*/
bool budCollisionModelManagerLocal::MergePolygonWithTreePolygons( cm_model_t* model, cm_node_t* node, cm_polygon_t* polygon )
{
	int i;
	cm_polygonRef_t* pref;
	cm_polygon_t* p, *newp;
...
/*
=============
budCollisionModelManagerLocal::MergeTreePolygons

  try to merge any two polygons with the same surface flags and the same contents
=============
*/
void budCollisionModelManagerLocal::MergeTreePolygons( cm_model_t* model, cm_node_t* node )
{
	cm_polygonRef_t* pref;
	cm_polygon_t* p;
	bool merge;
...
/*
=============
budCollisionModelManagerLocal::FindInternalEdgesOnPolygon
=============
*/
void budCollisionModelManagerLocal::FindInternalEdgesOnPolygon( cm_model_t* model, cm_polygon_t* p1, cm_polygon_t* p2 )
{
	int i, j, k, edgeNum;
	cm_edge_t* edge;
...
/*
=============
budCollisionModelManagerLocal::FindInternalPolygonEdges
=============
*/
void budCollisionModelManagerLocal::FindInternalPolygonEdges( cm_model_t* model, cm_node_t* node, cm_polygon_t* polygon )
{
	cm_polygonRef_t* pref;
	cm_polygon_t* p;
...
/*
=============
budCollisionModelManagerLocal::FindContainedEdges
=============
*/
void budCollisionModelManagerLocal::FindContainedEdges( cm_model_t* model, cm_polygon_t* p )
{
	int i, edgeNum;
	cm_edge_t* edge;
	budFixedWinding w;
...
/*
=============
budCollisionModelManagerLocal::FindInternalEdges
=============
*/
void budCollisionModelManagerLocal::FindInternalEdges( cm_model_t* model, cm_node_t* node )
{
	cm_polygonRef_t* pref;
	cm_polygon_t* p;
...
================
*/
static int CM_FindSplitter( const cm_node_t* node, const budBounds& bounds, int* planeType, float* planeDist )
{
...
================
*/
static int CM_R_InsideAllChildren( cm_node_t* node, const budBounds& bounds )
{
	assert( node != NULL );
	if( node->planeType != -1 )
	{
...
/*
================
budCollisionModelManagerLocal::R_FilterPolygonIntoTree
================
*/
void budCollisionModelManagerLocal::R_FilterPolygonIntoTree( cm_model_t* model, cm_node_t* node, cm_polygonRef_t* pref, cm_polygon_t* p )
{
	assert( node != NULL );
...
/*
================
budCollisionModelManagerLocal::R_FilterBrushIntoTree
================
*/
void budCollisionModelManagerLocal::R_FilterBrushIntoTree( cm_model_t* model, cm_node_t* node, cm_brushRef_t* pref, cm_brush_t* b )
{
	assert( node != NULL );
	while( node->planeType != -1 )
	{
...
/*
================
budCollisionModelManagerLocal::R_CreateAxialBSPTree

  a brush or polygon is linked in the node closest to the root where
  the brush or polygon is inside all children
================
*/
cm_node_t* budCollisionModelManagerLocal::R_CreateAxialBSPTree( cm_model_t* model, cm_node_t* node, const budBounds& bounds )
{
	int planeType;
	float planeDist;
	...
	budBounds frontBounds, backBounds;
...
/*
================
budCollisionModelManagerLocal::CreateAxialBSPTree
================
*/
cm_node_t* budCollisionModelManagerLocal::CreateAxialBSPTree( cm_model_t* model, cm_node_t* node )
{
	cm_polygonRef_t* pref;
	cm_brushRef_t* bref;
	budBounds bounds;
...
/*
================
budCollisionModelManagerLocal::SetupHash
================
*/
void budCollisionModelManagerLocal::SetupHash()
{
	if( !cm_vertexHash )
	{
		cm_vertexHash = new( TAG_COLLISION ) budHashIndex( VERTEX_HASH_SIZE, 1024 );
	}
	if( !cm_edgeHash )
	{
		cm_edgeHash = new( TAG_COLLISION ) budHashIndex( EDGE_HASH_SIZE, 1024 );
	}
...
/*
================
budCollisionModelManagerLocal::ShutdownHash
================
*/
void budCollisionModelManagerLocal::ShutdownHash()
{
...
/*
================
budCollisionModelManagerLocal::ClearHash
================
*/
void budCollisionModelManagerLocal::ClearHash( budBounds& bounds )
{
	int i;
	float f, max;
...
/*
================
budCollisionModelManagerLocal::CreatePolygon
================
*/
void budCollisionModelManagerLocal::CreatePolygon( cm_model_t* model, budFixedWinding* w, const budPlane& plane, const budMaterial* material, int primitiveNum )
{
	...
	{
		common->Warning( "budCollisionModelManagerLocal::CreatePolygon: polygon has more than %d edges", numPolyEdges );
...
/*
================
budCollisionModelManagerLocal::PolygonFromWinding

  NOTE: for patches primitiveNum < 0 and abs(primitiveNum) is the real number
================
*/
void budCollisionModelManagerLocal::PolygonFromWinding( cm_model_t* model, budFixedWinding* w, const budPlane& plane, const budMaterial* material, int primitiveNum )
{
	int contents;
	...
	if( w->IsHuge() )
	{
		common->Warning( "budCollisionModelManagerLocal::PolygonFromWinding: model %s primitive %d is degenerate", model->name.c_str(), abs( primitiveNum ) );
		return;
	}
...
/*
=================
budCollisionModelManagerLocal::CreatePatchPolygons
=================
*/
void budCollisionModelManagerLocal::CreatePatchPolygons( cm_model_t* model, idSurface_Patch& mesh, const budMaterial* material, int primitiveNum )
{
	int i, j;
	float dot;
	int v1, v2, v3, v4;
...
/*
=================
budCollisionModelManagerLocal::ConverPatch
=================
*/
void budCollisionModelManagerLocal::ConvertPatch( cm_model_t* model, const idMapPatch* patch, int primitiveNum )
{
...
/*
================
budCollisionModelManagerLocal::ConvertBrushSides
================
*/
void budCollisionModelManagerLocal::ConvertBrushSides( cm_model_t* model, const idMapBrush* mapBrush, int primitiveNum )
{
	int i, j;
	...
	planes = ( budPlane* ) _alloca16( mapBrush->GetNumSides() * sizeof( planes[0] ) );
...
/*
================
budCollisionModelManagerLocal::ConvertBrush
================
*/
void budCollisionModelManagerLocal::ConvertBrush( cm_model_t* model, const idMapBrush* mapBrush, int primitiveNum )
{
	int i, j, contents;
	budBounds bounds;
	idMapBrushSide* mapSide;
	...
	budPlane* planes;
	budFixedWinding w;
	const budMaterial* material = NULL;
...
================
*/
static void CM_R_GetNodeBounds( budBounds* bounds, cm_node_t* node )
{
	cm_polygonRef_t* pref;
	cm_brushRef_t* bref;
...
================
*/
void CM_GetNodeBounds( budBounds* bounds, cm_node_t* node )
{
	bounds->Clear();
...
/*
==================
budCollisionModelManagerLocal::RemapEdges
==================
*/
void budCollisionModelManagerLocal::RemapEdges( cm_node_t* node, int* edgeRemap )
{
	cm_polygonRef_t* pref;
	cm_polygon_t* p;
	int i;
...
/*
==================
budCollisionModelManagerLocal::OptimizeArrays

  due to polygon merging and polygon removal the vertex and edge array
  can have a lot of unused entries.
==================
*/
void budCollisionModelManagerLocal::OptimizeArrays( cm_model_t* model )
{
...
/*
================
budCollisionModelManagerLocal::FinishModel
================
*/
void budCollisionModelManagerLocal::FinishModel( cm_model_t* model )
{
...
/*
================
budCollisionModelManagerLocal::LoadBinaryModel
================
*/
cm_model_t* budCollisionModelManagerLocal::LoadBinaryModelFromFile( budFile* file, ID_TIME_T sourceTimeStamp )
{
...
================
*/
cm_model_t* budCollisionModelManagerLocal::LoadBinaryModel( const char* fileName, ID_TIME_T sourceTimeStamp )
{
	budFileLocal file( fileSystem->OpenFileReadMemory( fileName ) );
	if( file == NULL )
	{
		return NULL;
	}
...
/*
================
budCollisionModelManagerLocal::WriteBinaryModel
================
*/
void budCollisionModelManagerLocal::WriteBinaryModelToFile( cm_model_t* model, budFile* file, ID_TIME_T sourceTimeStamp )
{
...
================
*/
void budCollisionModelManagerLocal::WriteBinaryModel( cm_model_t* model, const char* fileName, ID_TIME_T sourceTimeStamp )
{
	budFileLocal file( fileSystem->OpenFileWrite( fileName, "fs_basepath" ) );
	if( file == NULL )
	{
...
/*
================
budCollisionModelManagerLocal::LoadRenderModel
================
*/
cm_model_t* budCollisionModelManagerLocal::LoadRenderModel( const char* fileName )
{
	int i, j;
	budRenderModel* renderModel;
...
/*
================
budCollisionModelManagerLocal::CollisionModelForMapEntity
================
*/
cm_model_t* budCollisionModelManagerLocal::CollisionModelForMapEntity( const idMapEntity* mapEnt )
{
...
/*
================
budCollisionModelManagerLocal::FindModel
================
*/
cmHandle_t budCollisionModelManagerLocal::FindModel( const char* name )
{
	int i;
...
/*
==================
budCollisionModelManagerLocal::PrintModelInfo
==================
*/
void budCollisionModelManagerLocal::PrintModelInfo( const cm_model_t* model )
{
...
/*
================
budCollisionModelManagerLocal::AccumulateModelInfo
================
*/
void budCollisionModelManagerLocal::AccumulateModelInfo( cm_model_t* model )
{
	int i;
...
/*
================
budCollisionModelManagerLocal::ModelInfo
================
*/
void budCollisionModelManagerLocal::ModelInfo( cmHandle_t model )
{
	...
	{
		common->Printf( "budCollisionModelManagerLocal::ModelInfo: invalid model handle\n" );
		return;
	}
	if( !models[model] )
	{
		common->Printf( "budCollisionModelManagerLocal::ModelInfo: invalid model\n" );
		return;
	}
...
/*
================
budCollisionModelManagerLocal::ListModels
================
*/
void budCollisionModelManagerLocal::ListModels()
{
	int i, totalMemory;
...
/*
================
budCollisionModelManagerLocal::BuildModels
================
*/
void budCollisionModelManagerLocal::BuildModels( const budMapFile* mapFile )
{
	int i;
	...
	if( !LoadCollisionModelFile( mapFile->GetName(), mapFile->GetGeometryCRC() ) )
	{
		...
		for( i = 0; i < mapFile->GetNumEntities(); i++ )
		{
			...
			{
				common->Error( "budCollisionModelManagerLocal::BuildModels: more than %d collision models", MAX_SUBMODELS );
				break;
			}
...
/*
================
budCollisionModelManagerLocal::Preload
================
*/
void budCollisionModelManagerLocal::Preload( const char* mapName )
{
...
/*
================
budCollisionModelManagerLocal::LoadMap
================
*/
void budCollisionModelManagerLocal::LoadMap( const budMapFile* mapFile )
{

	if( mapFile == NULL )
	{
		common->Error( "budCollisionModelManagerLocal::LoadMap: NULL mapFile" );
		return;
	}
...
/*
===================
budCollisionModelManagerLocal::GetModelName
===================
*/
const char* budCollisionModelManagerLocal::GetModelName( cmHandle_t model ) const
{
	if( model < 0 || model > MAX_SUBMODELS || model >= numModels || !models[model] )
	{
		common->Printf( "budCollisionModelManagerLocal::GetModelBounds: invalid model handle\n" );
		return "";
	}
...
/*
===================
budCollisionModelManagerLocal::GetModelBounds
===================
*/
bool budCollisionModelManagerLocal::GetModelBounds( cmHandle_t model, budBounds& bounds ) const
{
...
/*
===================
budCollisionModelManagerLocal::GetModelContents
===================
*/
bool budCollisionModelManagerLocal::GetModelContents( cmHandle_t model, int& contents ) const
{
	if( model < 0 || model > MAX_SUBMODELS || model >= numModels || !models[model] )
	{
		common->Printf( "budCollisionModelManagerLocal::GetModelContents: invalid model handle\n" );
		return false;
	}
...
bool budCollisionModelManagerLocal::GetModelVertex( cmHandle_t model, int vertexNum, Vector3& vertex ) const
{
	if( model < 0 || model > MAX_SUBMODELS || model >= numModels || !models[model] )
	{
		common->Printf( "budCollisionModelManagerLocal::GetModelVertex: invalid model handle\n" );
		return false;
	}
	
	if( vertexNum < 0 || vertexNum >= models[model]->numVertices )
	{
		common->Printf( "budCollisionModelManagerLocal::GetModelVertex: invalid vertex number\n" );
		return false;
	}
...
bool budCollisionModelManagerLocal::GetModelEdge( cmHandle_t model, int edgeNum, Vector3& start, Vector3& end ) const
{
	if( model < 0 || model > MAX_SUBMODELS || model >= numModels || !models[model] )
	{
		common->Printf( "budCollisionModelManagerLocal::GetModelEdge: invalid model handle\n" );
		return false;
	}
	...
	{
		common->Printf( "budCollisionModelManagerLocal::GetModelEdge: invalid edge number\n" );
		return false;
	}
...
/*
===================
budCollisionModelManagerLocal::GetModelPolygon
===================
*/
bool budCollisionModelManagerLocal::GetModelPolygon( cmHandle_t model, int polygonNum, budFixedWinding& winding ) const
{
	int i, edgeNum;
	cm_polygon_t* poly;
	...
	if( model < 0 || model > MAX_SUBMODELS || model >= numModels || !models[model] )
	{
		common->Printf( "budCollisionModelManagerLocal::GetModelPolygon: invalid model handle\n" );
		return false;
	}
...
/*
==================
budCollisionModelManagerLocal::LoadModel
==================
*/
cmHandle_t budCollisionModelManagerLocal::LoadModel( const char* modelName )
{
	int handle;
	...
	if( numModels >= MAX_SUBMODELS )
	{
		common->Error( "budCollisionModelManagerLocal::LoadModel: no free slots\n" );
		return 0;
	}
	...
	if( LoadCollisionModelFile( modelName, 0 ) )
	{
		...
		{
			common->Warning( "budCollisionModelManagerLocal::LoadModel: collision file for '%s' contains different model", modelName );
		}
	}
...
/*
==================
budCollisionModelManagerLocal::TrmFromModel_r
==================
*/
bool budCollisionModelManagerLocal::TrmFromModel_r( budTraceModel& trm, cm_node_t* node )
{
	cm_polygonRef_t* pref;
	cm_polygon_t* p;
	int i;
...
/*
==================
budCollisionModelManagerLocal::TrmFromModel

  NOTE: polygon merging can merge colinear edges and as such might cause dangling edges.
==================
*/
bool budCollisionModelManagerLocal::TrmFromModel( const cm_model_t* model, budTraceModel& trm )
{
	...
	{
		common->Printf( "budCollisionModelManagerLocal::TrmFromModel: model %s has too many vertices.\n", model->name.c_str() );
		PrintModelInfo( model );
		return false;
	}
	...
	{
		common->Printf( "budCollisionModelManagerLocal::TrmFromModel: model %s has too many edges.\n", model->name.c_str() );
		PrintModelInfo( model );
		return false;
	}
	...
	{
		common->Printf( "budCollisionModelManagerLocal::TrmFromModel: model %s has too many polygons.\n", model->name.c_str() );
		PrintModelInfo( model );
		return false;
	}
	...
	for( i = 1; i <= trm.numEdges; i++ )
	{
		if( numEdgeUsers[i] != 2 )
		{
			common->Printf( "budCollisionModelManagerLocal::TrmFromModel: model %s has dangling edges, the model has to be an enclosed hull.\n", model->name.c_str() );
			PrintModelInfo( model );
			return false;
		}
	}
...
==================
*/
bool budCollisionModelManagerLocal::TrmFromModel( const char* modelName, budTraceModel& trm )
{
	cmHandle_t handle;
	...
	if( !handle )
	{
		common->Printf( "budCollisionModelManagerLocal::TrmFromModel: model %s not found.\n", modelName );
		return false;
	}
